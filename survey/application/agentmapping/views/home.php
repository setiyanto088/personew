						...
						<div class="col-md-12 grid-margin ">
							<div class="card">
								...
								<input type="hidden" id="agent_id" />
										<?php foreach($kecamatan as $array_familys){ ?>
											 <div class="col-md-6" >
											  <div class="form-check form-check-danger">
												  <label class="form-check-label">
													<input type="checkbox" name="kecamatan" value="<?php echo $array_familys['KECAMATAN_DAGRI']; ?>" id="<?php echo str_replace(" ","_",$array_familys['KECAMATAN_DAGRI']); ?>"  class="form-check-input" >
