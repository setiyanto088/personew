					    ...
					    <div class="row">
						    ...
						    <div class="row">
						     <div class="col-md-4">
							  <div class="form-check" >
								<label class="form-check-label">
								  <input type="radio" class="form-check-input formxx" name="b2" id="b2_-50" value="-50">
								  Dibawah Rp 50 Ribu
								</label>
							  </div>
							</div>
              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <form class="forms-sample">
							 ...
							 <div class="row">
							  ...
							  <div class="col-md-3">
							   ...
							   <div class="col-md-3">
								  <div class="form-check" >
									<label class="form-check-label">
									  <input type="radio" class="form-check-input frmxx" name="f2" id="f2_2" value="2">
					...
					<div id="F_part2" style="display:none">
					<div class="form-group">
...
<div class="col-md-3">
					...
					<div id="F_part3" style="display:none">
					<div class="form-group">
					...
					<div id="F_part4" style="display:none">
                      ...
                      <label for="exampleInputUsername1"><b>F58. Dalam 6 bulan terakhir, barang elektronik dan Home Appliance apa saja yang Bpk /Ibu /Sdr beli. Apa mereknya?</b> </label>
							...
							<div class="row">
								<div class="col-md-6">
								  <div class="form-check mx-sm-2">
									  <label class="form-check-label">
										<input type="checkbox" id="F58_val_<?php echo $i ?>" class="form-check-input " value="<?php echo $i ?>" >
											<?php echo $penggunaan_ss; ?>
									  </label>
									</div>
								</div> 
					...
					<div id="F_part5" style="display:none">
					...
					<div id="F_part6" style="display:none">
					...
					<div id="F_part7" style="display:none">
					<div class="form-group">
					  ...
					  F90.(F90-1) (Showcard-P) Barang kebutuhan sehari-hari berikut ini, mana yang Bpk/Ibu/ Sdr dan atau keluarga beli dalam 1 bulan terakhir; <br>
						...
						<b>Kebutuhan Makan dan Minum</b>
							...
							<div class="row">
								...
								<select class="form-control js-example-basic-multiple " name="<?php echo $field_merk[$in]; ?>_kk[]" id="<?php echo $field_merk[$in]; ?>_kk" multiple="multiple" style="width:100%"> 
												<?php  foreach($array_merk[$field_merk[$in]]['VALUE'] as $array_merks){
								...
								<div class="col-md-9">
									...
									<?php foreach($array_family as $array_familys){ ?>
									<div class="col-md-3 <?php echo $array_familys[1]; ?>" style="display: none;">
									<h4 style="margin-left:-10px">&nbsp</h4>
									  <div class="form-check mx-sm-2">
										  <label class="form-check-label">
											<input type="checkbox" name="<?php echo $field_merk[$in]; ?>_fam" id="<?php echo $field_merk[$in]; ?>_<?php echo $array_familys[1]; ?>_fam" value="<?php echo $array_familys[1]; ?>" class="form-check-input formxx" >
											<?php echo $array_familys[0]; ?>
										  </label>
										</div>
					...
					<div id="F_part8" style="display:none">
					<div class="form-group">
                      <label for="exampleInputUsername1"><b>
					...
					<div id="F_part9" style="display:none">
					<div class="form-group">
					  ...
					  G1. (G1-1) (Showcard-R) Barang-barang tahan lama berikut ini, mana yang Bpk/ Ibu/ Sdr miliki? <br>
						...
						<b>Produk Kendaraan dan Elektronik</b>
							...
							<div class="row">
								...
								<select class="form-control js-example-basic-multiple formxxc" name="<?php echo $field_merk[$in]; ?>_kk[]" id="<?php echo $field_merk[$in]; ?>_kk" multiple="multiple" style="width:100%" onChange="change_<?php echo $field_merk[$in]; ?>('kk','')"> 
												<?php  foreach($array_merk[$field_merk[$in]]['VALUE'] as $array_merks){
							...
							<div class="row">
								<div class="col-md-3">
								<h4 style='margin-left:-5px;'><?php echo $penggunaan_ss; ?></h4>
								<select class="form-control js-example-basic-multiple formxxc" name="<?php echo $field_merk[$in]; ?>_kk[]" id="<?php echo $field_merk[$in]; ?>_kk" multiple="multiple" style="width:100%"> 
												<?php  foreach($array_merk[$field_merk[$in]]['VALUE'] as $array_merks){
							...
							<div class="row">
									<div class="col-md-6">
										<div class="row" id="list_car_own_kk">
											<div class="col-md-6"><span id="mobil1">Mobil 1</span></div>
											<div class="col-md-6"><div class="form-group"><input type="text" class="form-control" id="G21lainnya1_kk" placeholder="Tahun Perakitan"></div></div>
											
											<div class="col-md-6"><span id="mobil2">Mobil 2</span></div>
											<div class="col-md-6"><div class="form-group"><input type="text" class="form-control" id="G21lainnya2_kk" placeholder="Tahun Perakitan"></div></div>

											<div class="col-md-6"><span id="mobil3">Mobil 3</span></div>
											<div class="col-md-6"><div class="form-group"><input type="text" class="form-control" id="G21lainnya3_kk" placeholder="Tahun Perakitan"></div></div>
										</div>
									...
									<div class="col-md-6">
										...
										<div class="col-md-6"><span id="motor1">Motor 1</span></div>
											<div class="col-md-6"><div class="form-group"><input type="text" class="form-control" id="G22lainnya1_kk" placeholder="Tahun Perakitan"></div></div>
											
											<div class="col-md-6"><span id="motor2">Motor2 2</span></div>
											<div class="col-md-6"><div class="form-group"><input type="text" class="form-control" id="G22lainnya2_kk" placeholder="Tahun Perakitan"></div></div>

											<div class="col-md-6"><span id="motor3">Motor 3</span></div>
											<div class="col-md-6"><div class="form-group"><input type="text" class="form-control" id="G22lainnya3_kk" placeholder="Tahun Perakitan"></div></div>
...
<button class="btn btn btn-danger" type="button" onClick="back_user()">Kembali ke survey</button>
		  ...
		  <div class="row" id="survey_page_3">
		    ...
		    <div class="col-md-6 grid-margin transparent" id="next_real">
              <div class="row">
			 ...
			 <div class="col-md-6 grid-margin transparent" id="next_f" style="display:none">
              <div class="row">
                <div class="col-md-6 mb-4 stretch-card transparent">
				 <button type="button" class="btn btn-success btn-md" onClick="before_survey_f(0)">Sebelumnya</button>
                  <button type="button" class="btn btn-success btn-md" id="btn_next" onClick="next_survey_f(1)">Selanjutnya</button>
	...
	<div class="modal fade bd-example-modal-lg" id="modal_load" data-backdrop="static" data-keyboard="false" tabindex="-1">
		...
		$( document ).ready(function() { 
		 ...
		 // if ($("#datepicker-popup").length) {
		  ...
		  // }
			...
			<?php foreach($data_r7 as $data_r1s){ 
				...
				if($data_r1s['type_input'] == 0){
					...
					if($data_r1s['value'] <> ''){
						...
						if($data_r1s['sub_question'] == 7 || $data_r1s['sub_question'] == 8){

							$var_field = explode('_',$data_r1s['code_question']);

							if(count($var_field) == 3){
								$name_field_kk = $var_field[0].'_'.$var_field[1].'_kk';
							}else{
								$name_field_kk = $var_field[0].'_'.$var_field[1].'_'.$var_field[2].'_kk';
							}
							echo '$("#'.$data_r1s['code_question'].'_fam").prop("checked", true);';

						}else{
							$name_field_kk = $data_r1s['code_question'];
						}
						...
						echo "var selects= $('#".$name_field_kk."');";
				...
				if($data_r1s['type_input'] == 0){
					...
					if($dr <> ''){
						...
						if($data_r1s['value'] <> ''){
							...
							if($data_r1s['code_question'] == 'merk_car_kkS' || $data_r1s['code_question'] == 'merk_mb_kkS'){
								foreach($vv as $vvs){
			...
			if($('#f36_berita_dan_informasi').is(':checked')){
					$("#f37-pg").show();
			}
			...
			if($('#f53_day_2_1').is(':checked')){
					$("#f54-pg").show();
			}
			
			if($('#f53_week_2_1').is(':checked')){
					$("#f54-pg").show();
			}
			
			if($('#f53_month_2_1').is(':checked')){
					$("#f54-pg").show();
			}
		...
		//id_pelanggan
			...
			$("#f36_berita_dan_informasi").change(function() {
				if(this.checked) {
					$("#f37-pg").show();
				}else{
					$("#f37-pg").hide();
			...
			$("#f53_day_2_1").change(function() {
				...
				if(trt > 0) {
					$( "#f53_2_1" ).prop( "checked", true );
					$("#f54-pg").show();
				}else{
					$( "#f53_2_1" ).prop( "checked", false );
					$("#f54-pg").hide();
				}
			});
			
			$("#f53_week_2_1").change(function() {
			...
			$("#f53_day_4_1").change(function() {
				
				var trt = 0;
				
				if($("#f53_day_4_1").is(":checked")){
					trt++;
				}
				...
				if($("#f53_day_4_1").is(":checked")){
					...
					if(trt > 0) {
					$( "#f53_4_1" ).prop( "checked", true );
					$("#f55-pg").show();
				}else{
					$( "#f53_4_1" ).prop( "checked", false );
					$("#f55-pg").hide();
				}
			});
			
			$("#f53_week_4_1").change(function() {
				
				var trt = 0;
				
				if($("#f53_week_4_1").is(":checked")){
					trt++;
				}
			...
			$("#f53_month_4_1").change(function() {
				
				var trt = 0;
				
				if($("#f53_month_4_1").is(":checked")){
					trt++;
				}
			...
			$("#f53_day_5_1").change(function() {
				
				var trt = 0;
				
				if($("#f53_day_5_1").is(":checked")){
					trt++;
				}
				...
				if(trt > 0) {
					$( "#f53_5_1" ).prop( "checked", true );
					$("#f56-pg").show();
				}else{
					$( "#f53_5_1" ).prop( "checked", false );
					$("#f56-pg").hide();
				}
			});
			
			$("#f53_week_5_1").change(function() {
				
				var trt = 0;
				
				if($("#f53_week_5_1").is(":checked")){
					trt++;
				}
			...
			$("#f53_month_5_1").change(function() {
				
				var trt = 0;
				
				if($("#f53_month_5_1").is(":checked")){
					trt++;
				}
...
// $("#page_identiatas_responden").hide();
		...
		<script>
				      ...
				      $.ajax({
						...
						//console.log(response[1].screening);
							...
							for(var i=0;i<response.length;i++){
								...
								var numbers = i+1;
								$('#program_name_'+numbers).html(response[i].CHANNEL+"<BR>"+response[i].PROGRAM+"<BR>Genre "+response[i].GENRE_PROGRAM+""+array_sc[response[i].screening]);
								$('#c12_channel'+numbers).val(response[i].PROGRAM);
								$('#c12_program_skala'+numbers).val(response[i].PROGRAM);
								$('#progra_skala_'+numbers).html(numbers+'. '+response[i].CHANNEL+"<BR>"+response[i].PROGRAM+"<BR>Genre "+response[i].GENRE_PROGRAM);
			...
			function change_merk_car(fm,sm_str){
				...
				for(var i=0; i<merk_vals.length; i++){
					var idn = i+1;
					var spl =merk_vals[i].split("_");

					//$('#mobil'+idn).html(spl[2]);

					
						html += '<div class="col-md-6">	<span id="mobil'+idn+'">'+spl[2]+'</span></div> ';
...
//alert('asasasa');
				...
				for(var i=0; i<merk_vals.length; i++){
					...
					var idn = i+1;
						html += '<div class="col-md-6">	<span id="mb'+idn+'">'+spl[2]+'</span></div> ';
			...
			function next_survey_f(page){
				...
				if(fpage == 0){
					...
					//alert(fpage);
							...
							var formData2 = new FormData();
							var urls = "<?php echo base_url('survey/insert_survey_f'); ?>";
							...
							formData2.append('form_part', 5);
							formData2.append('curr_page', 8);
							formData2.append('sub_cat', 1);
							
							<?php foreach($field_r7_f1 as $r1){ 
					...
					var errors = '';
						...
						if(errors == ''){
							...
							formData2.append('form_part', 5);
							formData2.append('curr_page', 8);
							formData2.append('sub_cat', 2);
							
							<?php foreach($field_r7_f2 as $r1){ 
					...
					//alert(fpage);
							...
							formData2.append('form_part', 5);
							formData2.append('curr_page', 8);
							formData2.append('sub_cat', 3);
							
							<?php foreach($field_r7_f3 as $r1){ 
					...
					if(errors == ''){
						...
						//	alert(fpage);
							...
							formData2.append('form_part', 5);
							formData2.append('curr_page', 8);
							formData2.append('sub_cat', 4);
							
							<?php foreach($field_r7_f4 as $r1){ 
				...
				//	alert(fpage);
							...
							formData2.append('form_part', 5);
							formData2.append('curr_page', 8);
							formData2.append('sub_cat', 5);
							
							<?php foreach($field_r7_f5 as $r1){ 
				...
				//	alert(fpage);
							...
							formData2.append('form_part', 5);
							formData2.append('curr_page', 8);
							formData2.append('sub_cat', 6);
							
							<?php foreach($field_r7_f6 as $r1){ 
					...
					if(errors == ''){
						...
						//	alert(fpage);
							...
							formData2.append('form_part', 5);
							formData2.append('curr_page', 8);
							formData2.append('sub_cat', 7);
							
							<?php foreach($field_r7_f7 as $r1){ 
									...
									if($r1['type_input'] == 0){
										...
										$("input:checkbox[name=<?php echo $r1['fieldss'] ?>]:checked").each(function(){
											var aa = $(this).val();
											formData2.append('<?php echo $r1['raw_field'] ?>_'+aa,vals);
											<?php //echo "formData2.append('".$r1['raw_question']."_', vals);"; ?>
										});
										//var values_rel = values.slice(0, -1) ;
										//console.log(val_amdk);
					...
					if(errors == ''){
							...
							formData2.append('form_part', 5);
							formData2.append('curr_page', 8);
							formData2.append('sub_cat', 8);
							
							<?php foreach($field_r7_f8 as $r1){ 
					...
					if(errors == ''){
							...
							formData2.append('form_part', 5);
							formData2.append('curr_page', 9);
							formData2.append('sub_cat', 9);
							
							<?php foreach($field_r7_f9 as $r1){ 
						...
						swal({
							...
							<?php foreach($field_r8 as $r1){ 
									...
									if(merk_vals == '' || merk_vals == undefined ){
										...
										<?php echo "formData2.append('".$r1['code_question']."', $('#".$r1['code_question']."').val());"; ?>
									}
