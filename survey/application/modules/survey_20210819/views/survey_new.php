                      ...
                      <label for="exampleInputUsername1">A1. Bagaimana status pernikahan Bpk/ Ibu/ Sdr?</label>
					    <div class="row">
						  <div class="col-md-3">
							  <div class="form-check" >
								<label class="form-check-label">
								  <input type="radio" class="form-check-input" name="a1" id="a11" value="single">
								  Belum menikah
								</label>
							  </div>
						  </div>
						   <div class="col-md-3">
							  <div class="form-check">
								<label class="form-check-label">
								  <input type="radio" class="form-check-input" name="a1" id="a12" value="married" >
								  Menikah
								</label>
							  </div>
						   </div>
						   <div class="col-md-3">
							  <div class="form-check">
								<label class="form-check-label">
								  <input type="radio" class="form-check-input" name="a1" id="a12" value="mcm" >
								  Menikah – Cerai mati
								</label>
							  </div>
						   </div>
						   <div class="col-md-3">
							  <div class="form-check">
								<label class="form-check-label">
								  <input type="radio" class="form-check-input" name="a1" id="a13" value="mch" >
								  Menikah – Cerai Hidup
								</label>
							  </div>
						   </div>
                      ...
                      <label for="exampleInputUsername1">A2. Sebagai apa posisi Bpk/ Ibu/ Sdr di keluarga ini?</label>
					    <div class="row">
						  <div class="col-md-3">
							  <div class="form-check" >
								<label class="form-check-label">
								  <input type="radio" class="form-check-input" name="a2" id="a21" value="kk">
								  Kepala Keluarga (KK)
								</label>
							  </div>
						  </div>
						   <div class="col-md-3">
							  <div class="form-check">
								<label class="form-check-label">
								  <input type="radio" class="form-check-input" name="a2" id="a22" value="ik" >
						    ...
						    <div class="col-md-3">
							  <div class="form-check" >
								<label class="form-check-label">
								  <input type="radio" class="form-check-input" name="a2" id="a23" value="ak">
						   ...
						   <div class="col-md-3">
							  <div class="form-check">
								<label class="form-check-label">
								  <input type="radio" class="form-check-input" name="a2" id="a24" value="oki" >
						   ...
						   <div class="col-md-3">
							  <div class="form-check">
								<label class="form-check-label">
								  <input type="radio" class="form-check-input" name="a2" id="a25" value="ski" >
						   ...
						   <div class="col-md-3">
							  <div class="form-check">
								<label class="form-check-label">
								  <input type="radio" class="form-check-input" name="a2" id="a26" value="fs_ll" >
								  Lainnya
								</label>
							  </div>
						   </div>
                      ...
                      <label for="exampleInputUsername1">A3. Berapakah jumlah anggota keluarga Bpk/ Ibu/ Sdr yang tinggal dalam satu rumah?</label>
					    <div class="row">
						  ...
						  <div class="col-md-3">
							  <div class="form-check" >
								<label class="form-check-label">
								  <input type="radio" class="form-check-input" name="a3" id="a31" value="count_1">
								  1
								</label>
							  </div>
						  </div>
						    <div class="col-md-3">
							  <div class="form-check" >
								<label class="form-check-label">
								  <input type="radio" class="form-check-input" name="a3" id="a32" value="count_2">
								  2
								</label>
							  </div>
						  </div>
							  ...
							  <div class="form-check" >
								<label class="form-check-label">
								  <input type="radio" class="form-check-input" name="a3" id="a33" value="count_3">
								  3
								</label>
							  </div>
						  </div>
						    <div class="col-md-3">
							  <div class="form-check" >
								<label class="form-check-label">
								  <input type="radio" class="form-check-input" name="a3" id="a34" value="count_4">
								  4
								</label>
							  </div>
						  </div>
							  ...
							  <div class="form-check" >
								<label class="form-check-label">
								  <input type="radio" class="form-check-input" name="a3" id="a35" value="count_5">
								  5
								</label>
							  </div>
						  </div>
							  ...
							  <div class="form-check" >
								<label class="form-check-label">
								  <input type="radio" class="form-check-input" name="a3" id="a36" value="count_5+">
								  >5
								</label>
							  </div>
						  </div>
					    ...
					    <div class="row">
						    ...
						    <div class="row">
						     <div class="col-md-4">
							  <div class="form-check" >
								<label class="form-check-label">
								  <input type="radio" class="form-check-input" name="b2" id="b21" value="<50">
								  Dibawah Rp 50 Ribu
								</label>
							  </div>
							</div>
						    ...
						    <div class="col-md-4">
							  <div class="form-check" >
								<label class="form-check-label">
								  <input type="radio" class="form-check-input" name="b2" id="b22" value="50-100">
							  ...
							  <div class="form-check" >
								<label class="form-check-label">
								  <input type="radio" class="form-check-input" name="b2" id="b23" value="100-150">
						    ...
						    <div class="col-md-4">
							  <div class="form-check" >
								<label class="form-check-label">
								  <input type="radio" class="form-check-input" name="b2" id="b24" value="150-200">
							  ...
							  <div class="form-check" >
								<label class="form-check-label">
								  <input type="radio" class="form-check-input" name="b2" id="b25" value="200-300">
						   ...
						   <div class="col-md-4">
							  <div class="form-check" >
								<label class="form-check-label">
								  <input type="radio" class="form-check-input" name="b2" id="b26" value=">300">
								  Diatas Rp 300 Ribu
								</label>
							  </div>
						  </div>
...
<div class="col-md-3">
					...
					<div class="form-group" id="f64new-pg" style="display:none">
                      <label for="exampleInputUsername1"><b>F64. Jika jawaban F59:“YA”, jasa ekspedisi apa yang sering Bpk/ Ibu/ Sdr gunakan saat berbelanja online ?</b> </label>
						 <div class="row">
							<?php $situs_musik = ['JNE','SiCepat','Go-Send','Tidak tahu (ditentukan oleh ecommerce)','J&T','Ninja Express','Pos','TiKi','Lainnya']; 
							foreach($situs_musik as $penggunaan_ss){ ?>
								<div class="col-md-3">
								  <div class="form-check mx-sm-2">
									  <label class="form-check-label">
										<input type="checkbox" name="f64new" value="<?php echo $penggunaan_ss; ?>" class="form-check-input" >
											<?php echo $penggunaan_ss; ?>
									  </label>
									</div>
								</div> 
						 ...
						 <div class="row">
							...
							foreach($situs_musik as $penggunaan_ss){ ?>
								...
								<div class="col-md-6">
									  <div class="form-check" >
										<label class="form-check-label">
										  <input type="radio" class="form-check-input" name="F67" id="F67<?php echo $i; ?>" value="<?php echo $penggunaan_ss; ?>">
										  <?php echo $penggunaan_ss; ?>
										</label>
									  </div>
								</div>
...
<button class="btn btn btn-danger" type="button" onClick="back_user()">Kembali ke survey</button>
		...
		//id_pelanggan
			...
			// var $selectAll = $( "input:radio[name=F101]" );
			// $selectAll.on( "change", function() {
