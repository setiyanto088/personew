...
class Survey extends MX_Controller {
	...
	public function new_survey(){
		...
		$session_val = $this->session->userdata['logged_in'];
			...
			$data['array_channel'] = ['RCTI','MNC TV','GTV','iNews','Metro TV','SCTV','ANTV','Trans 7','Trans TV','TV One','NET TV ','CNN Indonesia','Kompas TV'];
			...
			$data['array_family'] = [['Kepala Keluarga','kk'],['Isteri KK','ik'],['Anak Pertama','ak1'],['Anak Kedua','ak2'],['Anak Ketiga','ak3'],['Orang tua KK','oki'],['Saudara KK','ski']];
