          ...
          <div class="col-lg-4 mx-auto">
            <div class="auth-form-light text-left py-5 px-4 px-sm-5">
              <div class="brand-logo">
                <!--<img src="<?php echo $path_dash; ?>images/logo.svg" alt="logo"> -->
              </div>
              <h4>Sign In</h4>
              ...
              <form class="pt-3" id="losloginform">
                ...
                <div class="mt-3">
					<input type="submit" class="btn btn-block btn-primary btn-lg font-weight-medium auth-form-btn" id="submit" placeholder="Password">
            ...
            success: function(response) {
              if (response.status == "success") {
                ...
                window.location.href = "<?php echo base_url('home');?>";  
				  }else if(respod.id_role == 100){
					 
            window.location.href = "<?php echo base_url('home_agent');?>";
          }else{
