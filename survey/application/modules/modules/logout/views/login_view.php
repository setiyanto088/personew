              ...
              <div class="panel-body">
                <form>
                  ...
                  <div>
                    ...
                    <img id="loader" src="<?php echo $image;?>loading.gif" style="width: 27px; height: 27px">
                  </div>
                  ...
                  <div class="separator">
                    ...
                    <div>
                      <h1><i class="fa fa-institution"></i> LOS</h1>
              ...
              <div class="panel-body">
                <form>
                  ...
                  <div>
                    ...
                    <img id="loader2" src="<?php echo $image;?>loading.gif" style="width: 27px; height: 27px">
                  </div>
