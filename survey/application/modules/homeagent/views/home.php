								   ...
								   <div class="col-md-3" style="margin-top:100px;" >
										 <div class="row">
											 ...
											 <div class="col-md-12" style="">
												<h4 class="" style="color:#F1626C" ><b><?php echo number_format($get_summ[0]['konfirmasi'],0,0,'.'); ?></b></h4>
												<h5 class="" style="color:#AEAEAE" ><b>Pelanggan <br>Terkonfirmasi</b></h5>
												<br>
											 </div>
											 
											  <div class="col-md-12" style="">
												<h4 class="" style="color:#F1626C" ><b><?php echo number_format($get_summ[0]['menolak'],0,0,'.'); ?></b></h4>
												<h5 class="" style="color:#AEAEAE" ><b>Pelanggan <br> Tidak Menjawab</b></h5>
												<br>
											 </div>
											 
											  <div class="col-md-12" style="">
												<h4 class="" style="color:#F1626C" ><b><?php echo number_format($get_summ[0]['tidak_mejawab'],0,0,'.'); ?></b></h4>
                ...
                <div class="card-body">
					...
					<div class="row" >
						...
						<div class="col-md-6" style="margin-top:20px">
							<div class="mr-5 mt-3">
							  <h3 class="text-primary fs-30 font-weight-medium" style="color:#F1646E !important;"><?php echo number_format($get_summ[0]['total'],0,0,'.'); ?></h3>
						...
						<div class="col-md-6" style="text-align: right;margin-top:20px">
							<div class="mr-5 mt-3">
							  <h3 class="text-primary fs-30 font-weight-medium" style="color:#F1646E !important;"><?php if($get_summ[0]['total'] == 0){ echo 0; }else{ echo number_format((($get_summ[0]['konfirmasi']/$get_summ[0]['total']))*100,0,0,'.'); } ?>%</h3>
