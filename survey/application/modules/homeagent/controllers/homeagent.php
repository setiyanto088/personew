...
class Homeagent extends MX_Controller {
	...
	public function index()
	{
			...
			$data['get_history'] = $this->home_agent_model->get_history($user_id); 
			$data['get_summ'] = $this->home_agent_model->get_summ($user_id); 
			$data['get_chart'] = $this->home_agent_model->get_chart($user_id); 
