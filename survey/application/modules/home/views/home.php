            ...
            <div class="col-md-12 grid-margin ">
              <div class="row">
                <div class="col-md-3 mb-4  " >
                  <div class="card card-light-danger" style="background-color:#ff1414">
                    <div class="card-body">
                      ...
                      <p><?php //echo number_format(($total_call[0]['total_call']/5000)*100,2,',','.'); ?>  </p>
                    </div>
                  </div>
                </div>
                <div class="col-md-3 mb-4  ">
                  <div class="card card-light-danger" style="background-color:#ff1414">
                    <div class="card-body">
                      ...
                      <p><?php //echo number_format(($total_call_bersedia[0]['total_call']/5000)*100,2,',','.'); ?>  </p>
                    </div>
                  </div>
                </div>
                <div class="col-md-3 mb-4 mb-lg-0  ">
                  <div class="card card-light-danger" style="background-color:#ff1414">
                    <div class="card-body">
                      ...
                      <p><?php //echo number_format(($total_interview[0]['total_call']/5000)*100,2,',','.'); ?>  </p>
                    </div>
                  </div>
                </div>
                <div class="col-md-3 ">
				 ...
				 <div class="col-md-3 mb-4  " >
                  <div class="card card-light-danger" style="background-color:#5b55c2">
                    <div class="card-body">
                      <p class="mb-4">Data Valid</p>
                      <p class="fs-30 mb-2"><?php echo number_format($total_interview[0]['valid_sum'],0,',','.'); ?></p>
                      <p><?php //echo number_format(($total_call[0]['total_call']/5000)*100,2,',','.'); ?>  </p>
                    </div>
                  </div>
                </div>
                <div class="col-md-3 mb-4  ">
                  <div class="card card-light-danger" style="background-color:#5b55c2">
                    <div class="card-body">
                      <p class="mb-4">Data Valid Supevisor</p>
                      <p class="fs-30 mb-2"><?php echo number_format($total_interview[0]['valid_supervisor_sum'],0,',','.'); ?></p>
                      <p><?php //echo number_format(($total_call_bersedia[0]['total_call']/5000)*100,2,',','.'); ?>  </p>
                    </div>
                  </div>
                </div>
                <div class="col-md-3 mb-4 mb-lg-0  ">
                  <div class="card card-light-danger" style="background-color:#5b55c2">
                    <div class="card-body">
                      <p class="mb-4">Data Tidak Valid</p>
                      <p class="fs-30 mb-2"><?php echo number_format($total_interview[0]['invalid_sum'],0,',','.'); ?></p>
                      <p><?php //echo number_format(($total_interview[0]['total_call']/5000)*100,2,',','.'); ?>  </p>
                    </div>
                  </div>
                </div>
                <div class="col-md-3 ">
                  <div class="card card-light-danger" style="background-color:#5b55c2">
                    <div class="card-body">
                      <p class="mb-4">Data Belum Divalidasi</p>
                      <p class="fs-30 mb-2"><?php echo number_format($total_interview[0]['unvalidate_sum'],0,',','.'); ?></p>
                      <p> <?php //echo number_format(((150000-$total_call[0]['total_call'])/1500),3,',','.'); ?> </p>
                    </div>
                  </div>
                </div>
