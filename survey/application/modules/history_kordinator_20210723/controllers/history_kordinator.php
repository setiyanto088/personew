	...
	//	$data['array_kota'] = explode('|',$kota);
		...
		foreach($get_history as $users){
			...
			if($users['status_survey'] == null ){
				...
				$htmls .= '									<div class="row">';
				$htmls .= '										<div class="col-md-2"><br>Supervisor <h4>'.$users['supervisor'].'</h4><br>Surveyor <h4>'.$users['surveyor'].'</h4></div>';
				...
				$htmls .= '										<div class="col-md-2"><br>'.$users['date_survey'].'<br>'.$users['day_survey'].'<br>'.$users['hours_survey'].'<br>'.$users['date_hours_survey'].'</div>';
				$htmls .= '										<div class="col-md-2" style="align:center;" ><br>'.$array_respond[$users['respond_res']].'<br><br><button type="button" class="btn btn-danger btn-sm" onClick="delete_outbound('.$users['id_outbound'].')">Hapus</button></div>';
				$htmls .= '									</div>';
				$htmls .= '								</div>';
				$htmls .= '							</div>';
