	...
	<?php foreach($table_data as $table_datas){ ?>
	   ...
	   <?php } ?>
		...
		<th colspan=5 style="border: 1px solid black;text-align: center;">Urban</th>
		<th colspan=5 style="border: 1px solid black;text-align: center;">Rural</th>
		<th colspan=5 style="border: 1px solid black;text-align: center;">Total</th>
	   </tr>
	    <tr>
				<th style="border: 1px solid black;text-align: center;">Target</th>
                <th style="border: 1px solid black;text-align: center;">Hasil</th>
                <th style="border: 1px solid black;text-align: center;">Valid</th>
                <th style="border: 1px solid black;text-align: center;">Tidak Valid</th>
                <th style="border: 1px solid black;text-align: center;">% Valid</th>
        ...
        <tbody>
	<?php $total_urban = 0; $total_rural = 0; $urban_s = 0; $rural_s = 0; $i=0; $total_urban_int = 0; $total_rural_int = 0;$total_urban_inv = 0; $total_rural_inv = 0;
	...
	<tr style="background-color:#FBC6A4">
		...
		<td style="text-align: right;"><b><?php echo $val[1]; ?></b></td>	
		<td style="text-align: right;"><?php echo $data_survey[$val[0]]['URBAN'] ?></td>
		<td style="text-align: right;"><?php echo $data_survey[$val[0]]['URBAN_VALID'] ?></td>
		<td style="text-align: right;"><?php echo $data_survey[$val[0]]['URBAN_INVALID'] ?></td>
		<td style="text-align: right;"><?php echo number_format(($data_survey[$val[0]]['URBAN_VALID']/$val[1])*100,1,',','.'); ?> %</td>
		<td style="text-align: right;"><b><?php echo $val[2]; ?></b></td>	
		<td style="text-align: right;"><?php echo $data_survey[$val[0]]['RURAL'] ?></td>
		<td style="text-align: right;"><?php echo $data_survey[$val[0]]['RURAL_VALID'] ?></td>
		<td style="text-align: right;"><?php echo $data_survey[$val[0]]['RURAL_INVALID'] ?></td>
		<td style="text-align: right;"><?php echo number_format(($data_survey[$val[0]]['RURAL_VALID']/$val[2])*100,1,',','.'); ?> %</td>
		<td style="text-align: right;"><b><?php echo $val[3]; ?></b></td>	
		<td style="text-align: right;"><?php echo $data_survey[$val[0]]['RURAL']+$data_survey[$val[0]]['URBAN'] ?></td>
		<td style="text-align: right;"><?php echo $data_survey[$val[0]]['RURAL_VALID']+$data_survey[$val[0]]['URBAN_VALID'] ?></td>
		<td style="text-align: right;"><?php echo $data_survey[$val[0]]['RURAL_INVALID']+$data_survey[$val[0]]['URBAN_INVALID'] ?></td>
		<td style="text-align: right;<?php if($total_pers < 31){ echo " color:red;"; }elseif($total_pers > 30 && $total_pers < 71 ){ echo " color:#FFD523;"; }else{ echo " color:green;"; } ?>"><strong><h6><?php echo number_format((($data_survey[$val[0]]['RURAL_VALID']+$data_survey[$val[0]]['URBAN_VALID'])/($val[2]+$val[1]))*100,1,',','.'); ?> %</strong></h6></td>
	</tr>
	<?php
	
	$i++; $total_urban += $data_survey[$val[0]]['URBAN_VALID']; $total_rural += $data_survey[$val[0]]['RURAL_VALID']; $total_urban_int += $data_survey[$val[0]]['URBAN']; $total_rural_int += $data_survey[$val[0]]['RURAL']; 
	$total_urban_inv += $data_survey[$val[0]]['URBAN_INVALID']; $total_rural_inv += $data_survey[$val[0]]['RURAL_INVALID']; 
	$urban_s += $val[1];
	$rural_s += $val[2];
        ...
        <tfoot>
            <tr>
               <th></th>
                ...
                <th style="text-align: right;"><?php echo number_format($total_urban_int,0,',','.'); ?></th>
                <th style="text-align: right;"><?php echo number_format($total_urban,0,',','.'); ?></th>
                <th style="text-align: right;"><?php echo number_format($total_urban_inv,0,',','.'); ?></th>
				...
				<th style="text-align: right;"><?php echo number_format($total_rural_int,0,',','.'); ?></th>
				<th style="text-align: right;"><?php echo number_format($total_rural,0,',','.'); ?></th>
				<th style="text-align: right;"><?php echo number_format($total_rural_inv,0,',','.'); ?></th>
				...
				<th style="text-align: right;"><?php echo number_format($total_urban_int+$total_rural_int,0,',','.'); ?></th>
				<th style="text-align: right;"><?php echo number_format($total_urban+$total_rural,0,',','.'); ?></th>
				<th style="text-align: right;"><?php echo number_format($total_urban_inv+$total_rural_inv,0,',','.'); ?></th>
