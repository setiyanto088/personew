...
class Home_supervisor extends MX_Controller {
	...
	public function index()
	{
			...
			$data['total_respondent'] = $this->home_supervisor_model->respondent_data($session_val['user_id']);
			
			//print_r($data['total_respondent']);die;
			...
			foreach($array_surveys as $array_surveys){
				...
				$array_data[$array_surveys['KOTA_KABUPATEN_DAGRI']]['URBAN_VALID'] = $array_surveys['URBAN_VALID'];
				$array_data[$array_surveys['KOTA_KABUPATEN_DAGRI']]['URBAN_INVALID'] = $array_surveys['URBAN_INVALID'];
				$array_data[$array_surveys['KOTA_KABUPATEN_DAGRI']]['RURAL'] = $array_surveys['RURAL'];
				$array_data[$array_surveys['KOTA_KABUPATEN_DAGRI']]['RURAL_VALID'] = $array_surveys['RURAL_VALID'];
				$array_data[$array_surveys['KOTA_KABUPATEN_DAGRI']]['RURAL_INVALID'] = $array_surveys['RURAL_INVALID'];
			}
			...
			$array_target = [['MEDAN',38,92,130],['BANDA ACEH',13,34,47],['PEMANTANG SIANTAR',8,12,20],['PEKANBARU',8,104,112],['PADANG',60,60,120],['PALEMBANG',26,67,93],['JAMBI',11,56,67],['BANDAR LAMPUNG',23,72,95],['JAKARTA TIMUR',209,118,327],['BEKASI',229,169,398],['JAKARTA SELATAN',276,12,288],['JAKARTA BARAT',188,12,200],['TANGERANG',121,122,243],['JAKARTA UTARA',213,13,226],['JAKARTA PUSAT',130,28,158],['BOGOR',93,180,273],['TANGERANG SELATAN',126,47,173],['DEPOK',147,64,211],['BANDUNG',267,141,408],['TASIKMALAYA',28,36,64],['SUKABUMI',36,38,74],['SEMARANG',117,51,168],['YOGYAKARTA',27,5,32],['SURAKARTA/SOLO',29,9,38],['SURABAYA',105,51,156],['MALANG',18,59,77],['SIDOARJO',51,43,94],['DENPASAR',49,4,53],['BALIKPAPAN',84,25,109],['SAMARINDA',109,32,141],['BANJARMASIN',43,10,53],['PONTIANAK',66,11,77],['MAKASSAR',63,50,113],['MANADO',64,7,71],['AMBON',40,15,55],['MATARAM',26,10,36]];
			...
			foreach($data['get_location'] as $location){
				...
				$data['array_t1'][$ii] = $array_targets[strtoupper($location['location_name'])];
			...
			$array_data = $this->createDateRangeArray('2022-09-01','2022-12-31');
