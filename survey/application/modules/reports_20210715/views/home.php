<style>
 .table-responsive .responsive{
	...
	<?php } ?>
		...
		<td style="text-align: right;"><?php echo number_format((($data_survey[$val[0]]['RURAL']+$data_survey[$val[0]]['URBAN'])/($val[2]+$val[1]))*100,1,',','.'); ?> %</td>
	</tr>
...
<?php $i++; $total_urban += $data_survey[$val[0]]['URBAN']; $total_rural += $data_survey[$val[0]]['RURAL']; } ?>
		...
		<th style="text-align: right;"><?php echo number_format((($total_urban+$total_rural)/5000)*100,1,',','.'); ?> %</th>
            </tr>
        </tfoot>
    </table>
                </div>
