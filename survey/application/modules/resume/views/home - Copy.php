      ...
      <div class="page-content container-fluid">
        <div class="row" data-plugin="matchHeight" data-by-row="true">
          ...
          <div class="col-xl-4 col-lg-6">
            ...
            <div class="card" id="widgetUserList">
              <div class="card-header cover overlay">
                <img class="cover-image h-200" src="<?php echo $path; ?>assets//examples/images/dashboard-header.jpg"
                  alt="..." />
                <div class="overlay-panel vertical-align overlay-background">
                  <div class="vertical-align-middle">
                    <a class="avatar avatar-100 float-left mr-20" href="javascript:void(0)">
                      <img src="<?php echo $path2; ?>global/portraits/5.jpg" alt="">
                    </a>
                ...
                <ul class="list-group list-group-full list-group-dividered mb-0">
                    ...
                    <div class="media">
                      <div class="pr-20">
                        <a class="avatar avatar-lg" href="javascript:void(0)">
                          <img class="img-responsive" src="<?php echo $path2; ?>global/portraits/1.jpg"
                            alt="...">
                        </a>
                      </div>
                  ...
                  <li class="list-group-item">
                    <div class="media">
                      <div class="pr-20">
                        <a class="avatar avatar-lg" href="javascript:void(0)">
                          <img class="img-responsive" src="<?php echo $path2; ?>global/portraits/2.jpg"
                            alt="...">
                        </a>
                      </div>
                      <div class="media-body">
                  ...
                  <li class="list-group-item">
                    <div class="media">
                      <div class="pr-20">
                        <a class="avatar avatar-lg" href="javascript:void(0)">
                          <img class="img-responsive" src="<?php echo $path2; ?>global/portraits/3.jpg"
                            alt="...">
                        </a>
                      </div>
                      <div class="media-body">
              ...
              <i class="icon md-chevron-left" aria-hidden="true"></i>
                ...
                <div class="text-right">
                  ...
                  <a class="avatar ml-10" data-toggle="tooltip" href="#" data-placement="right" title="June Lane">
                    <img src="<?php echo $path2; ?>global/portraits/4.jpg" alt="...">
                  </a>
                </div>
              </div>
                  ...
                  <div class="chat chat-left">
                    <div class="chat-avatar">
                      <a class="avatar" data-toggle="tooltip" href="#" data-placement="left" title="">
                        <img src="<?php echo $path2; ?>global/portraits/5.jpg" alt="Edward Fletcher">
                      </a>
                    </div>
                    <div class="chat-body">
                  ...
                  <div class="chat">
                    <div class="chat-avatar">
                      <a class="avatar" data-toggle="tooltip" href="#" data-placement="right" title="">
                        <img src="<?php echo $path2; ?>global/portraits/4.jpg" alt="June Lane">
                      </a>
                    </div>
                    <div class="chat-body">
          ...
          <div class="col-xl-4 col-lg-6">
            ...
            <div class="card card-shadow">
              <div class="card-header cover overlay">
                <div class="cover-background h-200" style="background-image: url('<?php echo $path2; ?>global/photos/placeholder.png')"></div>
              </div>
              <div class="card-block px-30 py-20" style="height:calc(100% - 250px);">
                <div class="mb-10" style="margin-top: -70px;">
                  <a class="avatar avatar-100 bg-white img-bordered" href="javascript:void(0)">
                    <img src="<?php echo $path2; ?>global/portraits/2.jpg" alt="">
                  </a>
                </div>
                <div class="mb-20">
