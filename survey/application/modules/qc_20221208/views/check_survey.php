						 ...
						 <div class="col-md-12 grid-margin stretch-card" style="margin-bottom:4px">
						  <div class="card">
							<div class="card-body">
								<div class="row">
									<div class="col-10">
									<?php if($valid == null || $valid == '' || $valid == 0 || $valid == 3 ){ ?>
									<button class="btn btn btn-info" style="" type="button" onClick="validate(<?php echo $id_outbound; ?>,1)" >Valid</button>
