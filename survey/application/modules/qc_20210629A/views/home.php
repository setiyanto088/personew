                ...
                <div class="col-md-3 mb-4  " >
                  <div class="card card-light-danger" style="background-color:#ff1414">
                    <div class="card-body">
                      ...
                      <p><?php echo number_format(($data_qc[0]['cnt']/$data_qc_tot[0]['total_survey']),3,',','.'); ?> % </p>
                    </div>
                  </div>
                </div>
                <div class="col-md-3 mb-4  ">
                  <div class="card card-light-danger" style="background-color:#ff1414">
                    <div class="card-body">
                      ...
                      <p><?php echo number_format(($data_qc[0]['valid']/$data_qc_tot[0]['total_survey']),3,',','.'); ?> % </p>
                    </div>
                  </div>
                </div>
                <div class="col-md-3 mb-4 mb-lg-0  ">
                  <div class="card card-light-danger" style="background-color:#ff1414">
                    <div class="card-body">
                      ...
                      <p><?php echo number_format(($data_qc[0]['tidak_valid']/$data_qc_tot[0]['total_survey']),3,',','.'); ?> % </p>
                    </div>
                  </div>
                </div>
                <div class="col-md-3 ">
                  <div class="card card-light-danger" style="background-color:#ff1414">
                    <div class="card-body">
                      ...
                      <p><?php echo number_format((($data_qc_tot[0]['total_survey']-$data_qc[0]['cnt'])/$data_qc_tot[0]['total_survey']),3,',','.'); ?> % </p>
                    </div>
                  </div>
                </div>
              </div>
