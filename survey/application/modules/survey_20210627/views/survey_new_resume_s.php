						  ...
						  <div class="col-md-6">
							  <div class="form-check" >
								<label class="form-check-label">
								  <input type="radio" class="form-check-input formxx" name="r1" id="r1_L" value="L">
								  Laki-laki
								</label>
							  </div>
						  </div>
						   <div class="col-md-6">
							  <div class="form-check">
								<label class="form-check-label">
								  <input type="radio" class="form-check-input formxx" name="r1" id="r1_P" value="P" >
								  Perempuan
								</label>
							  </div>
						   </div>
                    ...
                    <div class="form-group" class="page_1">
                      <label for="exampleInputUsername1">R2. Usia *</label>
					    <div class="row">
						 <div class="col-md-2">
							  <div class="form-group">
								<select class="form-control formxxc" id="r2lainnya" onChange="selectAge()">
						  ...
						  <div class="col-md-2">
							  <div class="form-check" >
								<label class="form-check-label">
								  <input type="radio" class="form-check-input formxx" name="r2" id="r2_17-25" value="17-25">
								  17-25 Tahun
								</label>
							  </div>
						  </div>
						   <div class="col-md-2">
							  <div class="form-check">
								<label class="form-check-label">
								  <input type="radio" class="form-check-input formxx" name="r2" id="r2_26-39" value="26-39" >
								  26-39 Tahun
								</label>
							  </div>
						   </div>
						    <div class="col-md-2">
							  <div class="form-check" >
								<label class="form-check-label">
								  <input type="radio" class="form-check-input formxx" name="r2" id="r2_40-55" value="40-55">
								  40-55 Tahun
								</label>
							  </div>
						  </div>
						   <div class="col-md-2">
							  <div class="form-check">
								<label class="form-check-label">
								  <input type="radio" class="form-check-input formxx" name="r2" id="r2_56-60" value="56-60" >
								  56-60 Tahun
								</label>
							  </div>
						   </div>
                      ...
                      <label for="exampleInputUsername1">R3. Pendidikan Terakhir *</label>
					    <div class="row">
						  ...
						  <div class="col-md-3">
							  <div class="form-check" >
								<label class="form-check-label">
								  <input type="radio" class="form-check-input formxx" name="r3" id="r3_SD" value="SD">
								  SD
								</label>
							  </div>
						  </div>
						   <div class="col-md-3">
							  <div class="form-check">
								<label class="form-check-label">
								  <input type="radio" class="form-check-input formxx" name="r3" id="r3_SMP" value="SMP" >
								  SMP
								</label>
							  </div>
						   </div>
						    <div class="col-md-3">
							  <div class="form-check" >
								<label class="form-check-label">
								  <input type="radio" class="form-check-input formxx" name="r3" id="r3_SMA" value="SMA">
								  SMA
								</label>
							  </div>
						  </div>
						   <div class="col-md-3">
							  <div class="form-check">
								<label class="form-check-label">
								  <input type="radio" class="form-check-input formxx" name="r3" id="r3_D1" value="D1" >
								  D1
								</label>
							  </div>
						   </div>
						     <div class="col-md-3">
							  <div class="form-check">
								<label class="form-check-label">
								  <input type="radio" class="form-check-input formxx" name="r3" id="r3_D3" value="D3" >
								  D3
								</label>
							  </div>
						   </div>
						    <div class="col-md-3">
							  <div class="form-check" >
								<label class="form-check-label">
								  <input type="radio" class="form-check-input formxx" name="r3" id="r3_D4_S1" value="D4_S1">
								  D4/S1
								</label>
							  </div>
						  </div>
						   <div class="col-md-3">
							  <div class="form-check">
								<label class="form-check-label">
								  <input type="radio" class="form-check-input formxx" name="r3" id="r3_S2" value="S2" >
								  S2
								</label>
							  </div>
						   </div>
						    <div class="col-md-3">
							  <div class="form-check" >
								<label class="form-check-label">
								  <input type="radio" class="form-check-input formxx" name="r3" id="r3_S3" value="S3">
								  S3
								</label>
							  </div>
						  </div>
                      ...
                      <label for="exampleInputUsername1">R4. Pekerjaan Utama *</label>
					    <div class="row">
						  ...
						  <div class="col-md-3">
							  <div class="form-check" >
								<label class="form-check-label">
								  <input type="radio" class="form-check-input formxx" name="r4" id="r4_Pelajar" value="Pelajar">
								  Pelajar/ Mahasiswa
						    ...
						    <div class="col-md-3">
							  <div class="form-check" >
								<label class="form-check-label">
								  <input type="radio" class="form-check-input formxx" name="r4" id="r4_art" value="art">
								  Ibu Rumah Tangga
								</label>
							  </div>
						  </div>
						    <div class="col-md-3">
							  <div class="form-check">
								<label class="form-check-label">
								  <input type="radio" class="form-check-input formxx" name="r4" id="r4_pensiunan" value="pensiunan" >
								  Pensiunan
								</label>
							  </div>
						   </div>
							  ...
							  <div class="form-check">
								<label class="form-check-label">
								  <input type="radio" class="form-check-input formxx" name="r4" id="r4_bumn" value="bumn" >
								  BUMN atau BUMD
								</label>
							  </div>
						   </div>
						   <div class="col-md-3">
							  <div class="form-check">
								<label class="form-check-label">
								  <input type="radio" class="form-check-input formxx" name="r4" id="r4_asn" value="asn" >
								  ASN (PNS)/ TNI/ POLRI
						    ...
						    <div class="col-md-3">
							 <div class="form-group">
							  <input type="text" class="form-control formxx" id="jabatanASN" placeholder="Jabatan ASN (PNS)/ TNI/ POLRI">
							</div>
						   </div>
						   ...
						   <div class="col-md-3">
							  <div class="form-check">
								<label class="form-check-label">
								  <input type="radio" class="form-check-input formxx" name="r4" id="r4_swasta" value="swasta" >
								  Pegawai Swasta
								</label>
							  </div>
						   </div>
						    ...
						    <div class="col-md-3">
							  <div class="form-check" >
								<label class="form-check-label">
								  <input type="radio" class="form-check-input formxx" name="r4" id="r4_mandiri" value="mandiri">
						    ...
						    <div class="col-md-3">
							  <div class="form-check" >
								<label class="form-check-label">
								  <input type="radio" class="form-check-input formxx" name="r4" id="r4_wiraswasta" value="wiraswasta">
                      ...
                      <label for="exampleInputUsername1">A1. Bagaimana status pernikahan Bpk/ Ibu/ Sdr?</label>
					    <div class="row">
						  <div class="col-md-3">
							  <div class="form-check" >
								<label class="form-check-label">
								  <input type="radio" class="form-check-input formxx" name="a1" id="a1_single" value="single">
								  Belum menikah
								</label>
							  </div>
						  </div>
						   <div class="col-md-3">
							  <div class="form-check">
								<label class="form-check-label">
								  <input type="radio" class="form-check-input formxx" name="a1" id="a1_married" value="married" >
								  Menikah
								</label>
							  </div>
						   </div>
						   <div class="col-md-3">
							  <div class="form-check">
								<label class="form-check-label">
								  <input type="radio" class="form-check-input formxx" name="a1" id="a1_mcm" value="mcm" >
								  Menikah – Cerai mati
								</label>
							  </div>
						   </div>
						   <div class="col-md-3">
							  <div class="form-check">
								<label class="form-check-label">
								  <input type="radio" class="form-check-input formxx" name="a1" id="a1_mch" value="mch" >
								  Menikah – Cerai Hidup
								</label>
							  </div>
						   </div>
                      ...
                      <label for="exampleInputUsername1">A2. Sebagai apa posisi Bpk/ Ibu/ Sdr di keluarga ini?</label>
					    <div class="row">
						  <div class="col-md-3">
							  <div class="form-check" >
								<label class="form-check-label">
								  <input type="radio" class="form-check-input formxx" name="a2" id="a2_kk" value="kk">
								  Kepala Keluarga (KK)
								</label>
							  </div>
						  </div>
						   <div class="col-md-3">
							  <div class="form-check">
								<label class="form-check-label">
								  <input type="radio" class="form-check-input formxx" name="a2" id="a2_ik" value="ik" >
						    ...
						    <div class="col-md-3">
							  <div class="form-check" >
								<label class="form-check-label">
								  <input type="radio" class="form-check-input formxx" name="a2" id="a2_ak" value="ak">
						   ...
						   <div class="col-md-3">
							  <div class="form-check">
								<label class="form-check-label">
								  <input type="radio" class="form-check-input formxx" name="a2" id="a2_oki" value="oki" >
						   ...
						   <div class="col-md-3">
							  <div class="form-check">
								<label class="form-check-label">
								  <input type="radio" class="form-check-input formxx" name="a2" id="a2_ski" value="ski" >
						   ...
						   <div class="col-md-3">
							  <div class="form-check">
								<label class="form-check-label">
								  <input type="radio" class="form-check-input formxx" name="a2" id="a2_fs_ll" value="fs_ll" >
								  Lainnya
								</label>
							  </div>
						   </div>
                      ...
                      <label for="exampleInputUsername1">A3. Berapakah jumlah anggota keluarga Bpk/ Ibu/ Sdr yang tinggal dalam satu rumah?</label>
					    <div class="row">
						  ...
						  <div class="col-md-3">
							  <div class="form-check" >
								<label class="form-check-label">
								  <input type="radio" class="form-check-input formxx" name="a3" id="a3_count_1" value="count_1">
								  1
								</label>
							  </div>
						  </div>
						    <div class="col-md-3">
							  <div class="form-check" >
								<label class="form-check-label">
								  <input type="radio" class="form-check-input formxx" name="a3" id="a3_count_2" value="count_2">
								  2
								</label>
							  </div>
						  </div>
							  ...
							  <div class="form-check" >
								<label class="form-check-label">
								  <input type="radio" class="form-check-input formxx" name="a3" id="a3_count_3" value="count_3">
								  3
								</label>
							  </div>
						  </div>
						    <div class="col-md-3">
							  <div class="form-check" >
								<label class="form-check-label">
								  <input type="radio" class="form-check-input formxx" name="a3" id="a3_count_4" value="count_4">
								  4
								</label>
							  </div>
						  </div>
							  ...
							  <div class="form-check" >
								<label class="form-check-label">
								  <input type="radio" class="form-check-input formxx" name="a3" id="a3_count_5" value="count_5">
								  5
								</label>
							  </div>
						  </div>
							  ...
							  <div class="form-check" >
								<label class="form-check-label">
								  <input type="radio" class="form-check-input formxx" name="a3" id="a3_count_6" value="count_5+">
								  >5
								</label>
							  </div>
						  </div>
							  ...
							  <tbody>
								<tr>
								  <td scope="row" data-label="Anggota Keluarga">
											<input type="checkbox" name="a4_check" id="a4_check_family_kk" value="family_kk" class="form-check-input formxx tft formxx" >Kepala keluarga KK
								  </td>
								  <td data-label="Jenis Kelamin">
												  <input type="radio" class="form-check-input formxx tft formxx" name="a4_kk_gen" id="a4_kk_gen_L" value="L">
												  Laki-laki&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
												  <input type="radio" class="form-check-input formxx tft formxx" name="a4_kk_gen" id="a4_kk_gen_P" value="P" >
												  Perempuan
								  </td>
								  <td data-label="Usia">
									
									  <input type="text" class="tft formxx" id="a4_kk_usia" placeholder="Usia" maxlength="4" size="20">
								  </td>
								</tr>
								<tr>
								  <td scope="row" data-label="Anggota Keluarga">
											<input type="checkbox" name="a4_check" id="a4_check_family_ik" value="family_ik" class="form-check-input formxx" >Isteri dari  Kepala <br> Keluarga
								  </td>
								  <td data-label="Jenis Kelamin">
												  <input type="radio" class="form-check-input formxx" name="a4_ik_gen" id="a4_ik_gen_L" value="L">
												  Laki-laki&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
												  <input type="radio" class="form-check-input formxx" name="a4_ik_gen" id="a4_ik_gen_P" value="P" >
												  Perempuan
								  </td>
								  <td data-label="Usia">
								...
								<tr>
								  <td scope="row" data-label="Anggota Keluarga">
											<input type="checkbox" name="a4_check" id="a4_check_family_ak1" value="family_ak1" class="form-check-input formxx" >Anak pertama dari <br> kepala keluarga
								  </td>
								  <td data-label="Jenis Kelamin">
												  <input type="radio" class="form-check-input formxx" name="a4_ak1_gen" id="a4_ak1_gen_L" value="L">
												  Laki-laki&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
												  <input type="radio" class="form-check-input formxx" name="a4_ak1_gen" id="a4_ak1_gen_P" value="P" >
												  Perempuan
								  </td>
								  <td data-label="Usia">
								...
								<tr>
								  <td scope="row" data-label="Anggota Keluarga">
											<input type="checkbox" name="a4_check" id="a4_check_family_ak2" value="family_ak2" class="form-check-input formxx" >Anak kedua dari <br> kepala keluarga
								  </td>
								  <td data-label="Jenis Kelamin">
												  <input type="radio" class="form-check-input formxx" name="a4_ak2_gen" id="a4_ak2_gen_L" value="L">
												  Laki-laki&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
												  <input type="radio" class="form-check-input formxx" name="a4_ak2_gen" id="a4_ak2_gen_P" value="P" >
												  Perempuan
								  </td>
								  <td data-label="Usia">
								...
								<tr>
								  <td scope="row" data-label="Anggota Keluarga">
											<input type="checkbox" name="a4_check" id="a4_check_family_ak3" value="family_ak3" class="form-check-input formxx" >Anak ketiga dari <br> kepala keluarga
								  </td>
								  <td data-label="Jenis Kelamin">
												  <input type="radio" class="form-check-input formxx" name="a4_ak3_gen" id="a4_ak3_gen_L" value="L">
												  Laki-laki&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
												  <input type="radio" class="form-check-input formxx" name="a4_ak3_gen" id="a4_ak3_gen_P" value="P" >
												  Perempuan
								  </td>
								  <td data-label="Usia">
								...
								<tr>
								  <td scope="row" data-label="Anggota Keluarga">
											<input type="checkbox" name="a4_check" id="a4_check_family_oki" value="family_oki" class="form-check-input formxx" >Orang tua dari Kepala <br> keluarga/ Isteri KK
								  </td>
								  <td data-label="Jenis Kelamin">
												  <input type="radio" class="form-check-input formxx" name="a4_oki_gen" id="a4_oki_gen_L" value="L">
												  Laki-laki&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
												  <input type="radio" class="form-check-input formxx" name="a4_oki_gen" id="a4_oki_gen_P" value="P" >
												  Perempuan
								  </td>
								  <td data-label="Usia">
								...
								<tr>
								  <td scope="row" data-label="Anggota Keluarga">
											<input type="checkbox" name="a4_check" id="a4_check_family_ski" value="family_ski" class="form-check-input formxx" >Saudara dari Kepala <br> keluarga/ isteri KK
								  </td>
								  <td data-label="Jenis Kelamin">
												  <input type="radio" class="form-check-input formxx" name="a4_ski_gen" id="a4_ski_gen_L" value="L">
												  Laki-laki&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
												  <input type="radio" class="form-check-input formxx" name="a4_ski_gen" id="a4_ski_gen_P" value="P" >
												  Perempuan
								  </td>
								  <td data-label="Usia">
                      ...
                      <label for="exampleInputUsername1">A5. Berapakah jumlah anggota keluarga Bpk/ Ibu/ Sdr yang tinggal dalam satu rumah yang memiliki penghasilan?</label>
					    <div class="row">
						  ...
						  <div class="col-md-3">
							  <div class="form-check" >
								<label class="form-check-label">
								  <input type="radio" class="form-check-input formxx" name="a5" id="a5_count_1_ff" value="count_1_ff">
								  1 Orang
								</label>
							  </div>
						  </div>
						    <div class="col-md-3">
							  <div class="form-check" >
								<label class="form-check-label">
								  <input type="radio" class="form-check-input formxx" name="a5" id="a5_count_2_ff" value="count_2_ff">
								  2 Orang
								</label>
							  </div>
						  </div>
							  ...
							  <div class="form-check" >
								<label class="form-check-label">
								  <input type="radio" class="form-check-input formxx" name="a5" id="a5_count_3_ff" value="count_3_ff">
								  3 Orang
								</label>
							  </div>
						  </div>
						    <div class="col-md-3">
							  <div class="form-check" >
								<label class="form-check-label">
								  <input type="radio" class="form-check-input formxx" name="a5" id="a5_count_4_ff" value="count_4_ff">
								  4 Orang
								</label>
							  </div>
						  </div>
							  ...
							  <div class="form-check" >
								<label class="form-check-label">
								  <input type="radio" class="form-check-input formxx" name="a5" id="a5_count_5_ff" value="count_5_ff">
								  5 Orang
								</label>
							  </div>
						  </div>
					    ...
					    <div class="row">
						    ...
						    <div class="row">
						     <div class="col-md-4">
							  <div class="form-check" >
								<label class="form-check-label">
								  <input type="radio" class="form-check-input formxx" name="a6" id="a6_2-" value="2-">
								  Dibawah Rp 2.0 Juta
								</label>
							  </div>
							</div>
						    ...
						    <div class="col-md-4">
							  <div class="form-check" >
								<label class="form-check-label">
								  <input type="radio" class="form-check-input formxx" name="a6" id="a6_2-3" value="2-3">
							  ...
							  <div class="form-check" >
								<label class="form-check-label">
								  <input type="radio" class="form-check-input formxx" name="a6" id="a6_3-45" value="3-45">
						    ...
						    <div class="col-md-4">
							  <div class="form-check" >
								<label class="form-check-label">
								  <input type="radio" class="form-check-input formxx" name="a6" id="a6_45-6" value="45-6">
							  ...
							  <div class="form-check" >
								<label class="form-check-label">
								  <input type="radio" class="form-check-input formxx" name="a6" id="a6_6-9" value="6-9">
						   ...
						   <div class="col-md-4">
							  <div class="form-check" >
								<label class="form-check-label">
								  <input type="radio" class="form-check-input formxx" name="a6" id="a6_9s" value="9s">
								  Diatas Rp 9.0 Juta
								</label>
							  </div>
						  </div>
                      ...
                      <label for="exampleInputUsername1">A7. Bagaimana status kepemilikan rumah yang Bpk/ Ibu/ Sdr tempati saat ini?</label>
					    <div class="row">
						  ...
						  <div class="col-md-3">
							  <div class="form-check" >
								<label class="form-check-label">
								  <input type="radio" class="form-check-input formxx" name="a7" id="a7_rs" value="rs">
								  Milik sendiri
								</label>
							  </div>
						  </div>
						    <div class="col-md-3">
							  <div class="form-check" >
								<label class="form-check-label">
								  <input type="radio" class="form-check-input formxx" name="a7" id="a7_rd" value="rd">
								  Rumah dinas
								</label>
							  </div>
						  </div>
						    ...
						    <div class="col-md-3">
							  <div class="form-check" >
								<label class="form-check-label">
								  <input type="radio" class="form-check-input formxx" name="a7" id="a7_sk" value="sk">
								  Sewa/ kontrak
								</label>
							  </div>
						  </div>
							  ...
							  <div class="form-check" >
								<label class="form-check-label">
								  <input type="radio" class="form-check-input formxx" name="a7" id="a7_rot" value="rot">
								  Rumah Orang tua
								</label>
							  </div>
						  </div>
							  ...
							  <div class="form-check" >
								<label class="form-check-label">
								  <input type="radio" class="form-check-input formxx" name="a7" id="a7_ho_ll" value="ho_ll">
								  Lainnya
								</label>
							  </div>
						  </div>
					    ...
					    <div class="row">
						  ...
						  <div class="col-md-3">
							  <div class="form-check mx-sm-2">
								  <label class="form-check-label">
									<input type="checkbox" name="b1" id="b1_axis" value="axis" class="form-check-input formxx" >
									Axis
								  </label>
								</div>
						  </div>
						   <div class="col-md-3">
							  <div class="form-check mx-sm-2">
								  <label class="form-check-label">
									<input type="checkbox" name="b1" id="b1_indosat" value="indosat" class="form-check-input formxx" >
									Indosat
								  </label>
								</div>
						  </div> 
						  ...
						  <div class="col-md-3">
							  <div class="form-check mx-sm-2">
								  <label class="form-check-label">
									<input type="checkbox" name="b1" id="b1_telkomsel" value="telkomsel" class="form-check-input formxx" >
									Telkomsel
								  </label>
								</div>
						  </div> 
						  <div class="col-md-3">
							  <div class="form-check mx-sm-2">
								  <label class="form-check-label">
									<input type="checkbox" name="b1" id="b1_three" value="three" class="form-check-input formxx" >
									Three (3)
								  </label>
								</div>
						  </div> 
						  <div class="col-md-3">
							  <div class="form-check mx-sm-2">
								  <label class="form-check-label">
									<input type="checkbox" name="b1" id="b1_xl" value="xl" class="form-check-input formxx" >
									XL
								  </label>
								</div>
						  </div> 
						  <div class="col-md-3">
							  <div class="form-check mx-sm-2">
								  <label class="form-check-label">
									<input type="checkbox" name="b1" id="b1_lainnya" value="lainnya" class="form-check-input formxx" >
									Lainnya
								  </label>
								</div>
						  </div> 
					    ...
					    <div class="row">
						    ...
						    <div class="row">
						     <div class="col-md-4">
							  <div class="form-check" >
								<label class="form-check-label">
								  <input type="radio" class="form-check-input formxx" name="b2" id="b2_-5" value="-50">
								  Dibawah Rp 50 Ribu
								</label>
							  </div>
							</div>
						    ...
						    <div class="col-md-4">
							  <div class="form-check" >
								<label class="form-check-label">
								  <input type="radio" class="form-check-input formxx" name="b2" id="b2_50-100" value="50-100">
							  ...
							  <div class="form-check" >
								<label class="form-check-label">
								  <input type="radio" class="form-check-input formxx" name="b2" id="b2_100-150" value="100-150">
						    ...
						    <div class="col-md-4">
							  <div class="form-check" >
								<label class="form-check-label">
								  <input type="radio" class="form-check-input formxx" name="b2" id="b2_150-200" value="150-200">
							  ...
							  <div class="form-check" >
								<label class="form-check-label">
								  <input type="radio" class="form-check-input formxx" name="b2" id="b2_200-300" value="200-300">
						   ...
						   <div class="col-md-4">
							  <div class="form-check" >
								<label class="form-check-label">
								  <input type="radio" class="form-check-input formxx" name="b2" id="b2_300s" value=">300">
								  Diatas Rp 300 Ribu
								</label>
							  </div>
						  </div>
					    ...
					    <div class="row">
						    ...
						    <div class="row">
						     <div class="col-md-4">
							  <div class="form-check" >
								<label class="form-check-label">
								  <input type="radio" class="form-check-input formxx" name="b3" id="b3_data_very_high" value="data_very_high">
								  Setiap hari
								</label>
							  </div>
							</div>
						    ...
						    <div class="col-md-4">
							  <div class="form-check" >
								<label class="form-check-label">
								  <input type="radio" class="form-check-input formxx" name="b3" id="b3_data_high" value="data_high">
							  ...
							  <div class="form-check" >
								<label class="form-check-label">
								  <input type="radio" class="form-check-input formxx" name="b3" id="b3_data_medhigh" value="data_medhigh">
						    ...
						    <div class="col-md-4">
							  <div class="form-check" >
								<label class="form-check-label">
								  <input type="radio" class="form-check-input formxx" name="b3" id="b3_data_med" value="data_med">
								  Seminggu sekali
								</label>
							  </div>
						  </div>
							  ...
							  <div class="form-check" >
								<label class="form-check-label">
								  <input type="radio" class="form-check-input formxx" name="b3" id="b3_data_low" value="data_low">
								  Sebulan sekali
								</label>
							  </div>
						  </div>
						   <div class="col-md-4">
							  <div class="form-check" >
								<label class="form-check-label">
								  <input type="radio" class="form-check-input formxx" name="b3" id="b3_data_very_low" value="data_very_low">
					    ...
					    <div class="row">
						    ...
						    <div class="row">
						     <div class="col-md-4">
							  <div class="form-check" >
								<label class="form-check-label">
								  <input type="radio" class="form-check-input formxx" name="b4" id="b4_1" value="1">
								  Hari ini
								</label>
							  </div>
							</div>
						    ...
						    <div class="col-md-4">
							  <div class="form-check" >
								<label class="form-check-label">
								  <input type="radio" class="form-check-input formxx" name="b4" id="b4_1-3" value="1-3">
								  1-3 hari yang lalu
								</label>
							  </div>
						  </div>
							  ...
							  <div class="form-check" >
								<label class="form-check-label">
								  <input type="radio" class="form-check-input formxx" name="b4" id="b4_4-6" value="4-6">
								  4-6 hari yang lalu
								</label>
							  </div>
						  </div>
						    <div class="col-md-4">
							  <div class="form-check" >
								<label class="form-check-label">
								  <input type="radio" class="form-check-input formxx" name="b4" id="b4_7" value="7">
								  Seminggu yang lalu
								</label>
							  </div>
						  </div>
                      ...
                      <label for="exampleInputUsername1">C1. Seberapa sering Bpk/ Ibu/ Sdr menonton acara TV di rumah?</label>
						    ...
						    <div class="row">
						     <div class="col-md-4">
							  <div class="form-check" >
								<label class="form-check-label">
								  <input type="radio" class="form-check-input formxx" name="c1" id="c1_1-2mg" value="1-2mg">
								  1-2 kali seminggu
								</label>
							  </div>
							</div>
							 <div class="col-md-4">
							  <div class="form-check" >
								<label class="form-check-label">
								  <input type="radio" class="form-check-input formxx" name="c1" id="c1_3-6mg" value="3-6mg">
								  3-6 kali seminggu
								</label>
							  </div>
						  </div>
						    <div class="col-md-4">
							  <div class="form-check" >
								<label class="form-check-label">
								  <input type="radio" class="form-check-input formxx" name="c1" id="c1_1hari" value="1hari">
								 1 kali sehari
								</label>
							  </div>
						  </div>
							  ...
							  <div class="form-check" >
								<label class="form-check-label">
								  <input type="radio" class="form-check-input formxx" name="c1" id="c1_2-3hari" value="2-3hari">
								  2-3 kali sehari
								</label>
							  </div>
						  </div>
							  ...
							  <div class="form-check" >
								<label class="form-check-label">
								  <input type="radio" class="form-check-input formxx" name="c1" id="c1_3shari" value="3shari">
						   ...
						   <div class="col-md-4">
							  <div class="form-check" >
								<label class="form-check-label">
								  <input type="radio" class="form-check-input formxx" name="c1" id="c1_1mg-" value="1mg-">
					    ...
					    <div class="row">
							...
							<div class="col-md-4">
						     ...
						     <div class="col-md-4">
							  <div class="form-check" >
								<label class="form-check-label">
								  <input type="radio" class="form-check-input formxx" name="c2" id="c2_1-" value="1-">
								  < 1 Jam
								</label>
							  </div>
							</div>
						    ...
						    <div class="col-md-4">
							  <div class="form-check" >
								<label class="form-check-label">
								  <input type="radio" class="form-check-input formxx" name="c2" id="c2_1-2" value="1-2">
								  1 – 2 Jam
								</label>
							  </div>
						  </div>
							  ...
							  <div class="form-check" >
								<label class="form-check-label">
								  <input type="radio" class="form-check-input formxx" name="c2" id="c2_2-4" value="2-4">
								  2.1 – 4.0 Jam
								</label>
							  </div>
						  </div>
						    <div class="col-md-4">
							  <div class="form-check" >
								<label class="form-check-label">
								  <input type="radio" class="form-check-input formxx" name="c2" id="c2_4-6" value="4-6">
								  4.1 – 6.0 Jam
								</label>
							  </div>
						  </div>
							  ...
							  <div class="form-check" >
								<label class="form-check-label">
								  <input type="radio" class="form-check-input formxx" name="c2" id="c2_6-8" value="6-8">
								  6.1 – 8.0 Jam
								</label>
							  </div>
						  </div>
						   <div class="col-md-4">
							  <div class="form-check" >
								<label class="form-check-label">
								  <input type="radio" class="form-check-input formxx" name="c2" id="c2_8s" value="8s">
								  > 8 Jam
								</label>
							  </div>
						  </div>
                      ...
                      <label for="exampleInputUsername1">C3-1. Siapa saja anggota keluarga yang mononton acara TV di rumah Saat WEEKDAY?</label>
					    <div class="row">
						    ...
						    <div class="col-md-3 <?php echo $array_familys[1]; ?>" style="display: none;">
							  <div class="form-check mx-sm-2">
								  <label class="form-check-label">
									<input type="checkbox" name="c3-1" id="c3-1_<?php echo $array_familys[1]; ?>" value="<?php echo $array_familys[1]; ?>" class="form-check-input formxx" >
                      ...
                      <label for="exampleInputUsername1">C3-2. Siapa saja anggota keluarga yang mononton acara TV di rumah Saat WEEKEND?</label>
					    <div class="row">
						    ...
						    <div class="col-md-3 <?php echo $array_familys[1]; ?>" style="display: none;">
							  <div class="form-check mx-sm-2">
								  <label class="form-check-label">
									<input type="checkbox" name="c3-2" id="c3-2_<?php echo $array_familys[1]; ?>" value="<?php echo $array_familys[1]; ?>" class="form-check-input formxx" >
									<?php echo $array_familys[0]; ?>
								  </label>
								</div>
							</div>
                      ...
                      <label for="exampleInputUsername1">C4. Pada waktu berikut ini, siapa saja anggota keluarga yang mononton acara TV di rumah?</label>
						...
						<div class="col-md-10">
						   ...
						   <?php foreach($array_family as $array_familys){ ?>
						    <div class="col-md-3 <?php echo $array_familys[1]; ?>" style="display: none;">
							  <div class="form-check mx-sm-2">
								  <label class="form-check-label">
									<input type="checkbox" name="c4-1" id="c4-1_<?php echo $array_familys[1]; ?>" value="<?php echo $array_familys[1]; ?>" class="form-check-input formxx" >
									<?php echo $array_familys[0]; ?>
								  </label>
								</div>
							</div>
						...
						<?php foreach($array_family as $array_familys){ ?>
						     <div class="col-md-3 <?php echo $array_familys[1]; ?>" style="display: none;">
							  <div class="form-check mx-sm-2">
								  <label class="form-check-label">
									<input type="checkbox" name="c4-2" id="c4-2_<?php echo $array_familys[1]; ?>" value="<?php echo $array_familys[1]; ?>" class="form-check-input formxx" >
									<?php echo $array_familys[0]; ?>
								  </label>
								</div>
							</div>
						...
						<div class="col-md-10">
						    ...
						    <div class="col-md-3 <?php echo $array_familys[1]; ?>" style="display: none;">
							  <div class="form-check mx-sm-2">
								  <label class="form-check-label">
									<input type="checkbox" name="c4-3" id="c4-3_<?php echo $array_familys[1]; ?>" value="<?php echo $array_familys[1]; ?>" class="form-check-input formxx" >
									<?php echo $array_familys[0]; ?>
								  </label>
								</div>
							</div>
						...
						<div class="col-md-10">
						  ...
						  <?php foreach($array_family as $array_familys){ ?>
						    <div class="col-md-3 <?php echo $array_familys[1]; ?>" style="display: none;">
							  <div class="form-check mx-sm-2">
								  <label class="form-check-label">
									<input type="checkbox" name="c4-4" id="c4-4_<?php echo $array_familys[1]; ?>" value="<?php echo $array_familys[1]; ?>" class="form-check-input formxx" >
									<?php echo $array_familys[0]; ?>
								  </label>
								</div>
							</div>
						...
						<div class="col-md-10">
						  ...
						  <?php foreach($array_family as $array_familys){ ?>
						    <div class="col-md-3 <?php echo $array_familys[1]; ?>" style="display: none;">
							  <div class="form-check mx-sm-2">
								  <label class="form-check-label">
									<input type="checkbox" name="c4-5" id="c4-5_<?php echo $array_familys[1]; ?>" value="<?php echo $array_familys[1]; ?>" class="form-check-input formxx" >
									<?php echo $array_familys[0]; ?>
								  </label>
								</div>
							</div>
					  ...
					  <?php $c5int = 1; foreach($array_genre as $array_genres){ ?>
						...
						<div class="col-md-10">
						   ...
						   <div class="col-md-3 <?php echo $array_familys[1]; ?>" style="display: none;">
							  <div class="form-check mx-sm-2">
								  <label class="form-check-label">
									<input type="checkbox" id="c5-<?php echo $c5int; ?>_<?php echo $array_familys[1]; ?>" name="c5-<?php echo $c5int; ?>" value="<?php echo $array_familys[1]; ?>" class="form-check-input formxx" >
									<?php echo $array_familys[0]; ?>
								  </label>
								</div>
							</div>
					  ...
					  <br>
						...
						<div class="col-md-12">
						    ...
						    <div class="col-md-6">
							  <div class="form-check" >
								<label class="form-check-label">
								  <input type="radio" class="form-check-input formxx" name="c6" id="c6_Tidak" value="Tidak">
								  Tidak
								</label>
							  </div>
							</div>
						   <div class="col-md-6">
							  <div class="form-check" >
								<label class="form-check-label">
								  <input type="radio" class="form-check-input formxx" name="c6" id="c6_Ya" value="Ya">
								  Ya
								</label>
							  </div>
							</div>
					  ...
					  <br>
						...
						<div class="col-md-12">
						    ...
						    <div class="col-md-6">
							  <div class="form-check" >
								<label class="form-check-label">
								  <input type="radio" class="form-check-input formxx" name="c7" id="c7_digital" value="digital">
								  TV Digital
								</label>
							  </div>
							</div>
						   <div class="col-md-6">
							  <div class="form-check" >
								<label class="form-check-label">
								  <input type="radio" class="form-check-input formxx" name="c7" id="c7_analog" value="analog">
								  TV Analog
								</label>
							  </div>
							</div>
					  ...
					  <br>
					    ...
					    <div class="row">
						   ...
						   <div class="col-md-4">
							  <div class="form-check" >
								<label class="form-check-label">
								  <input type="radio" class="form-check-input formxx" name="c8" id="c8_1-" value="1-">
								  < 1 Jam
								</label>
							  </div>
							</div>
						    ...
						    <div class="col-md-4">
							  <div class="form-check" >
								<label class="form-check-label">
								  <input type="radio" class="form-check-input formxx" name="c8" id="c8_1-2" value="1-2">
								  1 – 2 Jam
								</label>
							  </div>
						  </div>
							  ...
							  <div class="form-check" >
								<label class="form-check-label">
								  <input type="radio" class="form-check-input formxx" name="c8" id="c8_2-4" value="2-4">
								  2.1 – 4.0 Jam
								</label>
							  </div>
						  </div>
						    <div class="col-md-4">
							  <div class="form-check" >
								<label class="form-check-label">
								  <input type="radio" class="form-check-input formxx" name="c8" id="c8_4-6" value="4-6">
								  4.1 – 6.0 Jam
								</label>
							  </div>
						  </div>
							  ...
							  <div class="form-check" >
								<label class="form-check-label">
								  <input type="radio" class="form-check-input formxx" name="c8" id="c8_6-8" value="6-8">
								  6.1 – 8.0 Jam
								</label>
							  </div>
						  </div>
						   <div class="col-md-4">
							  <div class="form-check" >
								<label class="form-check-label">
								  <input type="radio" class="form-check-input formxx" name="c8" id="c8_8s" value="8s">
								  > 8 Jam
								</label>
							  </div>
						  </div>	
								...
								<table id="table_resp_s" class="table table-striped">
								  ...
								  <?php $uc = 1; foreach($array_channel as $array_channels){ ?>
									<tr>
									  ...
									  <div class="form-check mx-sm-2">
										  <label class="form-check-label">
											<input type="checkbox" name="c82-<?php echo $uc; ?>" id="c82-<?php echo $uc; ?>_<?php echo str_replace(' ','_',$array_channels); ?>" value="<?php echo $array_channels; ?>" class="form-check-input formxx" >
								  ...
								  <?php $uc++; } ?>
									<tr>
									  ...
									  <div class="form-check mx-sm-2">
										  <label class="form-check-label">
											<input type="checkbox" class="form-check-input formxx" >
											Lainnya
										  </label>
										</div>
									  </td>
					  ...
					  <br>
						...
						<div class="col-md-12">
						    ...
						    <div class="col-md-6">
							  <div class="form-check" >
								<label class="form-check-label">
								  <input type="radio" class="form-check-input formxx" name="c9" id="c9_Tidak" value="Tidak">
								  Tidak
								</label>
							  </div>
							</div>
						   <div class="col-md-6">
							  <div class="form-check" >
								<label class="form-check-label">
								  <input type="radio" class="form-check-input formxx" name="c9" id="c9_Ya" value="Ya">
								  Ya
								</label>
							  </div>
							</div>
						...
						<div class="col-md-12">
						    <div class="row">
						     <div class="col-md-4">
							  <div class="form-check mx-sm-2">
								  <label class="form-check-label">
									<input type="checkbox" name="c10" id="c10_praktis" value="praktis" class="form-check-input formxx" >
									Lebih praktis
								  </label>
								</div>
						  </div> 
						  <div class="col-md-4">
							  <div class="form-check mx-sm-2">
								  <label class="form-check-label">
									<input type="checkbox" name="c10" id="c10_Kualitas" value="Kualitas" class="form-check-input formxx" >
						  ...
						  <div class="col-md-4">
							  <div class="form-check mx-sm-2">
								  <label class="form-check-label">
									<input type="checkbox" name="c10" id="c10_Tidak_ada" value="Tidak_ada" class="form-check-input formxx" >
						  ...
						  <div class="col-md-4">
							  <div class="form-check mx-sm-2">
								  <label class="form-check-label">
									<input type="checkbox" name="c10" id="c10_other" value="other" class="form-check-input formxx" >
									Lainnya
								  </label>
								</div>
						  </div> 
					  ...
					  <br>
					    ...
					    <div class="row">
						   ...
						   <div class="col-md-4">
							  <div class="form-check" >
								<label class="form-check-label">
								  <input type="radio" class="form-check-input formxx" name="c11" id="c11_1-" value="1-">
								  < 1 Jam
								</label>
							  </div>
							</div>
						    ...
						    <div class="col-md-4">
							  <div class="form-check" >
								<label class="form-check-label">
								  <input type="radio" class="form-check-input formxx" name="c11" id="c11_1-2" value="1-2">
								  1 – 2 Jam
								</label>
							  </div>
						  </div>
							  ...
							  <div class="form-check" >
								<label class="form-check-label">
								  <input type="radio" class="form-check-input formxx" name="c11" id="c11_2-4" value="2-4">
								  2.1 – 4.0 Jam
								</label>
							  </div>
						  </div>
						    <div class="col-md-4">
							  <div class="form-check" >
								<label class="form-check-label">
								  <input type="radio" class="form-check-input formxx" name="c11" id="c11_4-6" value="4-6">
								  4.1 – 6.0 Jam
								</label>
							  </div>
						  </div>
							  ...
							  <div class="form-check" >
								<label class="form-check-label">
								  <input type="radio" class="form-check-input formxx" name="c11" id="c11_6-8" value="6-8">
								  6.1 – 8.0 Jam
								</label>
							  </div>
						  </div>
						   <div class="col-md-4">
							  <div class="form-check" >
								<label class="form-check-label">
								  <input type="radio" class="form-check-input formxx" name="c11" id="c11_8s" value="8s">
								  > 8 Jam
								</label>
							  </div>
						  </div>		
								...
								<table id="table_resp_s" class="table table-striped">
								  ...
								  <?php $uc = 1;foreach($array_channel as $array_channels){ ?>
									<tr>
									  ...
									  <div class="form-check mx-sm-2">
										  <label class="form-check-label">
											<input type="checkbox" name="c112-<?php echo $uc; ?>" value="<?php echo $array_channels; ?>" class="form-check-input formxx" >
											<?php echo $array_channels; ?>
										  </label>
										</div>
									  </td>
						...
						<div class="col-md-8">
						   ...
						   <?php foreach($array_family as $array_familys){ ?>
							<div class="col-md-3 <?php echo $array_familys[1]; ?>" style="display: none;">
							  <div class="form-check mx-sm-2">
								  <label class="form-check-label">
									<input type="checkbox" name="c12_fam<?php echo $ii; ?>" id="c12_fam<?php echo $ii; ?>_<?php echo $array_familys[1]; ?>" value="<?php echo $array_familys[1]; ?>" class="form-check-input formxx" >
									<?php echo $array_familys[0]; ?>
								  </label>
								</div>
							</div>
								  ...
								  <?php $iii = 1;for($iii=1;$iii <21;$iii++){ ?>
									<tr>
									  ...
									  <td>
										...
										<div class="form-group">
										<label class="form-check-label formxx" id="progra_skala_<?php echo $iii; ?>">
										  Program <?php echo $iii; ?>
										  <input type="hidden" id="d1_program_skala<?php echo $ii; ?>" value="" />
										  </label>
											<select class="form-control formxxc" id="d1_skala_prog_<?php echo $iii; ?>">
                      ...
                      <label for="exampleInputUsername1">D2. Hal apa yang menjadi perhatian utama Bpk/ Ibu/ Sdr dalam menilai kualitas program acara TV?</label>
					    <div class="row">
						  <div class="col-md-3">
							  <div class="form-check" >
								<label class="form-check-label">
								  <input type="radio" class="form-check-input formxx" name="d2" id="d2_1" value="1">
						   ...
						   <div class="col-md-3">
							  <div class="form-check">
								<label class="form-check-label">
								  <input type="radio" class="form-check-input formxx" name="d2" id="d2_2" value="2" >
						   ...
						   <div class="col-md-3">
							  <div class="form-check">
								<label class="form-check-label">
								  <input type="radio" class="form-check-input formxx" name="d2" id="d2_3" value="3" >
						   ...
						   <div class="col-md-3">
							  <div class="form-check">
								<label class="form-check-label">
								  <input type="radio" class="form-check-input formxx" name="d2" id="d2_4" value="4" >
						    ...
						    <div class="col-md-3">
							  <div class="form-check" >
								<label class="form-check-label">
								  <input type="radio" class="form-check-input formxx" name="d2" id="d2_5" value="5">
						   ...
						   <div class="col-md-3">
							  <div class="form-check">
								<label class="form-check-label">
								  <input type="radio" class="form-check-input formxx" name="d2" id="d2_6" value="6" >
								  Menghibur
								</label>
							  </div>
						   </div>
						   <div class="col-md-3">
							  <div class="form-check">
								<label class="form-check-label">
								  <input type="radio" class="form-check-input formxx" name="d2" id="d2_7" value="7" >
								  Lainnya, sebutkan:
								</label>
							  </div>
						   </div>
                      ...
                      <label for="exampleInputUsername1"><b>D3. Menurut Bpk/ Ibu/ Sdr, adakah program acara TV baru yang perlu ditambahkan? Jika ada, program seperti apa yang perlu ditambahkan?</b> </label>
					    <div class="row">
						  <div class="col-md-3">
							  <div class="form-check" >
								<label class="form-check-label">
								  <input type="radio" class="form-check-input formxx" name="d3" id="d3_Tidak" value="Tidak">
								  Tidak
								</label>
							  </div>
						  </div>
						   <div class="col-md-3">
							  <div class="form-check">
								<label class="form-check-label">
								  <input type="radio" class="form-check-input formxx" name="d3" id="d3_Ya" value="Ya" >
								  Ada:
								</label>
							  </div>
						   </div>
					    ...
					    <div class="row">
						  ...
						  <?php $c5int = 1; foreach($array_channel_h as $array_channel_hs){ ?>
							...
							<div class="col-md-3">
							  <div class="form-check mx-sm-2">
								  <label class="form-check-label">
									<input type="checkbox" name="e1" id="e1_<?php echo str_replace(' ','_',$array_channel_hs); ?>" value="<?php echo $array_channel_hs; ?>" class="form-check-input formxx" >
						  ...
						  <?php $c5int++; } ?>
							...
							<div class="col-md-3">
							  <div class="form-check mx-sm-2">
								  <label class="form-check-label">
									<input type="checkbox" name="e1_other" value="other" class="form-check-input formxx" >
										Lainnya
								  </label>
								</div>
							</div>
						 ...
						 <div class="col-md-9">
							<div class="row">
								<div class="col-md-4">
								  <div class="form-check mx-sm-2">
									  <label class="form-check-label">
										<input type="checkbox" name="e2-<?php echo $ii; ?>" id="e2-<?php echo $ii; ?>_movies" value="movies" class="form-check-input formxx" >
										Film (Movies)
									  </label>
									</div>
								</div>
								<div class="col-md-4">
								  <div class="form-check mx-sm-2">
									  <label class="form-check-label">
										<input type="checkbox"  name="e2-<?php echo $ii; ?>" id="e2-<?php echo $ii; ?>_musik" value="musik" class="form-check-input formxx" >
										Musik
									  </label>
									</div>
								</div>
								<div class="col-md-4">
								  <div class="form-check mx-sm-2">
									  <label class="form-check-label">
										<input type="checkbox"  name="e2-<?php echo $ii; ?>" id="e2-<?php echo $ii; ?>_kids" value="kids" class="form-check-input formxx" >
								...
								<div class="col-md-4">
								  <div class="form-check mx-sm-2">
									  <label class="form-check-label">
										<input type="checkbox"  name="e2-<?php echo $ii; ?>" id="e2-<?php echo $ii; ?>_religi" value="religi" class="form-check-input formxx" >
										Religi
									  </label>
									</div>
								</div>
								<div class="col-md-4">
								  <div class="form-check mx-sm-2">
									  <label class="form-check-label">
										<input type="checkbox"  name="e2-<?php echo $ii; ?>" id="e2-<?php echo $ii; ?>_lifestyle" value="lifestyle" class="form-check-input formxx" >
								...
								<div class="col-md-4">
								  <div class="form-check mx-sm-2">
									  <label class="form-check-label">
										<input type="checkbox"  name="e2-<?php echo $ii; ?>" id="e2-<?php echo $ii; ?>_sport" value="sport" class="form-check-input formxx" >
										Olah Raga (Sport)
									  </label>
									</div>
								</div>
								<div class="col-md-4">
								  <div class="form-check mx-sm-2">
									  <label class="form-check-label">
										<input type="checkbox"  name="e2-<?php echo $ii; ?>" id="e2-<?php echo $ii; ?>_technology" value="technology" class="form-check-input formxx" >
								...
								<div class="col-md-4">
								  <div class="form-check mx-sm-2">
									  <label class="form-check-label">
										<input type="checkbox"  name="e2-<?php echo $ii; ?>" id="e2-<?php echo $ii; ?>_news" value="news" class="form-check-input formxx" >
										Berita (News)
									  </label>
									</div>
								</div>
								<div class="col-md-4">
								  <div class="form-check mx-sm-2">
									  <label class="form-check-label">
										<input type="checkbox"  name="e2-<?php echo $ii; ?>" id="e2-<?php echo $ii; ?>_drama_series" value="drama_series" class="form-check-input formxx" >
								...
								<div class="col-md-4">
								  <div class="form-check mx-sm-2">
									  <label class="form-check-label">
										<input type="checkbox" name="e2-<?php echo $ii; ?>" id="e2-<?php echo $ii; ?>_ftv" value="ftv" class="form-check-input formxx" >
										FTV / Sinetron Pendek
									  </label>
									</div>
								</div>
                      ...
                      <label for="exampleInputUsername1"><b>F1. Apakah Bpk/ Ibu/ Sdr suka nonton film di BIOSKOP? </b> </label>
					    <div class="row">
							...
							<div class="col-md-6">
							  <div class="form-check" >
								<label class="form-check-label">
								  <input type="radio" class="form-check-input formxx" name="f1" id="f1_Tidak" value="Tidak">
								  Tidak
								</label>
							  </div>
						  </div>
						  <div class="col-md-6">
							  <div class="form-check" >
								<label class="form-check-label">
								  <input type="radio" class="form-check-input formxx" name="f1" id="f1_Ya" value="Ya">
								  Ya
								</label>
							  </div>
						  </div>
                      ...
                      <label for="exampleInputUsername1"><b>F2. Jika jawaban F1:“YA”, Seberapa sering Bpk/ Ibu/ Sdr atau keluarga menonton BIOSKOP?</b> </label>
						 ...
						 <div class="row">
							...
							<div class="col-md-3">
							  <div class="form-check" >
								<label class="form-check-label">
								  <input type="radio" class="form-check-input formxx" name="f2" id="f2_0" value="0">
								  1 kali sebulan
								</label>
							  </div>
						  </div>
						  <div class="col-md-3">
							  <div class="form-check" >
								<label class="form-check-label">
								  <input type="radio" class="form-check-input formxx" name="f2" id="f2_1" value="1">
								  Seminggu sekali
								</label>
							  </div>
						  </div>
						   <div class="col-md-3">
							  <div class="form-check" >
								<label class="form-check-label">
								  <input type="radio" class="form-check-input formxx" name="f2" id="f2_2" value="2">
						   ...
						   <div class="col-md-3">
							  <div class="form-check" >
								<label class="form-check-label">
								  <input type="radio" class="form-check-input formxx" name="f2" id="f2_3" value="3">
								  2-3 kali sebulan
								</label>
							  </div>
						  </div>
						   <div class="col-md-3">
							  <div class="form-check" >
								<label class="form-check-label">
								  <input type="radio" class="form-check-input formxx" name="f2" id="f2_4" value="4">
								  Seminggu 2 kali
								</label>
							  </div>
						  </div>
                      ...
                      <label for="exampleInputUsername1"><b>F3. Jika jawaban F1:“YA”,  Dimana Bpk/ Ibu/ Sdr biasanya nonton film dibioskop?</b> </label>
						 ...
						 <div class="row">
							...
							<div class="col-md-3">
							  <div class="form-check mx-sm-2">
								  <label class="form-check-label">
									<input type="checkbox" name="f3" id="f3_studio21" value="studio21" class="form-check-input formxx" >
									Studio 21
								  </label>
								</div>
							</div> 
							<div class="col-md-3">
							  <div class="form-check mx-sm-2">
								  <label class="form-check-label">
									<input type="checkbox" name="f3" id="f3_cinema_xx1" value="cinema_xx1" class="form-check-input formxx" >
									Cinema XXI
								  </label>
								</div>
							</div> 
							<div class="col-md-3">
							  <div class="form-check mx-sm-2">
								  <label class="form-check-label">
									<input type="checkbox" name="f3" id="f3_cgv_blitz" value="cgv_blitz" class="form-check-input formxx" >
									CGV*Blitz
								  </label>
								</div>
							</div> 
							<div class="col-md-3">
							  <div class="form-check mx-sm-2">
								  <label class="form-check-label">
									<input type="checkbox" name="f3" id="f3_cinemaxx" value="cinemaxx" class="form-check-input formxx" >
									Cinemaxx
								  </label>
								</div>
							</div> 
							<div class="col-md-3">
							  <div class="form-check mx-sm-2">
								  <label class="form-check-label">
									<input type="checkbox" name="f3" id="f3_platinum" value="platinum" class="form-check-input formxx" >
									Platinum Cineplex
								  </label>
								</div>
							</div> 
							<div class="col-md-3">
							  <div class="form-check mx-sm-2">
								  <label class="form-check-label">
									<input type="checkbox" name="f3" id="f3_lainnya" value="lainnya" class="form-check-input formxx" >
									Lainnya
								  </label>
								</div>
							</div> 
                      ...
                      <label for="exampleInputUsername1"><b>F4. Jika jawaban F1:“YA”,  Kapan terakhir kali Bpk/ Ibu/ Sdr menonton film dibioskop?</b> </label>
						 ...
						 <div class="row">
							...
							<div class="col-md-4">
							  <div class="form-check" >
								<label class="form-check-label">
								  <input type="radio" class="form-check-input formxx" name="f4" id="f4_0" value="0">
								  Seminggu yang lalu
								</label>
							  </div>
						  </div>
						  <div class="col-md-4">
							  <div class="form-check" >
								<label class="form-check-label">
								  <input type="radio" class="form-check-input formxx" name="f4" id="f4_1" value="1">
						   ...
						   <div class="col-md-4">
							  <div class="form-check" >
								<label class="form-check-label">
								  <input type="radio" class="form-check-input formxx" name="f4" id="f4_2" value="2">
								  Sebulan yang lalu
								</label>
							  </div>
						  </div>
						   <div class="col-md-4">
							  <div class="form-check" >
								<label class="form-check-label">
								  <input type="radio" class="form-check-input formxx" name="f4" id="f4_3" value="3">
								  2 - 6 Bulan yang lalu
								</label>
							  </div>
						  </div>
						   <div class="col-md-4">
							  <div class="form-check" >
								<label class="form-check-label">
								  <input type="radio" class="form-check-input formxx" name="f4" id="f4_4" value="4">
								  1 Tahun yang lalu
								</label>
							  </div>
						  </div>
						   <div class="col-md-4">
							  <div class="form-check" >
								<label class="form-check-label">
								  <input type="radio" class="form-check-input formxx" name="f4" id="f4_5" value="5">
                      ...
                      <label for="exampleInputUsername1"><b>F5. Dimana biasanya Bpk/ Ibu/ Sdr kumpul – kumpul/ hangout/ nongkrong dengan teman / rekan / sahabat?</b> </label>
						 ...
						 <div class="row">
							...
							<div class="col-md-3">
							  <div class="form-check mx-sm-2">
								  <label class="form-check-label">
									<input type="checkbox" name="f5" id="f5_tamankota" value="tamankota" class="form-check-input formxx" >
									Taman Kota
								  </label>
								</div>
							</div> 
							<div class="col-md-3">
							  <div class="form-check mx-sm-2">
								  <label class="form-check-label">
									<input type="checkbox" name="f5" id="f5_perpustakaan" value="perpustakaan" class="form-check-input formxx" >
									Perpustakaan
								  </label>
								</div>
							</div> 
							<div class="col-md-3">
							  <div class="form-check mx-sm-2">
								  <label class="form-check-label">
									<input type="checkbox" name="f5" id="f5_gym" value="gym" class="form-check-input formxx" >
							...
							<div class="col-md-3">
							  <div class="form-check mx-sm-2">
								  <label class="form-check-label">
									<input type="checkbox" name="f5" id="f5_kafe" value="kafe" class="form-check-input formxx" >
									Kafe / Resto
								  </label>
								</div>
							</div> 
							<div class="col-md-3">
							  <div class="form-check mx-sm-2">
								  <label class="form-check-label">
									<input type="checkbox" name="f5" id="f5_sekolah" value="sekolah" class="form-check-input formxx" >
									Sekolah / Kampus
								  </label>
								</div>
							</div> 
							<div class="col-md-3">
							  <div class="form-check mx-sm-2">
								  <label class="form-check-label">
									<input type="checkbox" name="f5" id="f5_lainnya" value="lainnya" class="form-check-input formxx" >
									Lainnya
								  </label>
								</div>
							</div> 
                      ...
                      <label for="exampleInputUsername1"><b>F6. Kapan terakhir kali Bpk/ Ibu/ Sdr kumpul – kumpul/ hangout/ nongkrong dengan teman / rekan / sahabat?</b> </label>
						 ...
						 <div class="row">
							...
							<div class="col-md-4">
							  <div class="form-check" >
								<label class="form-check-label">
								  <input type="radio" class="form-check-input formxx" name="f6" id="f6_0" value="0">
								  1-3 hari yang lalu
								</label>
							  </div>
						  </div>
						  <div class="col-md-4">
							  <div class="form-check" >
								<label class="form-check-label">
								  <input type="radio" class="form-check-input formxx" name="f6" id="f6_1" value="1">
								  Seminggu yang lalu
								</label>
							  </div>
						  </div>
						   <div class="col-md-4">
							  <div class="form-check" >
								<label class="form-check-label">
								  <input type="radio" class="form-check-input formxx" name="f6" id="f6_2" value="2">
								  Sebulan yang lalu
								</label>
							  </div>
						  </div>
						   <div class="col-md-4">
							  <div class="form-check" >
								<label class="form-check-label">
								  <input type="radio" class="form-check-input formxx" name="f6" id="f6_3" value="3">
								  4-6 hari yang lalu
								</label>
							  </div>
						  </div>
						   <div class="col-md-4">
							  <div class="form-check" >
								<label class="form-check-label">
								  <input type="radio" class="form-check-input formxx" name="f6" id="f6_4" value="4">
								  2 – 3 minggu yang lalu
								</label>
							  </div>
						  </div>
						   <div class="col-md-4">
							  <div class="form-check" >
								<label class="form-check-label">
								  <input type="radio" class="form-check-input formxx" name="f6" id="f6_5" value="5">
                      ...
                      <label for="exampleInputUsername1"><b>F7. Apakah Bpk/ Ibu/ Sdr ikut dalam sebuah Klub Olahraga yang rutin mengikutinya? Jika ”Ya”, sebutkan nama klub-nya! </b> </label>
					    <div class="row">
							...
							<div class="col-md-4">
							  <div class="form-check" >
								<label class="form-check-label">
								  <input type="radio" class="form-check-input formxx" name="f7" id="f7_Tidak" value="Tidak">
								  Tidak
								</label>
							  </div>
						  </div>
						  <div class="col-md-4">
							  <div class="form-check" >
								<label class="form-check-label">
								  <input type="radio" class="form-check-input formxx" name="f7" id="f7_Ya" value="Ya">
								  Ya,sebut nama klub 
								</label>
							  </div>
						  </div>
                      ...
                      <label for="exampleInputUsername1"><b>F8. Jika jawaban F7:“YA”,  Sebutkan jenis olahraganya? </b> </label>
						 ...
						 <div class="row">
							...
							<div class="col-md-3">
							  <div class="form-check" >
								<label class="form-check-label">
								  <input type="radio" class="form-check-input formxx" name="f8" id="f8_Futsal" value="Futsal">
								  Futsal
								</label>
							  </div>
						  </div>
						  <div class="col-md-3">
							  <div class="form-check" >
								<label class="form-check-label">
								  <input type="radio" class="form-check-input formxx" name="f8" id="f8_Tennis" value="Tennis">
								  Tennis
								</label>
							  </div>
						  </div>
						   <div class="col-md-3">
							  <div class="form-check" >
								<label class="form-check-label">
								  <input type="radio" class="form-check-input formxx" name="f8" id="f8_Badminton" value="Badminton">
								  Bulu Tangkis
								</label>
							  </div>
						  </div>
						   <div class="col-md-3">
							  <div class="form-check" >
								<label class="form-check-label">
								  <input type="radio" class="form-check-input formxx" name="f8" id="f8_Running" value="Running">
								  Running
								</label>
							  </div>
						  </div>
						   <div class="col-md-3">
							  <div class="form-check" >
								<label class="form-check-label">
								  <input type="radio" class="form-check-input formxx" name="f8" id="f8_Volly" value="Volly">
								  Volly
								</label>
							  </div>
						  </div>
						   <div class="col-md-3">
							  <div class="form-check" >
								<label class="form-check-label">
								  <input type="radio" class="form-check-input formxx" name="f8" id="f8_Sepeda" value="Sepeda">
								  Sepeda
								</label>
							  </div>
						  </div>
						  <div class="col-md-3">
							  <div class="form-check" >
								<label class="form-check-label">
								  <input type="radio" class="form-check-input formxx" name="f8" id="f8_Lainnya" value="Lainnya">
								  Lainnya
								</label>
							  </div>
						  </div>
					...
					<div class="form-group" id="f9-pg" style="display:none">
						 ...
						 <div class="row">
							...
							<div class="col-md-4">
							  <div class="form-check" >
								<label class="form-check-label">
								  <input type="radio" class="form-check-input formxx" name="F9" id="F9_0" value="0">
								  1-3 hari yang lalu
								</label>
							  </div>
						  </div>
						  <div class="col-md-4">
							  <div class="form-check" >
								<label class="form-check-label">
								  <input type="radio" class="form-check-input formxx" name="F9" id="F9_1" value="1">
								  Seminggu yang lalu
								</label>
							  </div>
						  </div>
						   <div class="col-md-4">
							  <div class="form-check" >
								<label class="form-check-label">
								  <input type="radio" class="form-check-input formxx" name="F9" id="F9_2" value="2">
								  Sebulan yang lalu
								</label>
							  </div>
						  </div>
						   <div class="col-md-4">
							  <div class="form-check" >
								<label class="form-check-label">
								  <input type="radio" class="form-check-input formxx" name="F9" id="F9_3" value="3">
								  4-6 hari yang lalu
								</label>
							  </div>
						  </div>
						   <div class="col-md-4">
							  <div class="form-check" >
								<label class="form-check-label">
								  <input type="radio" class="form-check-input formxx" name="F9" id="F9_4" value="4">
								  2 – 3 minggu yang lalu
								</label>
							  </div>
						  </div>
						   <div class="col-md-4">
							  <div class="form-check" >
								<label class="form-check-label">
								  <input type="radio" class="form-check-input formxx" name="F9" id="F9_5" value="5">
								  Lebih dari sebulan yang lalu
								</label>
							  </div>
						  </div>
						   ...
						   foreach($array_ragam_media as $array_ragam_medias){ ?>
							...
							<br>
							   ...
							   <div class="col-md-3">
								<div class="form-check mx-sm-2">
										  <label class="form-check-label">
											<input type="checkbox" name="F10-k<?php echo $ffd; ?>" id="F10-k<?php echo $ffd; ?>_1" value="1" class="form-check-input formxx" >
							   ...
							   <div class="col-md-9">
								 ...
								 <div class="col-md-4">
									  <div class="form-check" >
										<label class="form-check-label">
										  <input type="radio" class="form-check-input formxx" name="F101<?php echo $ffd; ?>" id="F101<?php echo $ffd; ?>_0" value="0">
									...
									<div class="col-md-4">
									  <div class="form-check" >
										<label class="form-check-label">
										  <input type="radio" class="form-check-input formxx" name="F101<?php echo $ffd; ?>" id="F101<?php echo $ffd; ?>_1" value="1">
										  1-3 hari yang lalu
										</label>
									  </div>
								  </div>
								  <div class="col-md-4">
									  <div class="form-check" >
										<label class="form-check-label">
										  <input type="radio" class="form-check-input formxx" name="F101<?php echo $ffd; ?>" id="F101<?php echo $ffd; ?>_2" value="2">
										  Seminggu yang lalu
										</label>
									  </div>
								  </div>
								   <div class="col-md-4">
									  <div class="form-check" >
										<label class="form-check-label">
										  <input type="radio" class="form-check-input formxx" name="F101<?php echo $ffd; ?>" id="F101<?php echo $ffd; ?>_3" value="3">
										  Sebulan yang lalu
										</label>
									  </div>
								  </div>
								   <div class="col-md-4">
									  <div class="form-check" >
										<label class="form-check-label">
										  <input type="radio" class="form-check-input formxx" name="F101<?php echo $ffd; ?>" id="F101<?php echo $ffd; ?>_4" value="4">
										  4-6 hari yang lalu
										</label>
									  </div>
								  </div>
								   <div class="col-md-4">
									  <div class="form-check" >
										<label class="form-check-label">
										  <input type="radio" class="form-check-input formxx" name="F101<?php echo $ffd; ?>" id="F101<?php echo $ffd; ?>_5" value="5">
										  2 – 3 minggu yang lalu
										</label>
									  </div>
								  </div>
								   <div class="col-md-4">
									  <div class="form-check" >
										<label class="form-check-label">
										  <input type="radio" class="form-check-input formxx" name="F101<?php echo $ffd; ?>" id="F101<?php echo $ffd; ?>_6" value="6">
										  Lebih dari sebulan yang lalu
										</label>
									  </div>
								  </div>
						   ...
						   <?php $ffd=1; foreach($array_ragam_media2 as $array_ragam_medias){ ?>
							...
							<br>
							   ...
							   <div class="col-md-3">
								<div class="form-check mx-sm-2">
										  <label class="form-check-label">
											<input type="checkbox" name="F10-d<?php echo $ffd; ?>" id="F10-d<?php echo $ffd; ?>_1" value="1" class="form-check-input formxx" >
											<?php echo $array_ragam_medias; ?>
										  </label>
										</div>
							   </div>
							   <div class="col-md-9">
								 ...
								 <div class="col-md-4">
									  <div class="form-check" >
										<label class="form-check-label">
										  <input type="radio" class="form-check-input formxx" name="F102<?php echo $ffd; ?>" id="F102<?php echo $ffd; ?>_0" value="0">
										  Tadi pagi/siang/sore
										</label>
									  </div>
								  </div>
									<div class="col-md-4">
									  <div class="form-check" >
										<label class="form-check-label">
										  <input type="radio" class="form-check-input formxx" name="F102<?php echo $ffd; ?>" id="F102<?php echo $ffd; ?>_1" value="1">
										  1-3 hari yang lalu
										</label>
									  </div>
								  </div>
								  <div class="col-md-4">
									  <div class="form-check" >
										<label class="form-check-label">
										  <input type="radio" class="form-check-input formxx" name="F102<?php echo $ffd; ?>" id="F102<?php echo $ffd; ?>_2" value="2">
										  Seminggu yang lalu
										</label>
									  </div>
								  </div>
								   <div class="col-md-4">
									  <div class="form-check" >
										<label class="form-check-label">
										  <input type="radio" class="form-check-input formxx" name="F102<?php echo $ffd; ?>" id="F102<?php echo $ffd; ?>_3" value="3">
										  Sebulan yang lalu
										</label>
									  </div>
								  </div>
								   <div class="col-md-4">
									  <div class="form-check" >
										<label class="form-check-label">
										  <input type="radio" class="form-check-input formxx" name="F102<?php echo $ffd; ?>" id="F102<?php echo $ffd; ?>_4" value="4">
										  4-6 hari yang lalu
										</label>
									  </div>
								  </div>
								   <div class="col-md-4">
									  <div class="form-check" >
										<label class="form-check-label">
										  <input type="radio" class="form-check-input formxx" name="F102<?php echo $ffd; ?>" id="F102<?php echo $ffd; ?>_5" value="5">
										  2 – 3 minggu yang lalu
										</label>
									  </div>
								  </div>
								   <div class="col-md-4">
									  <div class="form-check" >
										<label class="form-check-label">
										  <input type="radio" class="form-check-input formxx" name="F102<?php echo $ffd; ?>" id="F102<?php echo $ffd; ?>_6" value="6">
										  Lebih dari sebulan yang lalu
										</label>
									  </div>
								  </div>
                      ...
                      <label for="exampleInputUsername1"><b>F11. Jika jawaban F10-2:“KORAN”, bagaimana cara Bpk/ Ibu/ Sdr mendapatkan koran yang dibaca?</b> </label>
						 ...
						 <div class="row">
							...
							<div class="col-md-3">
							  <div class="form-check mx-sm-2">
								  <label class="form-check-label">
									<input type="checkbox" name="f11" value="0" id="f11_0"  class="form-check-input formxx" >
									Berlangganan
								  </label>
								</div>
							</div> 
							<div class="col-md-3">
							  <div class="form-check mx-sm-2">
								  <label class="form-check-label">
									<input type="checkbox" name="f11" value="1" id="f11_1" class="form-check-input formxx" >
									Beli eceran
								  </label>
								</div>
							</div> 
							<div class="col-md-3">
							  <div class="form-check mx-sm-2">
								  <label class="form-check-label">
									<input type="checkbox" name="f11" value="2" id="f11_2" class="form-check-input formxx" >
									Pinjam
								  </label>
								</div>
							</div> 
                      ...
                      <label for="exampleInputUsername1"><b>F13. Jika jawaban F10-2:“KORAN”, Seberapa sering Bpk/ Ibu/ Sdr membaca koran?</b> </label>
						 ...
						 <div class="row">
							...
							<div class="col-md-4">
							  <div class="form-check" >
								<label class="form-check-label">
								  <input type="radio" class="form-check-input formxx" name="f13" id="f13_0" value="0">
								  Kurang dari seminggu sekali
								</label>
							  </div>
						  </div>
						  <div class="col-md-4">
							  <div class="form-check" >
								<label class="form-check-label">
								  <input type="radio" class="form-check-input formxx" name="f13" id="f13_1" value="1">
								  3-6 kali seminggu
								</label>
							  </div>
						  </div>
						   <div class="col-md-4">
							  <div class="form-check" >
								<label class="form-check-label">
								  <input type="radio" class="form-check-input formxx" name="f13" id="f13_2" value="2">
								  2-3 kali sehari
								</label>
							  </div>
						  </div>
						   <div class="col-md-4">
							  <div class="form-check" >
								<label class="form-check-label">
								  <input type="radio" class="form-check-input formxx" name="f13" id="f13_3" value="3">
								  1-2 kali seminggu
								</label>
							  </div>
						  </div>
						   <div class="col-md-4">
							  <div class="form-check" >
								<label class="form-check-label">
								  <input type="radio" class="form-check-input formxx" name="f13" id="f13_4" value="4">
								 1 kali sehari
								</label>
							  </div>
						  </div>
						   <div class="col-md-4">
							  <div class="form-check" >
								<label class="form-check-label">
								  <input type="radio" class="form-check-input formxx" name="f13" id="f13_5" value="5">
								  Lebih dari 3 kali sehari
								</label>
							  </div>
						  </div>
                      ...
                      <label for="exampleInputUsername1"><b>F14. Jika jawaban F10-2:“KORAN”, Koran apa yang biasa Bpk/ Ibu/ Sdr baca?</b> </label>
						 ...
						 <div class="row">
							...
							<div class="col-md-3">
							  <div class="form-check mx-sm-2">
								  <label class="form-check-label">
									<input type="checkbox" name="f14" id="f14_Jawa_Pos" value="Jawa_Pos"  class="form-check-input formxx" >
										Jawa Pos
								  </label>
								</div>
							</div> 
							<div class="col-md-3">
							  <div class="form-check mx-sm-2">
								  <label class="form-check-label">
									<input type="checkbox" name="f14" id="f14_Kompas" value="Kompas" class="form-check-input formxx" >
									Kompas
								  </label>
								</div>
							</div> 
							<div class="col-md-3">
							  <div class="form-check mx-sm-2">
								  <label class="form-check-label">
									<input type="checkbox" name="f14" id="f14_Bisnis_Indonesia" value="Bisnis_Indonesia" class="form-check-input formxx" >
									Bisnis Indonesia
								  </label>
								</div>
							</div>
							<div class="col-md-3">
							  <div class="form-check mx-sm-2">
								  <label class="form-check-label">
									<input type="checkbox" name="f14" id="f14_Radar" value="Radar" class="form-check-input formxx" >
										Radar
								  </label>
								</div>
							</div> 
<div class="col-md-3">
							  <div class="form-check mx-sm-2">
								  <label class="form-check-label">
									<input type="checkbox" name="f14" id="f14_Investor_Daily" value="Investor_Daily" class="form-check-input formxx" >
										Investor Daily
								  </label>
								</div>
							</div> 
<div class="col-md-3">
							  <div class="form-check mx-sm-2">
								  <label class="form-check-label">
									<input type="checkbox" name="f14" id="f14_Jakarta_Post" value="Jakarta_Post" class="form-check-input formxx" >
										Jakarta Post
								  </label>
								</div>
							</div> 
<div class="col-md-3">
							  <div class="form-check mx-sm-2">
								  <label class="form-check-label">
									<input type="checkbox" name="f14" id="f14_Sindo" value="Sindo" class="form-check-input formxx" >
										Sindo
								  </label>
								</div>
							</div> 
<div class="col-md-3">
							  <div class="form-check mx-sm-2">
								  <label class="form-check-label">
									<input type="checkbox"name="f14" id="f14_Tempo" value="Tempo"  class="form-check-input formxx" >
										Tempo
								  </label>
								</div>
							</div> 
<div class="col-md-3">
							  <div class="form-check mx-sm-2">
								  <label class="form-check-label">
									<input type="checkbox" name="f14" id="f14_Republika" value="Republika" class="form-check-input formxx" >
										Republika
								  </label>
								</div>
							</div> 
<div class="col-md-3">
							  <div class="form-check mx-sm-2">
								  <label class="form-check-label">
									<input type="checkbox" name="f14" id="f14_Lainnya" value="Lainnya" class="form-check-input formxx" >
										Lainnya
								  </label>
								</div>
							</div> 
                      ...
                      <label for="exampleInputUsername1"><b>F15. Jika jawaban F10-2:“KORAN”, (Showcard-I) rubrik apa yang biasa Bpk/ Ibu/ Sdr baca?</b> </label>
						 ...
						 <div class="row">
							...
							<div class="col-md-3">
							  <div class="form-check mx-sm-2">
								  <label class="form-check-label">
									<input type="checkbox" name="f15" id="f15_Politik" value="Politik"  class="form-check-input formxx" >
										Politik
								  </label>
								</div>
							</div> 
							<div class="col-md-3">
							  <div class="form-check mx-sm-2">
								  <label class="form-check-label">
									<input type="checkbox" name="f15" id="f15_Ekonomi" value="Ekonomi" class="form-check-input formxx" >
									Ekonomi/Bisnis
								  </label>
								</div>
							</div> 
							<div class="col-md-3">
							  <div class="form-check mx-sm-2">
								  <label class="form-check-label">
									<input type="checkbox" name="f15" id="f15_Sosial" value="Sosial" class="form-check-input formxx" >
									Sosial/ Budaya
								  </label>
								</div>
							</div>
							<div class="col-md-3">
							  <div class="form-check mx-sm-2">
								  <label class="form-check-label">
									<input type="checkbox" name="f15" id="f15_Teknologi" value="Teknologi" class="form-check-input formxx" >
										Teknologi
								  </label>
								</div>
							</div> 
<div class="col-md-3">
							  <div class="form-check mx-sm-2">
								  <label class="form-check-label">
									<input type="checkbox" name="f15" id="f15_Properti" value="Properti" class="form-check-input formxx" >
										Properti
								  </label>
								</div>
							</div> 
<div class="col-md-3">
							  <div class="form-check mx-sm-2">
								  <label class="form-check-label">
									<input type="checkbox" name="f15" id="f15_Otomotif" value="Otomotif" class="form-check-input formxx" >
										Otomotif
								  </label>
								</div>
							</div> 
<div class="col-md-3">
							  <div class="form-check mx-sm-2">
								  <label class="form-check-label">
									<input type="checkbox" name="f15" id="f15_Olahraga" value="Olahraga" class="form-check-input formxx" >
										Olahraga
								  </label>
								</div>
							</div> 
<div class="col-md-3">
							  <div class="form-check mx-sm-2">
								  <label class="form-check-label">
									<input type="checkbox" name="f15" id="f15_Kesehatan" value="Kesehatan" class="form-check-input formxx" >
										Kesehatan
								  </label>
								</div>
							</div> 
<div class="col-md-3">
							  <div class="form-check mx-sm-2">
								  <label class="form-check-label">
									<input type="checkbox" name="f15" id="f15_Hiburan" value="Hiburan"  class="form-check-input formxx" >
										Hiburan
								  </label>
								</div>
							</div> 
<div class="col-md-3">
							  <div class="form-check mx-sm-2">
								  <label class="form-check-label">
									<input type="checkbox" name="f15" id="f15_Fashion" value="Fashion" class="form-check-input formxx" >
										Fashion
								  </label>
								</div>
							</div> 
<div class="col-md-3">
							  <div class="form-check mx-sm-2">
								  <label class="form-check-label">
									<input type="checkbox" name="f15" id="f15_nasional" value="nasional" class="form-check-input formxx" >
							...
							<div class="col-md-3">
							  <div class="form-check mx-sm-2">
								  <label class="form-check-label">
									<input type="checkbox" name="f15" id="f15_Berita_Luar_Negeri" value="Berita_Luar_Negeri" class="form-check-input formxx" >
										Berita Luar Negeri
								  </label>
								</div>
							</div> 
                      ...
                      <label for="exampleInputUsername1"><b>F16. Jika jawaban F10-2:“ MAJALAH/ TABLOID”, bagaimana cara Bpk/ Ibu/ Sdr mendapatkan majalah/ tabloid yang dibaca?</b> </label>
						 ...
						 <div class="row">
							...
							<div class="col-md-3">
							  <div class="form-check mx-sm-2">
								  <label class="form-check-label">
									<input type="checkbox" name="f16" value="Berlangganan" id="f16_Berlangganan" class="form-check-input formxx" >
									Berlangganan
								  </label>
								</div>
							</div> 
							<div class="col-md-3">
							  <div class="form-check mx-sm-2">
								  <label class="form-check-label">
									<input type="checkbox" name="f16" value="Beli_eceran"  id="f16_Beli_eceran" class="form-check-input formxx" >
									Beli eceran
								  </label>
								</div>
							</div> 
							<div class="col-md-3">
							  <div class="form-check mx-sm-2">
								  <label class="form-check-label">
									<input type="checkbox"name="f16" value="Pinjam" id="f16-Berlangganan"   class="form-check-input formxx" >
									Pinjam
								  </label>
								</div>
							</div> 
                      ...
                      <label for="exampleInputUsername1"><b>F18. Jika jawaban F10-2:“MAJALAH/ TABLOID”, Majalah / Tabloid apa yang sering Bpk/ Ibu/ Sdr baca?</b> </label>
						 ...
						 <div class="row">
							...
							<div class="col-md-3">
							  <div class="form-check mx-sm-2">
								  <label class="form-check-label">
									<input type="checkbox" name="f18" id="f18_Trubus" value="Trubus"   class="form-check-input formxx" >
											Trubus
								  </label>
								</div>
							</div> 
							<div class="col-md-3">
							  <div class="form-check mx-sm-2">
								  <label class="form-check-label">
									<input type="checkbox" name="f18" id="f18_Wanita_Indonesia" value="Wanita_Indonesia" class="form-check-input formxx" >
										Wanita Indonesia
								  </label>
								</div>
							</div> 
							<div class="col-md-3">
							  <div class="form-check mx-sm-2">
								  <label class="form-check-label">
									<input type="checkbox" name="f18" id="f18_Bintang" value="Bintang" class="form-check-input formxx" >
										Bintang
								  </label>
								</div>
							</div>
							<div class="col-md-3">
							  <div class="form-check mx-sm-2">
								  <label class="form-check-label">
									<input type="checkbox" name="f18" id="f18_Nova" value="Nova" class="form-check-input formxx" >
											Nova
								  </label>
								</div>
							</div> 
<div class="col-md-3">
							  <div class="form-check mx-sm-2">
								  <label class="form-check-label">
									<input type="checkbox" name="f18" id="f18_Chip"  value="Chip" class="form-check-input formxx" >
											Chip
								  </label>
								</div>
							</div> 
<div class="col-md-3">
							  <div class="form-check mx-sm-2">
								  <label class="form-check-label">
									<input type="checkbox" name="f18" id="f18_SWA" value="SWA" class="form-check-input formxx" >
											SWA
								  </label>
								</div>
							</div> 
<div class="col-md-3">
							  <div class="form-check mx-sm-2">
								  <label class="form-check-label">
									<input type="checkbox" name="f18" id="f18_Intisari" value="Intisari" class="form-check-input formxx" >
											Intisari
								  </label>
								</div>
							</div> 
<div class="col-md-3">
							  <div class="form-check mx-sm-2">
								  <label class="form-check-label">
									<input type="checkbox" name="f18" id="f18_Rumah" value="Rumah" class="form-check-input formxx" >
										Rumah
								  </label>
								</div>
							</div> 
<div class="col-md-3">
							  <div class="form-check mx-sm-2">
								  <label class="form-check-label">
									<input type="checkbox" name="f18" id="f18_Gadis" value="Gadis" class="form-check-input formxx" >
										Gadis
								  </label>
								</div>
							</div> 
<div class="col-md-3">
							  <div class="form-check mx-sm-2">
								  <label class="form-check-label">
									<input type="checkbox" name="f18" id="f18_Lainnya"  value="Lainnya" class="form-check-input formxx" >
										Lainnya
								  </label>
								</div>
							</div> 
                      ...
                      <label for="exampleInputUsername1"><b>F19. Jika jawaban F10-2:“ MAJALAH/ TABLOID”, (Showcard-J) rubrik apa yang biasa Bpk/ Ibu/ Sdr baca?</b> </label>
						 ...
						 <div class="row">
							...
							<div class="col-md-3">
							  <div class="form-check mx-sm-2">
								  <label class="form-check-label">
									<input type="checkbox" name="f19" id="f19_Politik" value="Politik"  class="form-check-input formxx" >
												Politik
								  </label>
								</div>
							</div> 
							<div class="col-md-3">
							  <div class="form-check mx-sm-2">
								  <label class="form-check-label">
									<input type="checkbox" name="f19" id="f19_Ekonomi_Bisnis" value="Ekonomi_Bisnis"  class="form-check-input formxx" >
											Ekonomi/Bisnis
								  </label>
								</div>
							</div> 
							<div class="col-md-3">
							  <div class="form-check mx-sm-2">
								  <label class="form-check-label">
									<input type="checkbox" name="f19" id="f19_Sosial_Budaya" value="Sosial_Budaya"  class="form-check-input formxx" >
											Sosial/ Budaya
								  </label>
								</div>
							</div>
							<div class="col-md-3">
							  <div class="form-check mx-sm-2">
								  <label class="form-check-label">
									<input type="checkbox" name="f19" id="f19_Teknologi" value="Teknologi"  class="form-check-input formxx" >
												Teknologi
								  </label>
								</div>
							</div> 
<div class="col-md-3">
							  <div class="form-check mx-sm-2">
								  <label class="form-check-label">
									<input type="checkbox" name="f19" id="f19_Properti" value="Properti"  class="form-check-input formxx" >
												Properti
								  </label>
								</div>
							</div> 
<div class="col-md-3">
							  <div class="form-check mx-sm-2">
								  <label class="form-check-label">
									<input type="checkbox" name="f19" id="f19_Otomotif" value="Otomotif"  class="form-check-input formxx" >
											Otomotif
								  </label>
								</div>
							</div> 
<div class="col-md-3">
							  <div class="form-check mx-sm-2">
								  <label class="form-check-label">
									<input type="checkbox" name="f19" id="f19_Olahraga" value="Olahraga"  class="form-check-input formxx" >
												Olahraga
								  </label>
								</div>
							</div> 
<div class="col-md-3">
							  <div class="form-check mx-sm-2">
								  <label class="form-check-label">
									<input type="checkbox" name="f19" id="f19_Kesehatan" value="Kesehatan"  class="form-check-input formxx" >
											Kesehatan
								  </label>
								</div>
							</div> 
<div class="col-md-3">
							  <div class="form-check mx-sm-2">
								  <label class="form-check-label">
									<input type="checkbox" name="f19" id="f19_Hiburan" value="Hiburan"  class="form-check-input formxx" >
											Hiburan
								  </label>
								</div>
							</div> 
							<div class="col-md-3">
							  <div class="form-check mx-sm-2">
								  <label class="form-check-label">
									<input type="checkbox" name="f19" id="f19_Fashion" value="Fashion"  class="form-check-input formxx" >
											Fashion
								  </label>
								</div>
							</div> 
							<div class="col-md-3">
							  <div class="form-check mx-sm-2">
								  <label class="form-check-label">
									<input type="checkbox" name="f19" id="f19_Agro" value="Agro"   class="form-check-input formxx" >
											Agro
								  </label>
								</div>
							</div> 
<div class="col-md-3">
							  <div class="form-check mx-sm-2">
								  <label class="form-check-label">
									<input type="checkbox" name="f19" id="f19_Lainnya" value="Lainnya"  class="form-check-input formxx" >
										Lainnya
								  </label>
								</div>
							</div> 
                      ...
                      <label for="exampleInputUsername1"><b>F21. Jika jawaban F10-2:“RADIO”, dimana biasa Bpk/ Ibu/ Sdr mendengarkan Radio?</b> </label>
						 ...
						 <div class="row">
							...
							<div class="col-md-3">
							  <div class="form-check mx-sm-2">
								  <label class="form-check-label">
									<input type="checkbox" name="f21" id="f21_Rumah" value="Rumah" class="form-check-input formxx" >
													Rumah
								  </label>
								</div>
							</div> 
							<div class="col-md-3">
							  <div class="form-check mx-sm-2">
								  <label class="form-check-label">
									<input type="checkbox" name="f21" id="f21_Kantor" value="Kantor" class="form-check-input formxx" >
											Kantor
								  </label>
								</div>
							</div> 
							<div class="col-md-3">
							  <div class="form-check mx-sm-2">
								  <label class="form-check-label">
									<input type="checkbox" name="f21" id="f21_Sekolah" value="Sekolah" class="form-check-input formxx" >
											Sekolah
								  </label>
								</div>
							</div>
							<div class="col-md-3">
							  <div class="form-check mx-sm-2">
								  <label class="form-check-label">
									<input type="checkbox" name="f21"id="f21_Mobil"  value="Mobil" class="form-check-input formxx" >
													Mobil
								  </label>
								</div>
							</div> 
<div class="col-md-3">
							  <div class="form-check mx-sm-2">
								  <label class="form-check-label">
									<input type="checkbox" name="f21" id="f21_Lainnya" value="Lainnya" class="form-check-input formxx" >
										Lainnya
								  </label>
								</div>
							</div> 
                      ...
                      <label for="exampleInputUsername1"><b>F22. Jika jawaban F10-2:“RADIO”, seberapa sering Bpk/ Ibu/ Sdr mendengarkan radio?</b> </label>
						 ...
						 <div class="row">
							...
							<div class="col-md-4">
							  <div class="form-check" >
								<label class="form-check-label">
								  <input type="radio" class="form-check-input formxx" name="F22" id="F22_0" value="0">
								  Kurang dari seminggu sekali
								</label>
							  </div>
						  </div>
						  <div class="col-md-4">
							  <div class="form-check" >
								<label class="form-check-label">
								  <input type="radio" class="form-check-input formxx" name="F22" id="F22_1" value="1">
								  3-6 kali seminggu
								</label>
							  </div>
						  </div>
						   <div class="col-md-4">
							  <div class="form-check" >
								<label class="form-check-label">
								  <input type="radio" class="form-check-input formxx" name="F22" id="F22_2" value="2">
								  2-3 kali sehari
								</label>
							  </div>
						  </div>
						   <div class="col-md-4">
							  <div class="form-check" >
								<label class="form-check-label">
								  <input type="radio" class="form-check-input formxx" name="F22" id="F22_3" value="3">
								  1-2 kali seminggu
								</label>
							  </div>
						  </div>
						   <div class="col-md-4">
							  <div class="form-check" >
								<label class="form-check-label">
								  <input type="radio" class="form-check-input formxx" name="F22" id="F22_4" value="4">
								 1 kali sehari
								</label>
							  </div>
						  </div>
						   <div class="col-md-4">
							  <div class="form-check" >
								<label class="form-check-label">
								  <input type="radio" class="form-check-input formxx" name="F22" id="F22_5" value="5">
								  Lebih dari 3 kali sehari
								</label>
							  </div>
						  </div>
                      ...
                      <label for="exampleInputUsername1"><b>F23. Jika jawaban F10-2: “KORAN/ MAJALAH/ TABLOID/ SITUS”, apakah Bpk/ Ibu/ Sdr berlangganan Koran /Majalah /Tabloid /Situs berita Online?</b> </label>
						 ...
						 <div class="row">
							...
							<div class="col-md-4">
							  <div class="form-check" >
								<label class="form-check-label">
								  <input type="radio" class="form-check-input formxx" name="F23" id="F23_Ya" value="Ya">
								  Ya
								</label>
							  </div>
						  </div>
						  <div class="col-md-4">
							  <div class="form-check" >
								<label class="form-check-label">
								  <input type="radio" class="form-check-input formxx" name="F23" id="F23_Kadang" value="Kadang">
								  Kadang
								</label>
							  </div>
						  </div>
						   <div class="col-md-4">
							  <div class="form-check" >
								<label class="form-check-label">
								  <input type="radio" class="form-check-input formxx" name="F23" id="F23_Tidak" value="Tidak">
								  Tidak / Gratisan
								</label>
							  </div>
						  </div>
                      ...
                      <label for="exampleInputUsername1"><b>F24. Jika jawaban F10-2: “KORAN/ MAJALAH/ TABLOID/ SITUS”, Seberapa sering Bpk/ Ibu/ Sdr membaca Online?</b> </label>
						 ...
						 <div class="row">
							...
							<div class="col-md-4">
							  <div class="form-check" >
								<label class="form-check-label">
								  <input type="radio" class="form-check-input formxx" name="F24" id="F24_0" value="0">
								  Kurang dari seminggu sekali
								</label>
							  </div>
						  </div>
						  <div class="col-md-4">
							  <div class="form-check" >
								<label class="form-check-label">
								  <input type="radio" class="form-check-input formxx" name="F24" id="F24_1" value="1">
								  3-6 kali seminggu
								</label>
							  </div>
						  </div>
						   <div class="col-md-4">
							  <div class="form-check" >
								<label class="form-check-label">
								  <input type="radio" class="form-check-input formxx" name="F24" id="F24_2" value="2">
								  2-3 kali sehari
								</label>
							  </div>
						  </div>
						   <div class="col-md-4">
							  <div class="form-check" >
								<label class="form-check-label">
								  <input type="radio" class="form-check-input formxx" name="F24" id="F24_3" value="3">
								  1-2 kali seminggu
								</label>
							  </div>
						  </div>
						   <div class="col-md-4">
							  <div class="form-check" >
								<label class="form-check-label">
								  <input type="radio" class="form-check-input formxx" name="F24" id="F24_4" value="4">
								 1 kali sehari
								</label>
							  </div>
						  </div>
						   <div class="col-md-4">
							  <div class="form-check" >
								<label class="form-check-label">
								  <input type="radio" class="form-check-input formxx" name="F24" id="F24_5" value="5">
								  Lebih dari 3 kali sehari
								</label>
							  </div>
						  </div>
                      ...
                      <label for="exampleInputUsername1"><b>F25. Jika jawaban F10-2: “KORAN/ MAJALAH/ TABLOID/ SITUS”, media online apa yang biasa Bpk/ Ibu/ Sdr baca?</b> </label>
						 ...
						 <div class="row">
							...
							<div class="col-md-3">
							  <div class="form-check mx-sm-2">
								  <label class="form-check-label">
									<input type="checkbox" name="f25" id="f25_detik" value="detik"  class="form-check-input formxx" >
													detik.com
								  </label>
								</div>
							</div> 
							<div class="col-md-3">
							  <div class="form-check mx-sm-2">
								  <label class="form-check-label">
									<input type="checkbox" name="f25" id="f25_tirto" value="tirto" class="form-check-input formxx" >
												tirto.id
								  </label>
								</div>
							</div> 
							<div class="col-md-3">
							  <div class="form-check mx-sm-2">
								  <label class="form-check-label">
									<input type="checkbox" name="f25" id="f25_tempo" value="tempo" class="form-check-input formxx" >
												tempo.com
								  </label>
								</div>
							</div>
							<div class="col-md-3">
							  <div class="form-check mx-sm-2">
								  <label class="form-check-label">
									<input type="checkbox" name="f25" id="f25_kumparan" value="kumparan" class="form-check-input formxx" >
													kumparan.com
								  </label>
								</div>
							</div> 
<div class="col-md-3">
							  <div class="form-check mx-sm-2">
								  <label class="form-check-label">
									<input type="checkbox" name="f25" id="f25_okezone" value="okezone" class="form-check-input formxx" >
													okezone.com
								  </label>
								</div>
							</div> 
<div class="col-md-3">
							  <div class="form-check mx-sm-2">
								  <label class="form-check-label">
									<input type="checkbox" name="f25" id="f25_liputan6" value="liputan6"class="form-check-input formxx" >
												liputan6.com
								  </label>
								</div>
							</div> 
<div class="col-md-3">
							  <div class="form-check mx-sm-2">
								  <label class="form-check-label">
									<input type="checkbox" name="f25" id="f25_kompas" value="kompas" class="form-check-input formxx" >
													kompas.com
								  </label>
								</div>
							</div> 
<div class="col-md-3">
							  <div class="form-check mx-sm-2">
								  <label class="form-check-label">
									<input type="checkbox" name="f25" id="f25_tribunnews"  value="tribunnews" class="form-check-input formxx" >
												tribunnews.com
								  </label>
								</div>
							</div> 
<div class="col-md-3">
							  <div class="form-check mx-sm-2">
								  <label class="form-check-label">
									<input type="checkbox" name="f25" id="f25_kapanlagi" value="kapanlagi" class="form-check-input formxx" >
												kapanlagi.com
								  </label>
								</div>
							</div> 
...
<div class="col-md-3">
							  <div class="form-check mx-sm-2">
								  <label class="form-check-label">
									<input type="checkbox" name="f25" id="f25_Lainnya" value="Lainnya" class="form-check-input formxx" >
										Lainnya
								  </label>
								</div>
							</div> 
                      ...
                      <label for="exampleInputUsername1"><b>F26. Jika jawaban F10-2: “SOCIAL MEDIA”, media apa yang biasa Bpk/ Ibu/ Sdr baca berita / informasinya?</b> </label>
						 ...
						 <div class="row">
							...
							<div class="col-md-3">
							  <div class="form-check mx-sm-2">
								  <label class="form-check-label">
									<input type="checkbox" name="f26" id="f26_Facebook" value="Facebook" class="form-check-input formxx" >
												Facebook
								  </label>
								</div>
							</div> 
							<div class="col-md-3">
							  <div class="form-check mx-sm-2">
								  <label class="form-check-label">
									<input type="checkbox" name="f26" id="f26_twitter" value="twitter" class="form-check-input formxx" >
												twitter
								  </label>
								</div>
							</div> 
							<div class="col-md-3">
							  <div class="form-check mx-sm-2">
								  <label class="form-check-label">
									<input type="checkbox" name="f26" id="f26_Line" value="Line" class="form-check-input formxx" >
												Line
								  </label>
								</div>
							</div>
							<div class="col-md-3">
							  <div class="form-check mx-sm-2">
								  <label class="form-check-label">
									<input type="checkbox" name="f26" id="f26_Instagram" value="Instagram" class="form-check-input formxx" >
													Instagram
								  </label>
								</div>
							</div> 
<div class="col-md-3">
							  <div class="form-check mx-sm-2">
								  <label class="form-check-label">
									<input type="checkbox" name="f26" id="f26_Lainnya" value="Lainnya" class="form-check-input formxx" >
										Lainnya
								  </label>
								</div>
							</div> 
									...
									<tr>
									  <td>
										...
										<label class="form-check-label" id="socmed_skala_<?php echo $iii; ?>">
										 ...
										 <div class="form-check mx-sm-2">
										  <label class="form-check-label">
											<input type="checkbox" id="f27_chk<?php echo $iii; ?>_1" name="f27_chk<?php echo $iii; ?>" value="1" class="form-check-input formxx" > 
									...
									<tr>
									  <td>
										...
										<label class="form-check-label" id="socmed_skala_<?php echo $iii; ?>">
										   ...
										   <div class="form-check mx-sm-2">
										  <label class="form-check-label">
											<input type="checkbox" name="f27_chk_lainnya" value="Lainnya" class="form-check-input formxx" >
												lainnya
										  </label>
										</div>
                      ...
                      <label for="exampleInputUsername1"><b>F28. Jika jawaban F27: “YOUTUBE”, Apakah Bpk/ Ibu/ Sdr memiliki Channel YOUTUBE pribadi dan aktif mengupdate atau mengisi contentnya?</b> </label>
						 ...
						 <div class="row">
							...
							<div class="col-md-6">
							  <div class="form-check" >
								<label class="form-check-label">
								  <input type="radio" class="form-check-input formxx" name="F28" id="F28_Tidak" value="Tidak">
								  Tidak 
								</label>
							  </div>
						  </div>
						  <div class="col-md-6">
							  <div class="form-check" >
								<label class="form-check-label">
								  <input type="radio" class="form-check-input formxx" name="F28" id="F28_Ya" value="Ya">
								  Ya
								</label>
							  </div>
						  </div>
                      ...
                      <label for="exampleInputUsername1"><b>F29. Jika jawaban F27: “YOUTUBE”, Dalam 3 bulan terakhir, seberapa sering Bpk/ Ibu/ Sdr menonton Channel YOUTUBE orang lain?</b> </label>
						 ...
						 <div class="row">
							...
							<div class="col-md-3">
							  <div class="form-check" >
								<label class="form-check-label">
								  <input type="radio" class="form-check-input formxx" name="F29" id="F29_0" value="0">
								  Setiap hari 
								</label>
							  </div>
						  </div>
						  <div class="col-md-3">
							  <div class="form-check" >
								<label class="form-check-label">
								  <input type="radio" class="form-check-input formxx" name="F29" id="F29_1" value="1">
						  ...
						  <div class="col-md-3">
							  <div class="form-check" >
								<label class="form-check-label">
								  <input type="radio" class="form-check-input formxx" name="F29" id="F29_2" value="2">
						  ...
						  <div class="col-md-3">
							  <div class="form-check" >
								<label class="form-check-label">
								  <input type="radio" class="form-check-input formxx" name="F29" id="F29_3" value="3">
								  Seminggu sekali
								</label>
							  </div>
						  </div>
						  <div class="col-md-3">
							  <div class="form-check" >
								<label class="form-check-label">
								  <input type="radio" class="form-check-input formxx" name="F29" id="F29_4" value="4">
								  2-3 minggu sekali
								</label>
							  </div>
						  </div>
						  <div class="col-md-3">
							  <div class="form-check" >
								<label class="form-check-label">
								  <input type="radio" class="form-check-input formxx" name="F29" id="F29_5" value="5">
								  Sebulan sekali
								</label>
							  </div>
						  </div>
						  <div class="col-md-3">
							  <div class="form-check" >
								<label class="form-check-label">
								  <input type="radio" class="form-check-input formxx" name="F29" id="F29_6" value="6">
								  Lebih dari sebulan sekali
								</label>
							  </div>
						  </div>
						 ...
						 <div class="row">
							...
							<?php $ii=0; foreach($array_jenis_tayangan as $array_jenis_tayangans){ ?>
								...
								<div class="col-md-3">
								  <div class="form-check mx-sm-2">
									  <label class="form-check-label">
										<input type="checkbox" name="f30" id="f30_<?php echo $array_jenis_tayangan_val[$ii]; ?>" value="<?php echo $array_jenis_tayangan_val[$ii]; ?>" class="form-check-input formxx" >
						 ...
						 <div class="row">
							...
							foreach($penggunaan_s as $penggunaan_ss){ ?>
								...
								<div class="col-md-3">
								  <div class="form-check mx-sm-2">
									  <label class="form-check-label">
										<input type="checkbox" name="f31" id="f31_<?php echo $penggunaan_s_val[$ii]; ?>" value="<?php echo $penggunaan_s_val[$ii]; ?>"  class="form-check-input formxx" >
                      ...
                      <label for="exampleInputUsername1"><b>F32. Jika jawaban F27: “FACEBOOK”, Dalam 3 bulan terakhir, seberapa sering Bpk/ Ibu/ Sdr mengakses akun FACEBOOK yang dimiliki?</b> </label>
						 ...
						 <div class="row">
							...
							<div class="col-md-3">
							  <div class="form-check" >
								<label class="form-check-label">
								  <input type="radio" class="form-check-input formxx" name="F32" id="F32_0" value="0">
								  Setiap hari 
								</label>
							  </div>
						  </div>
						  <div class="col-md-3">
							  <div class="form-check" >
								<label class="form-check-label">
								  <input type="radio" class="form-check-input formxx" name="F32" id="F32_1" value="1">
								  5-6 hari dalam seminggu
								</label>
							  </div>
						  </div>
						  <div class="col-md-3">
							  <div class="form-check" >
								<label class="form-check-label">
								  <input type="radio" class="form-check-input formxx" name="F32" id="F32_2" value="2">
								  2-4 hari dalam seminggu
								</label>
							  </div>
						  </div>
						  <div class="col-md-3">
							  <div class="form-check" >
								<label class="form-check-label">
								  <input type="radio" class="form-check-input formxx" name="F32" id="F32_3" value="3">
								  Seminggu sekali
								</label>
							  </div>
						  </div>
						  <div class="col-md-3">
							  <div class="form-check" >
								<label class="form-check-label">
								  <input type="radio" class="form-check-input formxx" name="F32" id="F32_4" value="4">
								  2-3 minggu sekali
								</label>
							  </div>
						  </div>
						  <div class="col-md-3">
							  <div class="form-check" >
								<label class="form-check-label">
								  <input type="radio" class="form-check-input formxx" name="F32" id="F32_5" value="5">
								  Sebulan sekali
								</label>
							  </div>
						  </div>
						  <div class="col-md-3">
							  <div class="form-check" >
								<label class="form-check-label">
								  <input type="radio" class="form-check-input formxx" name="F32" id="F32_6" value="6">
								  Lebih dari sebulan sekali
								</label>
							  </div>
						  </div>
						 ...
						 <div class="row">
							...
							foreach($penggunaan_s as $penggunaan_ss){ ?>
								...
								<div class="col-md-3">
								  <div class="form-check mx-sm-2">
									  <label class="form-check-label">
										<input type="checkbox" name="f33" id="f33_<?php echo $penggunaan_s_val[$ii]; ?>" value="<?php echo $penggunaan_s_val[$ii]; ?>" class="form-check-input formxx" >
											<?php echo $penggunaan_ss; ?>
									  </label>
									</div>
								</div> 
                      ...
                      <label for="exampleInputUsername1"><b>F34. Jika jawaban F27: “INSTAGRAM”, Dalam 3 bulan terakhir, seberapa sering Bpk/ Ibu/ Sdr mengakses akun INSTAGRAM yang dimiliki?</b> </label>
						 ...
						 <div class="row">
							...
							<div class="col-md-3">
							  <div class="form-check" >
								<label class="form-check-label">
								  <input type="radio" class="form-check-input formxx" name="F34" id="F34_0" value="0">
								  Setiap hari 
								</label>
							  </div>
						  </div>
						  <div class="col-md-3">
							  <div class="form-check" >
								<label class="form-check-label">
								  <input type="radio" class="form-check-input formxx" name="F34" id="F34_1" value="1">
								  5-6 hari dalam seminggu
								</label>
							  </div>
						  </div>
						  <div class="col-md-3">
							  <div class="form-check" >
								<label class="form-check-label">
								  <input type="radio" class="form-check-input formxx" name="F34" id="F34_2" value="2">
								  2-4 hari dalam seminggu
								</label>
							  </div>
						  </div>
						  <div class="col-md-3">
							  <div class="form-check" >
								<label class="form-check-label">
								  <input type="radio" class="form-check-input formxx" name="F34" id="F34_3" value="3">
								  Seminggu sekali
								</label>
							  </div>
						  </div>
						  <div class="col-md-3">
							  <div class="form-check" >
								<label class="form-check-label">
								  <input type="radio" class="form-check-input formxx" name="F34" id="F34_4" value="4">
								  2-3 minggu sekali
								</label>
							  </div>
						  </div>
						  <div class="col-md-3">
							  <div class="form-check" >
								<label class="form-check-label">
								  <input type="radio" class="form-check-input formxx" name="F34" id="F34_5" value="5">
								  Sebulan sekali
								</label>
							  </div>
						  </div>
						  <div class="col-md-3">
							  <div class="form-check" >
								<label class="form-check-label">
								  <input type="radio" class="form-check-input formxx" name="F34" id="F34_6" value="6">
								  Lebih dari sebulan sekali
								</label>
							  </div>
						  </div>
						 ...
						 <div class="row">
							...
							foreach($penggunaan_lakukan as $penggunaan_ss){ ?>
								...
								<div class="col-md-3">
								  <div class="form-check mx-sm-2">
									  <label class="form-check-label">
										<input type="checkbox" name="f36" id="f36_<?php echo $penggunaan_lakukan_val[$iii]; ?>" value="<?php echo $penggunaan_lakukan_val[$iii]; ?>"  class="form-check-input formxx" >
											<?php echo $penggunaan_ss; ?>
									  </label>
									</div>
								</div> 
						 ...
						 <div class="row">
							...
							foreach($berita_informasi as $penggunaan_ss){ ?>
								...
								<div class="col-md-3">
								  <div class="form-check mx-sm-2">
									  <label class="form-check-label">
										<input type="checkbox" name="f37" id="f37_<?php echo $berita_informasi_val[$ii]; ?>" value="<?php echo $berita_informasi_val[$ii]; ?>"  class="form-check-input formxx" >
											<?php echo $penggunaan_ss; ?>
									  </label>
									</div>
								</div> 
						 ...
						 <div class="row">
							...
							foreach($situs_musik as $penggunaan_ss){ ?>
								...
								<div class="col-md-3">
								  <div class="form-check mx-sm-2">
									  <label class="form-check-label">
										<input type="checkbox" name="f38" id="f38_<?php echo $situs_musik_val[$ii]; ?>" value="<?php echo $situs_musik_val[$ii]; ?>"  class="form-check-input formxx" >
											<?php echo $penggunaan_ss; ?>
									  </label>
									</div>
								</div> 
						 ...
						 <div class="row">
							...
							foreach($situs_musik as $penggunaan_ss){ ?>
								...
								<div class="col-md-3">
								  <div class="form-check mx-sm-2">
									  <label class="form-check-label">
										<input type="checkbox" name="f39" id="f39_<?php echo $situs_musik_val[$ii]; ?>" value="<?php echo $situs_musik_val[$ii]; ?>"  class="form-check-input formxx" >
											<?php echo $penggunaan_ss; ?>
									  </label>
									</div>
								</div> 
						 ...
						 <div class="row">
							...
							foreach($situs_musik as $penggunaan_ss){ ?>
								...
								<div class="col-md-3">
								  <div class="form-check" >
									<label class="form-check-label">
									  <input type="radio" class="form-check-input formxx" name="F40" id="F40_<?php echo $situs_musik_val[$i]; ?>" value="<?php echo $situs_musik_val[$i]; ?>">
									 <?php echo $penggunaan_ss; ?>
									</label>
								  </div>
							  </div>
						 ...
						 <div class="row">
							...
							foreach($situs_musik as $penggunaan_ss){ ?>
								...
								<div class="col-md-3">
								  <div class="form-check mx-sm-2">
									  <label class="form-check-label">
										<input type="checkbox" name="f41" id="f41_<?php echo $situs_musik_val[$i]; ?>" value="<?php echo $situs_musik_val[$i]; ?>" class="form-check-input formxx" >
											<?php echo $penggunaan_ss; ?>
									  </label>
									</div>
								</div> 
						 ...
						 <div class="row">
							...
							foreach($situs_musik as $penggunaan_ss){ ?>
								...
								<div class="col-md-4">
									  <div class="form-check" >
										<label class="form-check-label">
										  <input type="radio" class="form-check-input formxx" name="F42" id="F42_<?php echo $situs_musik_val[$i]; ?>" value=" <?php echo $situs_musik_val[$i]; ?>">
										  <?php echo $penggunaan_ss; ?>
										</label>
									  </div>
								</div>
						 ...
						 <div class="row">
							...
							foreach($situs_musik as $penggunaan_ss){ ?>
								...
								<div class="col-md-3">
								  <div class="form-check mx-sm-2">
									  <label class="form-check-label">
										<input type="checkbox" name="f43" id="f43_<?php echo $situs_musik_val[$i]; ?>" value="<?php echo $situs_musik_val[$i]; ?>"  class="form-check-input formxx" >
											<?php echo $penggunaan_ss; ?>
									  </label>
									</div>
								</div> 
						 ...
						 <div class="row">
							...
							foreach($situs_musik as $penggunaan_ss){ ?>
								...
								<div class="col-md-3">
								  <div class="form-check mx-sm-2">
									  <label class="form-check-label">
										<input type="checkbox" name="f44" id="f44_<?php echo $situs_musik_val[$i]; ?>" value="<?php echo $situs_musik_val[$i]; ?>"  class="form-check-input formxx" >
											<?php echo $penggunaan_ss; ?>
									  </label>
									</div>
								</div> 
						 ...
						 <div class="row">
							...
							foreach($situs_musik as $penggunaan_ss){ ?>
								...
								<div class="col-md-3">
								  <div class="form-check" >
									<label class="form-check-label">
									  <input type="radio" class="form-check-input formxx" name="F45" id="F45_<?php echo $situs_musik_val[$i]; ?>" value="<?php echo $situs_musik_val[$i]; ?>">
									 <?php echo $penggunaan_ss; ?>
									</label>
								  </div>
							  </div>
						 ...
						 <div class="row">
							...
							foreach($situs_musik as $penggunaan_ss){ ?>
								...
								<div class="col-md-3">
								  <div class="form-check mx-sm-2">
									  <label class="form-check-label">
										<input type="checkbox" name="f46" id="f46_<?php echo $situs_musik_val[$i]; ?>" value="<?php echo $situs_musik_val[$i]; ?>" class="form-check-input formxx" >
											<?php echo $penggunaan_ss; ?>
									  </label>
									</div>
								</div> 
						 ...
						 <div class="row">
							...
							foreach($situs_musik as $penggunaan_ss){ ?>
								...
								<div class="col-md-4">
									  <div class="form-check" >
										<label class="form-check-label">
										  <input type="radio" class="form-check-input formxx" name="F47" id="F47_<?php echo $situs_musik_val[$i]; ?>" value="<?php echo $situs_musik_val[$i]; ?>">
										  <?php echo $penggunaan_ss; ?>
										</label>
									  </div>
								</div>
						 ...
						 <div class="row">
							...
							foreach($situs_musik as $penggunaan_ss){ ?>
								...
								<div class="col-md-3">
								  <div class="form-check mx-sm-2">
									  <label class="form-check-label">
										<input type="checkbox" name="f48" id="f48_<?php echo $situs_musik_val[$i]; ?>" value="<?php echo $situs_musik_val[$i]; ?>" class="form-check-input formxx" >
											<?php echo $penggunaan_ss; ?>
									  </label>
									</div>
								</div> 
						 ...
						 <div class="row">
							...
							foreach($situs_musik as $penggunaan_ss){ ?>
								...
								<div class="col-md-3">
								  <div class="form-check" >
									<label class="form-check-label">
									  <input type="radio" class="form-check-input formxx" name="F49" id="F49_<?php echo $situs_musik_val[$i]; ?>" value="<?php echo $situs_musik_val[$i]; ?>">
									 <?php echo $penggunaan_ss; ?>
									</label>
								  </div>
							  </div>
						 ...
						 <div class="row">
							...
							foreach($situs_musik as $penggunaan_ss){ ?>
								...
								<div class="col-md-4">
									  <div class="form-check" >
										<label class="form-check-label">
										  <input type="radio" class="form-check-input formxx" name="F51" id="F51_<?php echo $situs_musik_val[$i]; ?>" value="<?php echo $situs_musik_val[$i]; ?>" >
										  <?php echo $penggunaan_ss; ?>
										</label>
									  </div>
								</div>
						 ...
						 <div class="row">
							...
							foreach($situs_musik as $penggunaan_ss){ ?>
								<div class="col-md-3">
								  <div class="form-check mx-sm-2">
									  <label class="form-check-label">
										<input type="checkbox" name="f52" id="f52_<?php echo $situs_musik_val[$i]; ?>" value="<?php echo $situs_musik_val[$i]; ?>" class="form-check-input formxx" >
											<?php echo $penggunaan_ss; ?>
									  </label>
									</div>
								</div> 
						 ...
						 <div class="row">
							...
							<div class="row">
								<div class="col-md-9">
								  <div class="form-check mx-sm-2">
									  <label class="form-check-label">
										<input type="checkbox" name="f53<?php echo $iii; ?>" id="f53_<?php echo $iii; ?>_1" value="1" class="form-check-input formxx" >
											<?php echo $penggunaan_ss; ?>
									  </label>
									</div>
									...
									<div style="margin-left:20px">
										<div class="form-check mx-sm-2">
										  <label class="form-check-label">
											<input type="checkbox" name="f53_day_<?php echo $iii; ?>" id="f53_day_<?php echo $iii; ?>_1" value="1" class="form-check-input formxx" style="margin-left:20px;" >
												Harian
										  </label>
										</div>
										...
										<div class="form-check mx-sm-2">
										  <label class="form-check-label">
											<input type="checkbox" name="f53_week_<?php echo $iii; ?>" id="f53_week_<?php echo $iii; ?>_1" value="1" class="form-check-input formxx" style="margin-left:20px;">
												Mingguan
										  </label>
										</div>
										...
										<div class="form-check mx-sm-2">
										  <label class="form-check-label">
											<input type="checkbox" name="f53_month_<?php echo $iii; ?>" id="f53_month_<?php echo $iii; ?>_1" value="1" class="form-check-input formxx" style="margin-left:20px;">
												Bulanan
										  </label>
										</div>
									</div>
						 ...
						 <div class="row">
							...
							foreach($situs_musik as $penggunaan_ss){ ?>
								...
								<div class="col-md-3">
								  <div class="form-check mx-sm-2">
									  <label class="form-check-label">
										<input type="checkbox" name="f54" id="f54_<?php echo $situs_musik_val[$i]; ?>" value="<?php echo $situs_musik_val[$i]; ?>" value="<?php echo $penggunaan_ss; ?>" class="form-check-input formxx" >
											<?php echo $penggunaan_ss; ?>
									  </label>
									</div>
								</div> 
						 ...
						 <div class="row">
							...
							foreach($situs_musik as $penggunaan_ss){ ?>
								...
								<div class="col-md-3">
								  <div class="form-check mx-sm-2">
									  <label class="form-check-label">
										<input type="checkbox" name="f55" id="f55_<?php echo $penggunaan_ss; ?>" value="<?php echo $penggunaan_ss; ?>" class="form-check-input formxx" >
											<?php echo $penggunaan_ss; ?>
									  </label>
									</div>
								</div> 
						 ...
						 <div class="row">
							...
							foreach($situs_musik as $penggunaan_ss){ ?>
								...
								<div class="col-md-3">
								  <div class="form-check mx-sm-2">
									  <label class="form-check-label">
										<input type="checkbox" name="f56" id="f56_<?php echo $penggunaan_ss; ?>" value="<?php echo $penggunaan_ss; ?>" class="form-check-input formxx" >
											<?php echo $penggunaan_ss; ?>
									  </label>
									</div>
								</div> 
						 ...
						 <div class="row">
							...
							foreach($situs_musik as $penggunaan_ss){ ?>
								...
								<div class="col-md-4">
									  <div class="form-check" >
										<label class="form-check-label">
										  <input type="radio" class="form-check-input formxx" name="F57" id="F57_<?php echo $situs_musik_val[$i]; ?>" value="<?php echo $situs_musik_val[$i]; ?>">
										  <?php echo $penggunaan_ss; ?>
										</label>
									  </div>
								</div>
							...
							<div class="row">
								<div class="col-md-6">
								  <div class="form-check mx-sm-2">
									...
									<div class="col-md-6">
										  <div class="form-group" >
										  <select class="form-control js-example-basic-multiple formxxc " name="<?php echo $field_merk[$in]; ?>[]" id="<?php echo $field_merk[$in]; ?>" multiple="multiple" style="width:100%">
											...
											<!--<select class="form-control js-example-basic-multiple formxxc" name="<?php echo $field_merk[$in]; ?>[]" id="<?php echo $field_merk[$in]; ?>" style="width:100%"> 
						 ...
						 <div class="row">
							...
							foreach($situs_musik as $penggunaan_ss){ ?>
								...
								<div class="col-md-4">
									  <div class="form-check" >
										<label class="form-check-label">
										  <input type="radio" class="form-check-input formxx" name="F59" id="F59_<?php echo $i; ?>" value="<?php echo $i; ?>">
										  <?php echo $penggunaan_ss; ?>
										</label>
									  </div>
								</div>
						 ...
						 <div class="row">
							...
							foreach($situs_musik as $penggunaan_ss){ ?>
								...
								<div class="col-md-3">
								  <div class="form-check mx-sm-2">
									  <label class="form-check-label">
										<input type="checkbox" name="f60" id="f60_<?php echo $i; ?>" value="<?php echo $i; ?>"  class="form-check-input formxx" >
											<?php echo $penggunaan_ss; ?>
									  </label>
									</div>
								</div> 
						 ...
						 <div class="row">
							...
							foreach($situs_musik as $penggunaan_ss){ ?>
								...
								<div class="col-md-3">
								  <div class="form-check mx-sm-2">
									  <label class="form-check-label">
										<input type="checkbox" name="f61" id="f61_<?php echo $i; ?>"  value="<?php echo $i; ?>"  class="form-check-input formxx" >
											<?php echo $penggunaan_ss; ?>
									  </label>
									</div>
								</div> 
						 ...
						 <div class="row">
							...
							foreach($situs_musik as $penggunaan_ss){ ?>
								...
								<div class="col-md-3">
								  <div class="form-check mx-sm-2">
									  <label class="form-check-label">
										<input type="checkbox" name="f62" id="f62_<?php echo $i; ?>"  value="<?php echo $i; ?>"  class="form-check-input formxx" >
											<?php echo $penggunaan_ss; ?>
									  </label>
									</div>
								</div> 
						 ...
						 <div class="row">
							...
							foreach($situs_musik as $penggunaan_ss){ ?>
								<div class="col-md-3">
								  <div class="form-check mx-sm-2">
									  <label class="form-check-label">
										<input type="checkbox" name="f64new" id="f64new_<?php echo $situs_musik_val[$i]; ?>" value="<?php echo $situs_musik_val[$i]; ?>" class="form-check-input formxx" >
											<?php echo $penggunaan_ss; ?>
									  </label>
									</div>
								</div> 
						 ...
						 <div class="row">
							...
							foreach($situs_musik as $penggunaan_ss){ ?>
								<div class="col-md-3">
								  <div class="form-check mx-sm-2">
									  <label class="form-check-label">
										<input type="checkbox" name="f64" id="f64_<?php echo $situs_musik_val[$i]; ?>" value="<?php echo $situs_musik_val[$i]; ?>" class="form-check-input formxx" >
											<?php echo $penggunaan_ss; ?>
									  </label>
									</div>
								</div> 
						 ...
						 <div class="row">
							...
							foreach($situs_musik as $penggunaan_ss){ ?>
								<div class="col-md-3">
								  <div class="form-check mx-sm-2">
									  <label class="form-check-label">
										<input type="checkbox" name="f65" id="f65_<?php echo $situs_musik_val[$ii]; ?>"  value="<?php echo $situs_musik_val[$ii]; ?>"  class="form-check-input formxx" >
											<?php echo $penggunaan_ss; ?>
									  </label>
									</div>
								</div> 
						 ...
						 <div class="row">
							...
							foreach($situs_musik as $penggunaan_ss){ ?>
								<div class="col-md-3">
								  <div class="form-check mx-sm-2">
									  <label class="form-check-label">
										<input type="checkbox" name="f66" id="f66_<?php echo $situs_musik_val[$ii]; ?>" value="<?php echo $situs_musik_val[$ii]; ?>" class="form-check-input formxx" >
											<?php echo $penggunaan_ss; ?>
									  </label>
									</div>
								</div> 
						 ...
						 <div class="row">
							...
							foreach($situs_musik as $penggunaan_ss){ ?>
								...
								<div class="col-md-6">
									  <div class="form-check" >
										<label class="form-check-label">
										  <input type="radio" class="form-check-input formxx" name="F67" id="F67_<?php echo $penggunaan_ss; ?>" value="<?php echo $penggunaan_ss; ?>">
										  <?php echo $penggunaan_ss; ?>
										</label>
									  </div>
								</div>
						 ...
						 <div class="row">
							...
							foreach($situs_musik as $penggunaan_ss){ ?>
								...
								<div class="col-md-4">
									  <div class="form-check" >
										<label class="form-check-label">
										  <input type="radio" class="form-check-input formxx" name="F68" id="F68_<?php echo $situs_musik_val[$i]; ?>" value="<?php echo $situs_musik_val[$i]; ?>">
										  <?php echo $penggunaan_ss; ?>
										</label>
									  </div>
								</div>
						 ...
						 <div class="row">
							...
							foreach($situs_musik as $penggunaan_ss){ ?>
								...
								<div class="col-md-6">
									  <div class="form-check" >
										<label class="form-check-label">
										  <input type="radio" class="form-check-input formxx" name="F69" id="F69_<?php echo $penggunaan_ss; ?>" value="<?php echo $penggunaan_ss; ?>">
										  <?php echo $penggunaan_ss; ?>
										</label>
									  </div>
								</div>
						 ...
						 <div class="row">
							...
							foreach($situs_musik as $penggunaan_ss){ ?>
								<div class="col-md-3">
								  <div class="form-check mx-sm-2">
									  <label class="form-check-label">
										<input type="checkbox" name="f70" id="f70_<?php echo $penggunaan_ss; ?>" value="<?php echo $penggunaan_ss; ?>"  class="form-check-input formxx" >
											<?php echo $penggunaan_ss; ?>
									  </label>
									</div>
								</div> 
						 ...
						 <div class="row">
							...
							foreach($situs_musik as $penggunaan_ss){ ?>
								<div class="col-md-3">
								  <div class="form-check mx-sm-2">
									  <label class="form-check-label">
										<input type="checkbox" name="f72" id="f72_<?php echo $situs_musik_val[$i]; ?>" value="<?php echo $situs_musik_val[$i]; ?>" class="form-check-input formxx" >
											<?php echo $penggunaan_ss; ?>
									  </label>
									</div>
								</div> 
						 ...
						 <div class="row">
							...
							foreach($situs_musik as $penggunaan_ss){ ?>
								<div class="col-md-3">
								  <div class="form-check mx-sm-2">
									  <label class="form-check-label">
										<input type="checkbox" name="f73" id="f73_<?php echo $situs_musik_val[$ii]; ?>" value="<?php echo $situs_musik_val[$ii]; ?>" class="form-check-input formxx" >
											<?php echo $penggunaan_ss; ?>
									  </label>
									</div>
								</div> 
						 ...
						 <div class="row">
							...
							foreach($situs_musik as $penggunaan_ss){ ?>
								<div class="col-md-3">
								  <div class="form-check mx-sm-2">
									  <label class="form-check-label">
										<input type="checkbox" name="f74" id="f74_<?php echo $situs_musik_val[$i]; ?>" value="<?php echo $situs_musik_val[$i]; ?>" class="form-check-input formxx" >
											<?php echo $penggunaan_ss; ?>
									  </label>
									</div>
								</div> 
						 ...
						 <div class="row">
							...
							foreach($situs_musik as $penggunaan_ss){ ?>
								<div class="col-md-4">
								  <div class="form-check mx-sm-2">
									  <label class="form-check-label">
										<input type="checkbox" name="f75" id="f75_<?php echo $situs_musik_val[$i]; ?>" value="<?php echo $situs_musik_val[$i]; ?>" class="form-check-input formxx" >
											<?php echo $penggunaan_ss; ?>
									  </label>
									</div>
								</div> 
						 ...
						 <div class="row">
							...
							foreach($situs_musik as $penggunaan_ss){ ?>
								...
								<div class="col-md-4">
									  <div class="form-check" >
										<label class="form-check-label">
										  <input type="radio" class="form-check-input formxx" name="F76" id="F76_<?php echo $penggunaan_ss; ?>" value="<?php echo $penggunaan_ss; ?>">
										  <?php echo $penggunaan_ss; ?>
										</label>
									  </div>
								</div>
						 ...
						 <div class="row">
							...
							foreach($situs_musik as $penggunaan_ss){ ?>
								...
								<div class="col-md-6">
									  <div class="form-check" >
										<label class="form-check-label">
										  <input type="radio" class="form-check-input formxx" name="F77" id="F77_<?php echo $penggunaan_ss; ?>" value="<?php echo $penggunaan_ss; ?>">
										  <?php echo $penggunaan_ss; ?>
										</label>
									  </div>
								</div>
						 ...
						 <div class="row">
							...
							foreach($situs_musik as $penggunaan_ss){ ?>
								<div class="col-md-3">
								  <div class="form-check mx-sm-2">
									  <label class="form-check-label">
										<input type="checkbox" name="f78" id="f78_<?php echo $situs_musik_val[$i]; ?>" value="<?php echo $situs_musik_val[$i]; ?>" class="form-check-input formxx" >
											<?php echo $penggunaan_ss; ?>
									  </label>
									</div>
								</div> 
						 ...
						 <div class="row">
							...
							foreach($situs_musik as $penggunaan_ss){ ?>
								<div class="col-md-3">
								  <div class="form-check mx-sm-2">
									  <label class="form-check-label">
										<input type="checkbox" name="f79" id="f79_<?php echo $situs_musik_val[$i]; ?>" value="<?php echo $situs_musik_val[$i]; ?>" class="form-check-input formxx" >
											<?php echo $penggunaan_ss; ?>
									  </label>
									</div>
								</div> 
						 ...
						 <div class="row">
							...
							foreach($situs_musik as $penggunaan_ss){ ?>
								<div class="col-md-3">
								  <div class="form-check mx-sm-2">
									  <label class="form-check-label">
										<input type="checkbox" name="f80" id="f80_<?php echo $situs_musik_val[$i]; ?>" value="<?php echo $situs_musik_val[$i]; ?>" class="form-check-input formxx" >
											<?php echo $penggunaan_ss; ?>
									  </label>
									</div>
								</div> 
						 ...
						 <div class="row">
							...
							foreach($situs_musik as $penggunaan_ss){ ?>
								<div class="col-md-3">
								  <div class="form-check mx-sm-2">
									  <label class="form-check-label">
										<input type="checkbox" name="f81" id="f81_<?php echo $situs_musik_val[$i]; ?>" value="<?php echo $situs_musik_val[$i]; ?>" class="form-check-input formxx" >
											<?php echo $penggunaan_ss; ?>
									  </label>
									</div>
								</div> 
						 ...
						 <div class="row">
							...
							foreach($situs_musik as $penggunaan_ss){ ?>
								...
								<div class="col-md-6">
									  <div class="form-check" >
										<label class="form-check-label">
										  <input type="radio" class="form-check-input formxx" name="F82" id="F82_<?php echo $penggunaan_ss; ?>" value="<?php echo $penggunaan_ss; ?>">
										  <?php echo $penggunaan_ss; ?>
										</label>
									  </div>
								</div>
						 ...
						 <div class="row">
							...
							foreach($situs_musik as $penggunaan_ss){ ?>
								...
								<div class="col-md-6">
									  <div class="form-check" >
										<label class="form-check-label">
										  <input type="radio" class="form-check-input formxx" name="F83" id="F83_<?php echo $situs_musik_val[$i]; ?>" value="<?php echo $situs_musik_val[$i]; ?>">
										  <?php echo $penggunaan_ss; ?>
										</label>
									  </div>
								</div>
						 ...
						 <div class="row">
							...
							foreach($situs_musik as $penggunaan_ss){ ?>
								...
								<div class="col-md-6">
									  <div class="form-check" >
										<label class="form-check-label">
										  <input type="radio" class="form-check-input formxx" name="F84" id="F84_<?php echo $penggunaan_ss; ?>" value="<?php echo $penggunaan_ss; ?>">
										  <?php echo $penggunaan_ss; ?>
										</label>
									  </div>
								</div>
						 ...
						 <div class="row">
							...
							foreach($situs_musik as $penggunaan_ss){ ?>
								<div class="col-md-4">
								  <div class="form-check mx-sm-2">
									  <label class="form-check-label">
										<input type="checkbox" name="f85" id="f85_<?php echo $situs_musik_val[$ii]; ?>" value="<?php echo $situs_musik_val[$ii]; ?>" class="form-check-input formxx" >
											<?php echo $penggunaan_ss; ?>
									  </label>
									</div>
								</div> 
						 ...
						 <div class="row">
							...
							foreach($situs_musik as $penggunaan_ss){ ?>
								<div class="col-md-3">
								  <div class="form-check mx-sm-2">
									  <label class="form-check-label">
										<input type="checkbox" name="f86" id="f86_<?php echo $situs_musik_val[$ii]; ?>" value="<?php echo $situs_musik_val[$ii]; ?>"  class="form-check-input formxx" >
											<?php echo $penggunaan_ss; ?>
									  </label>
									</div>
								</div> 
						 ...
						 <div class="row">
							...
							foreach($situs_musik as $penggunaan_ss){ ?>
								...
								<div class="col-md-6">
									  <div class="form-check" >
										<label class="form-check-label">
										  <input type="radio" class="form-check-input formxx" name="F87" id="F87_<?php echo $penggunaan_ss; ?>" value="<?php echo $penggunaan_ss; ?>">
										  <?php echo $penggunaan_ss; ?>
										</label>
									  </div>
								</div>
						 ...
						 <div class="row">
							...
							foreach($situs_musik as $penggunaan_ss){ ?>
								<div class="col-md-3">
								  <div class="form-check mx-sm-2">
									  <label class="form-check-label">
										<input type="checkbox" name="f88" id="f88_<?php echo $situs_musik_val[$i]; ?>" value="<?php echo $situs_musik_val[$i]; ?>" class="form-check-input formxx" >
											<?php echo $penggunaan_ss; ?>
									  </label>
									</div>
								</div> 
							...
							<div class="row">
								...
								<div class="col-md-9">
									...
									<div class="col-md-3 <?php echo $array_familys[1]; ?>" style="display: none;">
									  <!--<div class="form-check mx-sm-2">
										  <label class="form-check-label">
											<input type="checkbox" name="<?php echo $field_merk[$in]; ?>_fam" value="<?php echo $array_familys[1]; ?>" class="form-check-input formxx" >
											<?php echo $array_familys[0]; ?>
										  </label>
										</div>-->
										 ...
										 <h4><?php echo $array_familys[0]; ?></h4>
											<select class="form-control js-example-basic-multiple formxxc" name="<?php echo $field_merk[$in]; ?>_<?php echo $array_familys[1]; ?>[]" id="<?php echo $field_merk[$in]; ?>_<?php echo $array_familys[1]; ?>" multiple="multiple" style="width:100%"> 
												<?php  foreach($array_merk[$field_merk[$in]]['VALUE'] as $array_merks){
						 ...
						 <div class="row">
							...
							foreach($situs_musik as $penggunaan_ss){ ?>
								...
								<div class="col-md-4">
									  <div class="form-check" >
										<label class="form-check-label">
										  <input type="radio" class="form-check-input formxx" name="F91" id="F91_<?php echo $situs_musik_val[$i]; ?>" value="<?php echo $situs_musik_val[$i]; ?>">
										  <?php echo $penggunaan_ss; ?>
										</label>
									  </div>
								</div>
						 ...
						 <div class="row">
							...
							foreach($situs_musik as $penggunaan_ss){ ?>
								...
								<div class="col-md-4">
									  <div class="form-check" >
										<label class="form-check-label">
										  <input type="radio" class="form-check-input formxx" name="F92" id="F92_<?php echo $situs_musik_val[$i]; ?>" value="<?php echo $situs_musik_val[$i]; ?>">
										  <?php echo $penggunaan_ss; ?>
										</label>
									  </div>
								</div>
						 ...
						 <div class="row">
							...
							foreach($situs_musik as $penggunaan_ss){ ?>
								<div class="col-md-3">
								  <div class="form-check mx-sm-2">
									  <label class="form-check-label">
										<input type="checkbox" name="F93" id="F93_<?php echo $situs_musik_val[$i]; ?>" value="<?php echo $situs_musik_val[$i]; ?>" class="form-check-input formxx" >
											<?php echo $penggunaan_ss; ?>
									  </label>
									</div>
								</div> 
						 ...
						 <div class="row">
							...
							foreach($situs_musik as $penggunaan_ss){ ?>
								<div class="col-md-3">
								  <div class="form-check mx-sm-2">
									  <label class="form-check-label">
										<input type="checkbox" name="F94" id="F94_<?php echo $situs_musik_val[$i]; ?>" value="<?php echo $situs_musik_val[$i]; ?>"  class="form-check-input formxx" >
											<?php echo $penggunaan_ss; ?>
									  </label>
									</div>
								</div> 
						 ...
						 <div class="row">
							...
							foreach($situs_musik as $penggunaan_ss){ ?>
								<div class="col-md-4">
								  <div class="form-check mx-sm-2">
									  <label class="form-check-label">
										<input type="checkbox" name="F95" id="F95_<?php echo $situs_musik_val[$i]; ?>" value="<?php echo $situs_musik_val[$i]; ?>" class="form-check-input formxx" >
											<?php echo $penggunaan_ss; ?>
									  </label>
									</div>
								</div> 
						 ...
						 <div class="row">
							...
							foreach($situs_musik as $penggunaan_ss){ ?>
								...
								<div class="col-md-4">
									  <div class="form-check" >
										<label class="form-check-label">
										  <input type="radio" class="form-check-input formxx" name="F96" id="F96_<?php echo $penggunaan_ss; ?>" value="<?php echo $penggunaan_ss; ?>">
										  <?php echo $penggunaan_ss; ?>
										</label>
									  </div>
								</div>
						 ...
						 <div class="row">
							...
							foreach($situs_musik as $penggunaan_ss){ ?>
								<div class="col-md-4">
								  <div class="form-check mx-sm-2">
									  <label class="form-check-label">
										<input type="checkbox" name="F97" id="F97_<?php echo $situs_musik_val[$i]; ?>" value="<?php echo $situs_musik_val[$i]; ?>" class="form-check-input formxx" >
											<?php echo $penggunaan_ss; ?>
									  </label>
									</div>
								</div> 
						 ...
						 <div class="row">
							...
							foreach($situs_musik as $penggunaan_ss){ ?>
								<div class="col-md-3">
								  <div class="form-check mx-sm-2">
									  <label class="form-check-label">
										<input type="checkbox" name="F98" id="F98_<?php echo $penggunaan_ss; ?>" value="<?php echo $penggunaan_ss; ?>" class="form-check-input formxx" >
											<?php echo $penggunaan_ss; ?>
									  </label>
									</div>
								</div> 
							...
							<div class="row">
								...
								<div class="col-md-9">
									...
									<div class="col-md-3 <?php echo $array_familys[1]; ?>" style="display: none;">
										 ...
										 <div class="form-group" >
										 <?php echo $array_familys[0]; ?>
											<select class="form-control js-example-basic-multiple formxxc" name="<?php echo $field_merk[$in]; ?>_<?php echo $array_familys[1]; ?>[]" id="<?php echo $field_merk[$in]; ?>_<?php echo $array_familys[1]; ?>" multiple="multiple" style="width:100%" onChange="change_<?php echo $field_merk[$in]; ?>('<?php echo $array_familys[1]; ?>','<?php echo $array_familys[0]; ?>')"> 
												<?php  foreach($array_merk[$field_merk[$in]]['VALUE'] as $array_merks){
						 ...
						 <div class="row">
							...
							foreach($situs_musik as $penggunaan_ss){ ?>
								<div class="col-md-3">
								  <div class="form-check mx-sm-2">
									  <label class="form-check-label">
										<input type="checkbox" name="G3" id="G3_<?php echo $ii; ?>" value="<?php echo $ii; ?>" class="form-check-input formxx" >
											<?php echo $penggunaan_ss; ?>
									  </label>
									</div>
								</div> 
						 ...
						 <div class="row">
							...
							foreach($situs_musik as $penggunaan_ss){ ?>
								<div class="col-md-3">
								  <div class="form-check mx-sm-2">
									  <label class="form-check-label">
										<input type="checkbox" name="G4" id="G4_<?php echo $ii; ?>" value="<?php echo $ii; ?>" class="form-check-input formxx" >
											<?php echo $penggunaan_ss; ?>
									  </label>
									</div>
								</div> 
						 ...
						 <div class="row">
							...
							foreach($situs_musik as $penggunaan_ss){ ?>
								<div class="col-md-3">
								  <div class="form-check mx-sm-2">
									  <label class="form-check-label">
										<input type="checkbox" name="G5" id="G5_<?php echo $ii; ?>"  value="<?php echo $ii; ?>" class="form-check-input formxx" >
											<?php echo $penggunaan_ss; ?>
									  </label>
									</div>
								</div> 
						 ...
						 <div class="row">
							...
							foreach($situs_musik as $penggunaan_ss){ ?>
								<div class="col-md-3">
								  <div class="form-check mx-sm-2">
									  <label class="form-check-label">
										<input type="checkbox" name="G6" id="G6_<?php echo $ii; ?>" value="<?php echo $ii; ?>" class="form-check-input formxx" >
											<?php echo $penggunaan_ss; ?>
									  </label>
									</div>
								</div> 
						 ...
						 <div class="row">
							...
							foreach($situs_musik as $penggunaan_ss){ ?>
								<div class="col-md-3">
								  <div class="form-check mx-sm-2">
									  <label class="form-check-label">
										<input type="checkbox" name="G7" id="G7_<?php echo $ii; ?>"  value="<?php echo $ii; ?>" class="form-check-input formxx" >
											<?php echo $ii; ?>
									  </label>
									</div>
								</div> 
						 ...
						 <div class="row">
							...
							foreach($situs_musik as $penggunaan_ss){ ?>
								<div class="col-md-4">
								  <div class="form-check mx-sm-2">
									  <label class="form-check-label">
										<input type="checkbox" name="G8" id="G8_<?php echo $ii; ?>" value="<?php echo $ii; ?>" class="form-check-input formxx" >
											<?php echo $penggunaan_ss; ?>
									  </label>
									</div>
								</div> 
						 ...
						 <div class="row">
							...
							foreach($situs_musik as $penggunaan_ss){ ?>
								<div class="col-md-3">
								  <div class="form-check mx-sm-2">
									  <label class="form-check-label">
										<input type="checkbox" name="G9" id="G9_<?php echo $ii; ?>" value="<?php echo $ii; ?>" class="form-check-input formxx" >
											<?php echo $penggunaan_ss; ?>
									  </label>
									</div>
								</div> 
						 ...
						 <div class="row">
							...
							foreach($situs_musik as $penggunaan_ss){ ?>
								...
								<div class="col-md-4">
									  <div class="form-check" >
										<label class="form-check-label">
										  <input type="radio" class="form-check-input formxx" name="g10" id="g10_<?php echo $i; ?>" value="<?php echo $i; ?>">
										  <?php echo $penggunaan_ss; ?>
										</label>
									  </div>
								</div>
...
// $("#page_identiatas_responden").hide();
			...
			$(".formxx").on('click', function(event){
				//alert("checked");
				myTimer();
			});
			
			$(".formxxc").on('change', function(event){
				//alert("checked");
				myTimer();
			});
				      ...
				      $.ajax({
						...
						//console.log(response[1].screening);
							...
							for(var i=0;i<response.length;i++){
								...
								var numbers = i+1;
								$('#program_name_'+numbers).html(response[i].CHANNEL+"<BR>"+response[i].PROGRAM+""+array_sc[response[i].screening]);
								$('#c12_channel'+numbers).val(response[i].PROGRAM);
								$('#c12_program_skala'+numbers).val(response[i].PROGRAM);
								$('#progra_skala_'+numbers).html(response[i].CHANNEL+"<BR>"+numbers+'. '+response[i].PROGRAM);
