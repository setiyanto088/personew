              ...
              if (response.status == "success") {
				 ...
				 // alert('successs');
					if(response.data.id_role == "99"){
						...
						window.location.href = "<?php echo base_url('home_supervisor');?>";
					}else{
