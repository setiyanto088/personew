...
class Api_shipper_model extends CI_Model {
	...
	public function list_datatable_report($params = array()) {					
		$sql		= "call shipper_list( ?, ?, ?, ?, ?, @total_filtered, @total)";
		$out		= array();
