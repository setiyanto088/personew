...
class Homesurveyor extends MX_Controller {

    public function __construct()
	{
		parent::__construct();
		$this->load->model('home_surveyor_model');		
	...
	public function index()
	{
			...
			$data['user'] = $this->agent_model->get_user(); 
			$data['get_history'] = $this->home_surveyor_model->get_history($session_val); 
			$data['get_summ'] = $this->home_surveyor_model->get_summ($session_val); 
			$data['get_chart'] = $this->home_surveyor_model->get_chart($session_val); 
			...
			//print_r($data['array_chart']);die;
		
			//$this->template->load('maintemplate', 'homeagent/views/detail', $data);
			$this->template->load('maintemplate', 'homeagent/views/home', $data);
	...
	function lists() {
		 ...
		 // print_r($params);die;
			...
			$list = $this->home_surveyor_model->list_po($params); 
	...
	public function detail(){
			...
			$result = $this->home_surveyor_model->get_detail($data['id']);
