...
class Home_kordinator_model extends CI_Model {
	...
	public function get_total_interview($user_id){
		...
		$sql = "
		SELECT SUM(total_interview) total_call FROM (
		SELECT b.id,b.nama,COUNT(DISTINCT(cardno)) total_interview, SUM(`RESP`) AS all_resp FROM t_outbond_call a 
			JOIN u_user b ON a.id_user = b.id
