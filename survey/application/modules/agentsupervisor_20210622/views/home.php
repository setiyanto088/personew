				...
				<div class="row">
					...
					<div class="col-md-12" style="margin-top:10px;">
					   <div class="col-12 col-xl-12 mb-4 mb-xl-0">
						...
						<div class="col-md-12" >
						<form class="forms-sample" id="add_user" role="form" action="<?php echo base_url('agentsupervisor/add_user');?>" method="post" enctype="multipart/form-data">
						<div class="row" id="create_user" style="">
							<div class="col-md-10">
							<h3 class="font-weight-bold">Pendaftaran</h3>
								<h4><label for="exampleInputEmail1">Agent Interviewer</label></h4>
							</div>
										...
										<br>
											...
											<?php foreach($kecamatan_data['kecamatan'] as $array_familys){ ?>
											 <div class="col-md-6" >
											  <div class="form-check">
												  <label class="form-check-label">
													<input type="checkbox" name="kecamatan" value="<?php echo $array_familys['KECAMATAN_DAGRI']; ?>" class="form-check-input" >
								...
								<div class="col-md-12">
									<button class="btn btn btn-danger col-md-12" style="margin-bottom:10px" type="submit" >Daftar Agent</button>
								</diV>
			  ...
			  <div class="row">
					<div class="col-md-12" style="margin-left:10px">
						<div class="row" id="list_user">
							<div class="col-md-10">
								<h4><label for="exampleInputEmail1">Active Agent Surveyor</label></h4>
