...
class Not_process extends MX_Controller {
	...
	public function index()
	{
			...
			$this->template->load('maintemplate', 'not_process/views/home');
	...
	public function detail(){
		...
		$this->template->load('maintemplate', 'not_process/views/detail', $data);
