...
class Reports extends MX_Controller {
	...
	public function exports() {
		...
		$array_surveys = $this->reports_model->list_survey();
			...
			$data['array_t1'] = [['MEDAN',38,92,130],['BANDA ACEH',13,34,47],['PEMATANG SIANTAR',8,12,20],['PEKANBARU',8,104,112],['PADANG',60,60,120],['PALEMBANG',26,67,93],['JAMBI',11,56,67],['BANDAR LAMPUNG',23,72,95]];
			$data['array_t2'] = [['JAKARTA TIMUR',209,118,327],['BEKASI',229,169,398],['JAKARTA SELATAN',276,12,288],['JAKARTA BARAT',188,12,200],['TANGERANG',121,122,243],['JAKARTA UTARA',213,13,226],['JAKARTA PUSAT',130,28,158],['BOGOR',93,180,273],['TANGERANG SELATAN',126,47,173],['DEPOK',147,64,211]];
			$data['array_t3'] = [['BANDUNG',267,141,408],['TASIKMALAYA',28,36,64],['SUKABUMI',36,38,74]];
			$data['array_t4'] = [['SEMARANG',117,51,168],['YOGYAKARTA',27,5,32],['SURAKARTA/SOLO',29,9,38]];
			$data['array_t5'] = [['SURABAYA',105,51,156],['MALANG',18,59,77],['SIDOARJO',51,43,94],['DENPASAR',49,4,53]];
			$data['array_t6'] = [['BALIKPAPAN',84,25,109],['SAMARINDA',109,32,141],['BANJARMASIN',43,10,53],['PONTIANAK',66,11,77]];
			$data['array_t7'] = [['MAKASSAR',63,50,113],['MANADO',64,7,71],['AMBON',40,15,55],['MATARAM',26,10,36]];
	   ...
	   $objPHPExcel->setActiveSheetIndex(0)
					...
					->setCellValue('C'.$i, '3.141')
					->setCellValue('D'.$i, $total_urban)
					->setCellValue('E'.$i, number_format(($total_urban/3141)*100,1,',','.').' %')
					->setCellValue('F'.$i, '1.859')
					->setCellValue('G'.$i, $total_rural)
					->setCellValue('H'.$i, number_format(($total_rural/1859)*100,1,',','.').' %')
