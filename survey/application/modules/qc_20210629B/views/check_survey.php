            ...
            <div class="col-md-12 grid-margin">
              <div class="row">
                <div class="col-12 col-xl-8 mb-4 mb-xl-0"  >
                  <h3 class="font-weight-bold">Quality Check </h3><p id="demo"></p>
				 <h6 id="info-na"></h6>
                </div>
				<!--
					...
					<div class="row">
							...
							<div class="col-2">
									  ...
									  <ul class="nav nav-pills nav-pills-vertical nav-pills-info" id="v-pills-tab" role="tablist" aria-orientation="vertical">
										<li class="nav-item">
										  <a class="nav-link active" id="identitas_resp_tab" data-bs-toggle="pill" href="#identitas_resp_h" role="tab" aria-controls="identitas_resp_h" onClick='tabs_1()' aria-selected="true">
											<!--<i class="ti-home"></i>-->
											IDENTITAS RESPONDEN
										  </a>                          
										</li>
										<li class="nav-item">
										  <a class="nav-link " id="demografi_respondent_tab" data-bs-toggle="pill" href="#demografi_respondent_h" role="tab" aria-controls="demografi_respondent_h" onClick='tabs_2()' aria-selected="false">
											R. DEMOGRAFI RESPONDEN
										  </a>                          
										</li>
										<li class="nav-item">
										  <a class="nav-link" id="profile_rt_tab" data-bs-toggle="pill" href="#profile_rt_h" role="tab" aria-controls="identitas_resp_h" onClick='tabs_3()' aria-selected="true">
											A. PROFIL RUMAH TANGGA
										  </a>                          
										</li>
										<li class="nav-item">
										   <a class="nav-link" id="internet_data_tab" data-bs-toggle="pill" href="#internet_data_h" role="tab" aria-controls="internet_data_h" onClick='tabs_4()' aria-selected="true">
											B. INTERNET DAN DATA
										  </a>                          
										</li>
										<li class="nav-item">
										  <a class="nav-link" id="menonton_tv_tab" data-bs-toggle="pill" href="#menonton_tv_h" role="tab" aria-controls="menonton_tv_h" onClick='tabs_5()' aria-selected="true">
											C. MENONTON TELEVISI
										  </a>                          
										</li>
										<li class="nav-item">
										  <a class="nav-link" id="program_tv_tab" data-bs-toggle="pill" href="#program_tv_h" role="tab" aria-controls="program_tv_h" onClick='tabs_6()' aria-selected="true">
											D. PROGRAM ACARA TELEVISI
										  </a>                          
										</li>
										<li class="nav-item">
										  <a class="nav-link" id="kesan_pemirsa_tab" data-bs-toggle="pill" href="#kesan_pemirsa_h" role="tab" aria-controls="kesan_pemirsa_h" onClick='tabs_7()' aria-selected="false">
											E. KESAN PEMIRSA
										  </a>                          
										</li>
										<li class="nav-item">
										  <a class="nav-link" id="kegemaran_prilaku_tab" data-bs-toggle="pill" href="#kegemaran_prilaku_h" role="tab" aria-controls="kegemaran_prilaku_h" onClick='tabs_8()' aria-selected="false">
											F. KEGEMARAN & PERILAKU
										  </a>                          
										</li>
										<li class="nav-item">
										  <a class="nav-link" id="product_ownership_tab" data-bs-toggle="pill" href="#product_ownership_h" role="tab" aria-controls="product_ownership_h" onClick='tabs_9()'  aria-selected="false">
											G. PRODUCT OWNERSHIP
										  </a>                          
										</li>
										<li class="nav-item">
										  <a class="nav-link" id="qc_tab" data-bs-toggle="pill" href="#qc_h" role="tab" aria-controls="qc_h" onclick='tabs_10()' aria-selected="false">
											QUALITY CONTROL
										  </a>                          
										</li>
									  ...
									  <div class="tab-content tab-content-vertical" id="v-pills-tabContent">
											  ...
											  <div style="border-bottom:1px solid #CED4DA !important;">
												<div class="form-group">
													...
													<div class="input-group">
														 <input type="text" class="form-control" id="id_pelanggan" value="<?php echo $outbound[0]['cardno']; ?>" placeholder="ID Pelanggan" readOnly>
													</div>
												</div>
												 ...
												 <div class="form-group">
												  ...
												  <input type="text" class="form-control" id="nama_respondent" placeholder="Nama Responden" readOnly>
												</div>
												<div class="form-group">
												  <label for="exampleInputEmail1">Alamat Rumah</label>
												  <input type="text" class="form-control" id="alamat_rumah" placeholder="Alamat Rumah" readOnly>
												</div>
												<div class="form-group">
												  <label for="exampleInputEmail1">Kelurahan</label>
												  <input type="text" class="form-control" id="kelurahan" placeholder="Kelurahan" readOnly>
												</div>
												  <div class="form-group">
												  <label for="exampleInputEmail1">Kecamatan</label>
												  <input type="text" class="form-control" id="kecamatan" placeholder="Kecamatan" readOnly>
												</div>
												  <div class="form-group">
												  <label for="exampleInputEmail1">No. Telp</label>
												  <input type="text" class="form-control" id="no_tel" placeholder="No. Telp" readOnly>
												</div>
												  <div class="form-group">
										...
										<div class="tab-pane fade" id="demografi_respondent_h" role="tabpanel" aria-labelledby="demografi_respondent_h">
										  <div class="media" >
											...
											<form class="forms-sample" style="border-bottom:1px solid #CED4DA !important;pointer-events:none;">
												<div class="form-group">
			...
			function start_survey(){
			 ...
			 function tabs_6(){
			  ...
			  function back_qc(){
				  ...
				  window.location.href = "<?php echo base_url() . 'qc'; ?>";
			  ...
			  function save_qc(){
				  ...
				  var valid = 0;
				  	var formData = new FormData();
					var urls = "<?php echo base_url('qc/insert_qc'); ?>";
				  
				  if($("input:checkbox[name=info_vali]").is(':checked')){
					 formData.append('info_vali', '1');
					 valid++;
				  }else{
					 formData.append('info_vali', '0');
				  }
				  
				   if($("input:checkbox[name=demografi_vali]").is(':checked')){
					 formData.append('demografi_vali', '1');
					  valid++;
				  }else{
					 formData.append('demografi_vali', '0');
				  }
				  
				   if($("input:checkbox[name=profile_rt_vali]").is(':checked')){
					 formData.append('profile_rt_vali', '1');
					  valid++;
				  }else{
					 formData.append('profile_rt_vali', '0');
				  }
				  
				   if($("input:checkbox[name=internet_data_vali]").is(':checked')){
					 formData.append('internet_data_vali', '1');
					  valid++;
				  }else{
					 formData.append('internet_data_vali', '0');
				  }
				  
				   if($("input:checkbox[name=menonton_tv_vali]").is(':checked')){
					 formData.append('menonton_tv_vali', '1');
					  valid++;
				  }else{
					 formData.append('menonton_tv_vali', '0');
				  }
				  
				   if($("input:checkbox[name=program_tv_vali]").is(':checked')){
					 formData.append('program_tv_vali', '1');
					  valid++;
				  }else{
					 formData.append('program_tv_vali', '0');
				  }
				  
				   if($("input:checkbox[name=kesan_pemirsa_vali]").is(':checked')){
					 formData.append('kesan_pemirsa_vali', '1');
					  valid++;
				  }else{
					 formData.append('kesan_pemirsa_vali', '0');
				  }
				  
				   if($("input:checkbox[name=kegemaran_prilaku_vali]").is(':checked')){
					 formData.append('kegemaran_prilaku_vali', '1');
					  valid++;
				  }else{
					 formData.append('kegemaran_prilaku_vali', '0');
				  }
				  
				   if($("input:checkbox[name=product_ownership_vali]").is(':checked')){
					 formData.append('product_ownership_vali', '1');
					  valid++;
				  }else{
					 formData.append('product_ownership_vali', '0');
				  }
					
					 formData.append('info_note', $('#info_note').val());
					 formData.append('demografi_note', $('#demografi_note').val());
					 formData.append('profile_rt_note', $('#profile_rt_note').val());
					 formData.append('internet_data_note', $('#internet_data_note').val());
					 formData.append('menonton_tv_note', $('#menonton_tv_note').val());
					 formData.append('program_tv_note', $('#program_tv_note').val());
					 formData.append('kesan_pemirsa_note', $('#kesan_pemirsa_note').val());
					 formData.append('kegemaran_prilaku_note', $('#kegemaran_prilaku_note').val());
					 formData.append('product_ownership_note', $('#product_ownership_note').val());
					 formData.append('id_outbound', <?php echo $id_outbound; ?>);
					 formData.append('valid', valid);
						
						if(valid == 9){
							var msg_val = "Data telah Valid ";
						}else{
							var msg_val = "Data Belum Valid ";
						}
