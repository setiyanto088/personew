					...
					<div class="col-md-12" style="margin-top:40px;">
					   <div class="col-12 col-xl-12 mb-4 mb-xl-0">
						...
						<div class="row">
							...
							<div class="col-md-12" >
							  <form class="forms-sample" id="edit_user" role="form" action="<?php echo base_url('kordinator_profile/edit_user');?>" method="post" >
			  ...
			  <div class="row">
					<div class="col-md-12" style="margin-left:10px">
						<div class="row" id="list_user">
							<div class="col-md-10">
								<h4><label for="exampleInputEmail1">Active Kordinator</label></h4>
								<label for="exampleInputEmail1">Daftar List Kordinator</label>
							</div>
						 ...
						 <form class="forms-sample" id="add_user" role="form" action="<?php echo base_url('kordinator_profile/add_user');?>" method="post" enctype="multipart/form-data">
