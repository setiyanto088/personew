                ...
                <div class="col-md-3 mb-4  " >
                  <div class="card card-light-danger" style="background-color:#ff1414">
                    <div class="card-body">
                      ...
                      <p><?php echo number_format(($data_qc[0]['cnt']/$data_qc[0]['total_survey']),3,',','.'); ?> % </p>
                    </div>
                  </div>
                </div>
                <div class="col-md-3 mb-4  ">
                  <div class="card card-light-danger" style="background-color:#ff1414">
                    <div class="card-body">
                      ...
                      <p><?php echo number_format(($data_qc[0]['valid']/$data_qc[0]['total_survey']),3,',','.'); ?> % </p>
                    </div>
                  </div>
                </div>
                <div class="col-md-3 mb-4 mb-lg-0  ">
                  <div class="card card-light-danger" style="background-color:#ff1414">
                    <div class="card-body">
                      ...
                      <p><?php echo number_format(($data_qc[0]['tidak_valid']/$data_qc[0]['total_survey']),3,',','.'); ?> % </p>
                    </div>
                  </div>
                </div>
                <div class="col-md-3 ">
                  <div class="card card-light-danger" style="background-color:#ff1414">
                    <div class="card-body">
                      <p class="mb-4">Sisa</p>
                      <p class="fs-30 mb-2"><?php echo number_format($data_qc[0]['total_survey'] - $data_qc[0]['cnt'],0,',','.'); ?></p>
                      <p><?php echo number_format((($data_qc[0]['total_survey']-$data_qc[0]['cnt'])/$data_qc[0]['total_survey']),3,',','.'); ?> % </p>
                    </div>
                  </div>
                </div>
              </div>
