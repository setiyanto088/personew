...
class Contact extends MX_Controller {
	...
	public function filter_kota(){
		...
		foreach($result as $results){
			...
			$html .= "<tr onclick=\"select_cont('".$results['NAMA_PELANGGAN']."|".$results['NO_HP']."|".$results['CARDNO']."|".$results['ALAMAT']."')\" style='cursor: pointer;' ><td>".$results['NAMA_PELANGGAN']."</td><td>+62".$results['NO_HP']."</td></tr>";
