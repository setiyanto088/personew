...
class Contact_model extends CI_Model {
	...
	public function get_list_contact($param,$SES){
		...
		LIMIT 0';
			...
			$sql 	= 'SELECT A.*,KOTA_KABUPATEN_DAGRI as KOTA_X, NAMA AS NAMA_PELANGGAN, NOTEL_INET as CARDNO, ALAMAT_NOSS AS ALAMAT from RESPONDENT_SURVEY_CLEAR A
	...
	public function get_respondent($data){
		...
		$sql 	= "
		SELECT * FROM `TOP_20_PROGRAM_SURVEY_CLEAN`
