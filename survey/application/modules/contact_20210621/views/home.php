						...
						<div class="row" id="create_user2" style="display: none;margin-right:5px;margin-bottom:15px" >
								...
								<div class="col-md-12">
									 <form class="forms-sample" id='form_responds'>
										<div class="form-group">
										  <select class="form-control" id="respond" placeholder="respond" style="border-radius:20%" onChange="select_respond()" disabled="disabled" >
											...
											<option value="7">Bersedia jadi Responden</option>
										  </select>
										</div>
...
pelanggan sudah Terkonfirmasi dan data pelanggan
