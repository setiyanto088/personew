...
class Qc_surveyor extends MX_Controller {
	...
	//public function index(){
			...
			//if($data['kuisioner'][0]['status_survey'] == 2){
				...
				$this->template->load('maintemplate', 'qc_surveyor/views/survey_new_resume', $data);
				//echo 'resume';
			// }else{
			...
			//$this->template->load('maintemplate', 'qc_surveyor/views/detail', $data);
	...
	public function index()
	{
			...
			$list_location=$this->input->post('list_location_text');
			...
			//echo $data['respond'];die;
			
			$session_val = $this->session->userdata['logged_in'];
			$user_id = $this->session->userdata['logged_in']['user_id'];
			$data['session'] = $session_val;
			$data['user'] = $this->qc_model->get_user(); 
			//$data['get_history'] = $this->qc_model->get_history($user_id,$data['list_location']); 
			...
			$data['get_history'] = $this->qc_model->get_history_filter($data['filter']); 
...
'<div class="badge badge-success" ><h5>Selesai Survey</h5></div>',
			...
			//$this->template->load('maintemplate', 'qc_surveyor/views/detail', $data);
			$this->template->load('maintemplate', 'qc_surveyor/views/home', $data);
	...
	//public function index(){
			...
			$list_location=$this->input->post('list_location');
			$start_date=$this->input->post('start_date');
			$end_date=$this->input->post('end_date');
			$respond=$this->input->post('respond');
			//$id_outbound =  $this->uri->segment('3');
			...
			$this->template->load('maintemplate', 'qc_surveyor/views/check_survey', $data);
