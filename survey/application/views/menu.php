	   ...
	   if (isset($menu['parents'][$parent]))
	   {
		  ...
		  foreach ($menu['parents'][$parent] as $itemId)
		  {
			 if( ! isset($menu['parents'][$itemId]))
			 {
				 ...
				 if($menu['items'][$itemId]['url'] == 'report_excel'){
					...
					'
					  ...
					  <li class="nav-item">
						<a class="nav-link" onClick="print_excel()" href="javascript:void(0);">
...
function print_excel(){
	...
	$.ajax({
			url: "<?php echo base_url().'report_excel/export'; ?>", 
			...
			success: function(data){
				...
				download_file('https://inrate.id/tmp_doc/report_excel.xls','report_excel_bys.xls'); 
