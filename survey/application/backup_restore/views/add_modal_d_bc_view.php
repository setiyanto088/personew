...
<form class="form-horizontal form-label-left" id="add_form" role="form" action="<?php echo base_url('bc/save_detail');?>" method="post" enctype="multipart/form-data" data-parsley-validate>
	...
	<div class="item form-group">
		...
		<div class="col-md-8 col-sm-6 col-xs-12">
			<input data-parsley-minlength="4" data-parsley-maxlength="20" type="text" id="kd_brg_bc" name="kd_brg_bc" class="form-control col-md-7 col-xs-12" placeholder="nama properties minimal 4 karakter" autocomplete="off" required="required">
	...
	<div class="item form-group">
		...
		<div class="col-md-8 col-sm-6 col-xs-12">
			<input data-parsley-minlength="4" data-parsley-maxlength="20" type="text" id="kd_brg" name="kd_brg" class="form-control col-md-7 col-xs-12" placeholder="nama properties minimal 4 karakter" autocomplete="off" required="required">
		...
		<div class="col-md-8 col-sm-6 col-xs-12">
			<select class="form-control" id="uom_id" name="uom_id" style="width: 100%" required>
				...
				<?php foreach($uom as $key) { ?>
					<option value="<?php echo $key['id_uom']; ?>">
		...
		<div class="col-md-8 col-sm-6 col-xs-12">
			<select class="form-control" id="valas_id" name="valas_id" style="width: 100%" required>
				...
				<?php foreach($valas as $key) { ?>
					<option value="<?php echo $key['valas_id']; ?>">
	...
	<div class="item form-group">
		...
		<div class="col-md-8 col-sm-6 col-xs-12">
			<input type="text" id="price" name="price" class="form-control col-md-7 col-xs-12" placeholder="Price" autocomplete="off" required="required" onkeypress="javascript:return isNumber(event)">
		</div>
	</div>
	...
	<div class="item form-group">
		...
		<div class="col-md-8 col-sm-6 col-xs-12">
			<input type="text" id="weight" name="weight" class="form-control col-md-7 col-xs-12" placeholder="Weight" autocomplete="off" required="required" onkeypress="javascript:return isNumber(event)">
		</div>
	</div>
	...
	<div class="item form-group">
		...
		<div class="col-md-8 col-sm-6 col-xs-12">
			<input type="text" id="qty" name="qty" class="form-control col-md-7 col-xs-12" placeholder="Qty" autocomplete="off" required="required" onkeypress="javascript:return isNumber(event)">
		</div>
	</div>
