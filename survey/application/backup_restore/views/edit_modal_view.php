...
<form class="form-horizontal form-label-left" id="edit_form" role="form" action="<?php echo base_url('bc_masuk/save_edit_bc');?>" method="post" enctype="multipart/form-data" data-parsley-validate>
			...
			<select class="form-control" id="jenis_bc" name="jenis_bc" style="width: 100%" required>
				...
				<?php foreach($jenis_bc as $key) { ?>
					...
					if(isset($bc[0]['jenis_bc'])) {
						if( $bc[0]['jenis_bc'] == $key['id'] ) { echo "selected"; }
					}?> ><?php
						echo $key['jenis_bc']; ?>
					</option>
				<?php } ?>
	...
	<div class="item form-group">
		...
		<div class="col-md-8 col-sm-6 col-xs-12">
			<input data-parsley-minlength="4" data-parsley-maxlength="100" type="number" id="nopendaftaran" name="nopendaftaran" class="form-control col-md-7 col-xs-12"
				placeholder="no pendaftaran minimal 4 karakter" value="<?php if(isset($bc[0]['no_pendaftaran'])){ echo $bc[0]['no_pendaftaran']; }?>" autocomplete="off"
			required="required">
	...
	<div class="item form-group">
		...
		<div class="col-md-8 col-sm-6 col-xs-12">
			<input data-parsley-minlength="4" data-parsley-maxlength="100" type="text" id="nopengajuan" name="nopengajuan" class="form-control col-md-7 col-xs-12"
				placeholder="no pengajuan minimal 4 karakter" value="<?php if(isset($bc[0]['no_pengajuan'])){ echo $bc[0]['no_pengajuan']; }?>" autocomplete="off"
			required="required">
