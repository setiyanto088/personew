...
$(document).ready(function() {
  ...
  $select.each(function() {
    ...
    $(this).next('.urate-select-dropdown').append($hiddenElement).append("<button class='urate-custom-button'>"+$(this).attr("title")+"</button>").append("<ul class='urate-custom-menu'></ul>");
