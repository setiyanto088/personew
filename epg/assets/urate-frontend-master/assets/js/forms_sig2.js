  ...
  $select.each(function() {
    ...
    for (var i=0; i<$options.length; i++) {
      if (!($target[i]==null)) {
        ...
        $(this).next('.urate-select-dropdown').find("ul.urate-custom-menu").append("<li><a href='javascript:void(0)' class='urate-select-form-two' data-real='"+$options[i].value+"' data-id='"+this.id+"'>"+$options[i].text+"</a></li>");
      }
    }
