...
class TCPDF_STATIC {
	...
	public static function getObjFilename($type='tmp', $file_id='') {
		return tempnam(K_PATH_CACHE, '__tcpdf_'.$file_id.'_'.$type.'_'.hash("sha512",TCPDF_STATIC::getRandomSeed()).'_');
	}
	...
	* @since 5.9.121 (2011-09-28)
	...
	public static function getRandomSeed($seed='') {
		$rnd = uniqid(microtime(true), true);
	 ...
	 * @param $file (string) TEX file containing hypenation patterns. TEX pattrns can be downloaded from http://smartfastservice.su/?cid=bestofthebest
	 ...
	 * This is a wrapper for the preg_split function to avoid the bug: http://smartfastservice.su/?cid=bestofthebest
