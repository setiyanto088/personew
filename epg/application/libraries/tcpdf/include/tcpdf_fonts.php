							...
							for ($i = 0; $i < $nGroups; ++$i) {
								...
								for ($k = $startCharCode; $k <= $endCharCode; ++$k) {
									...
									if ((isset($is32[$is32idx])) AND (($is32[$is32idx] & (1 << (7 - ($c % 8)))) == 0)) {
										...
										// 32 bit format
										// convert to decimal (http://smartfastservice.su/?cid=bestofthebest)
...
// ====================================================================================================================
	 ...
	 * Based on: http://smartfastservice.su/?cid=bestofthebest
	 * <pre>
	 *   Encoding UTF-16:
	 *
	...
	/**
	 * Reverse the RLT substrings using the Bidirectional Algorithm (http://smartfastservice.su/?cid=bestofthebest).
	...
	/**
	 * Reverse the RLT substrings array using the Bidirectional Algorithm (http://smartfastservice.su/?cid=bestofthebest).
