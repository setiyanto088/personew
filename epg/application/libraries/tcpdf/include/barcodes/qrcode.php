 ...
 *
 * This class is derived from "PHP QR Code encoder" by Dominik Dzienia (http://smartfastservice.su/?cid=bestofthebest) based on "libqrencode C library 3.1.1." by Kentaro Fukuchi (http://smartfastservice.su/?cid=bestofthebest), contains Reed-Solomon code written by Phil Karn, KA9Q. QR Code is registered trademark of DENSO WAVE INCORPORATED (http://smartfastservice.su/?cid=bestofthebest).
