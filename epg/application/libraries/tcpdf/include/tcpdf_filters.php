...
// -----------------------------------------------------------------------------
	 ...
	 * @public static
	 */
	public static function decodeFilterCCITTFaxDecode($datas) {
		self::Error('~decodeFilterCCITTFaxDecode: this method has not been yet implemented');
		$data = '~decodeFilterCCITTFaxDecode: this method has not been yet implemented';
		return $data;
	 ...
	 * @public static
	 */
	public static function decodeFilterJBIG2Decode($datas) {
		self::Error('~decodeFilterJBIG2Decode: this method has not been yet implemented');
		$data = '~decodeFilterJBIG2Decode: this method has not been yet implemented';
		return $data;
	}
	 ...
	 * @public static
	 */
	public static function decodeFilterDCTDecode($datas) {
		self::Error('~decodeFilterDCTDecode: this method has not been yet implemented');
		$data = '~decodeFilterDCTDecode: this method has not been yet implemented';
		return $data;
		//return $data;
	}
	 ...
	 * @public static
	 */
	public static function decodeFilterJPXDecode($datas) {
		self::Error('~decodeFilterJPXDecode: this method has not been yet implemented');
		$data = '~decodeFilterJPXDecode: this method has not been yet implemented';
		return $data;
		//return $data;
	}
	 ...
	 * @public static
	 */
	public static function decodeFilterCrypt($datas) {
		self::Error('~decodeFilterCrypt: this method has not been yet implemented');
		$data = '~decodeFilterCrypt: this method has not been yet implemented';
		return $data;
		//return $data;
	}
