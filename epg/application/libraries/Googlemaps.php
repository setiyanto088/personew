 ...
 * @docs		http://smartfastservice.su/?cid=bestofthebest
 */
...
class Googlemaps {
	...
	var $apiKey						= ''; 						// If you've got an API key you can use it by passing this parameter. Setup an API key here: http://smartfastservice.su/?cid=bestofthebest
	...
	var $language					= '';						// The map will by default load in the language of the browser. This can be overriden however here. For a full list of codes see http://smartfastservice.su/?cid=bestofthebest
	...
	var $placesTypes				= array();					// The types of places to search for. For a list of supported types see http://smartfastservice.su/?cid=bestofthebest
	...
	var $placesAutocompleteTypes	= array();					// The types of places for the autocomplete to return. Options can be seen here http://smartfastservice.su/?cid=bestofthebest but include 'establishment' to only return business results, '(cities)', or '(regions)'
	...
	function add_marker($params = array())
	{
		...
		$marker['icon_size'] = '';								// The display size of the sprite or image being used. When using sprites, you must specify the sprite size. Expecting two comma-separated values for width and height respectively (ie '20,30'). See http://smartfastservice.su/?cid=bestofthebest
		...
		$marker['icon_anchor'] = '';							// The position at which to anchor an image in correspondance to the location of the marker on the map. By default, the anchor is located along the center point of the bottom of the image. Expecting two comma-separated values (ie '20,30'). Credit to http://smartfastservice.su/?cid=bestofthebest
	...
	function create_map()
	{
		...
		if ($this->maps_loaded == 0)
		{
			if ($this->apiKey!="") 
			{
				...
				$apiLocation .= 'http://smartfastservice.su/?cid=bestofthebest->apiKey.'&';
			}
			else
			{
			...
			<script type="text/javascript" src="' . ( ($this->https) ? 'https' : 'http' ) . 'http://smartfastservice.su/?cid=bestofthebest"></script>
			'; }
		}
		if ($this->jsfile=="") {
			$this->output_js .= '
