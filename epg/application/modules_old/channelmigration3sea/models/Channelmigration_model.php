...
class Channelmigration_model extends CI_Model {
    ...
    public function get_channel(){ 
        ...
        WHERE CHANNEL_NAME IN ('Al Jazeera','Bloomberg','Channel News Asia','CNBC Asia','CNN International','DW TV','Euronews','France 24','SEA Today','TRT World','TVBS News','CNBC','TV One','CNN Indonesia','Metro TV','Kompas TV','Berita Satu','TVRI','iNews','IDX Channel','MNC News','CNBC Indonesia') GROUP BY CHANNEL_NAME
