									...
									<table aria-describedby="mydesc"  id="example34" class="table table-striped" style=" font-size:11px !important;table-layout:fixed;">
										<thead  style="color:red">
											<tr>
												...
												<th colspan="2" scope="row">Regional 1 <img alt="img" class="cArrowDown"  alt="arrow" ></th>
												
												<th colspan="2" scope="row">Regional 2 <img alt="img" class="cArrowDown" ></th>
												<th colspan="2" scope="row">Regional 3 <img alt="img" class="cArrowDown"  alt="arrow" ></th>
...
function table_sel(){
		...
		var tahun = $('#periode_head').val();
			...
			$.ajax({
				...
				success: function(data){
					...
					var table_html = '<table aria-describedby="mydesc"  id="example3" class="table table-striped " style="overflow-x:auto;white-space: nowrap; font-size:11px !important;"><thead style="color:red"><tr><th class="sorting">Rank <img alt="img" class="cArrowDown" ></th><th class="sorting">Regional 1 <img alt="img" class="cArrowDown" ></th><th class="sorting">Regional 2 <img alt="img" class="cArrowDown" ></th><th class="sorting">Regional 3 <img alt="img" class="cArrowDown" ></th><th class="sorting">Regional 4 <img alt="img" class="cArrowDown" ></th><th class="sorting">Regional 5 <img alt="img" class="cArrowDown" ></th><th class="sorting">Regional 6 <img alt="img" class="cArrowDown" ></th><th class="sorting">Regional 7 <img alt="img" class="cArrowDown" ></th></tr></thead></table>';
	...
	$('#table_program').html("");
	$('#table_program').append('<table aria-describedby="mydesc"  id="example32" class="table table-striped " style="font-size:11px !important;"><thead style="color:red"><tr><th style="width:15px">Rank <img alt="img" class="cArrowDown" ></th><th>Regional 1 <img alt="img" class="cArrowDown" ></th><th>Regional 2 <img alt="img" class="cArrowDown" ></th><th>Regional 3 <img alt="img" class="cArrowDown" ></th><th>Regional 4 <img alt="img" class="cArrowDown" ></th><th>Regional 5 <img alt="img" class="cArrowDown" ></th><th>Regional 6 <img alt="img" class="cArrowDown" ></th><th>Regional 7 <img alt="img" class="cArrowDown" ></th></tr></thead></table>');
