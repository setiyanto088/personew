									...
									<table aria-describedby="mydesc"  id="example32" class="table table-striped" style=" overflow-x:auto;white-space: nowrap; font-size:11px !important;">
										<thead style="color:red">
											<tr>
												...
												<th scope="row">Minipack <img alt="img" class="cArrowDown" ></th>
											</tr>
				...
				<div class="result-table" style="overflow-x:hidden">
								...
								<div id="table_program_program">
									<table aria-describedby="mydesc"  id="example34" class="table table-striped" style=" font-size:11px !important;table-layout:fixed;">
										<thead style="color:red">
											<tr>
												<th rowspan="2" style="width:15px" scope="col">Rank <img alt="img" class="cArrowDown"  alt="arrow" ></th>
												<th colspan="2" scope="row">Program <img alt="img" class="cArrowDown"  alt="arrow" ></th>

												
											</tr>
											<tr>
												<th scope="row">Program<img alt="img" class="cArrowDown"  alt="arrow" ></th>
												<th scope="row">Channel<img alt="img" class="cArrowDown"  alt="arrow" ></th>
											</tr>
...
function table_sel(){
	 ...
	 $("#table_program_channel").append(' <img alt="img" id="loading" src="<?php echo base_url();?>assets/urate-frontend-master/assets/images/icon_loader.gif">');
			...
			$.ajax({
				...
				success: function(data){
					...
					var table_html = '<table aria-describedby="mydesc"  id="example3" class="table table-striped" style="overflow-x:auto;white-space: nowrap; font-size:14px !important;"><thead style="color:red"><tr><th style="width:15px">Rank <img alt="img" class="cArrowDown" ></th><th >Channel <img alt="img" class="cArrowDown" ></th></tr></thead></table>';
	...
	$('#table_program').html("");
	$('#table_program').append('<table aria-describedby="mydesc"  id="example32" class="table table-striped" style="font-size:14px !important;"><thead style="color:red"><tr><th style="width:15px">Rank <img alt="img" class="cArrowDown" ></th><th>Minipack <img alt="img" class="cArrowDown" ></th></tr></thead></table>');
			...
			$.ajax({
				...
				success: function(data){
					...
					if(tpe == 'table'){
						...
						var table_html = '<table aria-describedby="mydesc"  id="example3" class="table table-striped " style="overflow-x:auto;white-space: nowrap; font-size:11px !important;"><thead style="color:red"><tr><th style="width:15px">Rank <img alt="img" class="cArrowDown" ></th><th >Channel <img alt="img" class="cArrowDown" ></th></tr></thead></table>';
