...
class Audience_model extends CI_Model {
	...
	public function __construct()
	{
	 ...
	 function list_program($param){  	
        $query2 = "SELECT PROGRAM, START_PROGRAM FROM `M_SUMMARY_AUDIENCE_N_PTV`
  			WHERE DATE_FORMAT(`DATE`,'%d/%m/%Y') = '".$param['date']."' 
	 ...
	 public function get_channel(){       
		 ...
		 $sql = "SELECT CHANNEL_NAME AS CHANNEL_CIM, CHANNEL_NAME AS CHANNEL_CDR FROM `CHANNEL_PARAM` C
  ...
  public function current_date() {
	...
	public function get_userid($data) {
      ...
      return $sql->result_array();	   
		...
		$sql = "SELECT * FROM M_SUMMARY_AUDIENCE_RESUME2
				WHERE  SEGMENT <> ''
				AND VIEWERS >= 100 
	...
	public function list_chart_audience($params = array()) {	
		...
		public function list_chart_audience_reg($params = array()) {	
	...
	public function list_chart_audience_witel($params = array()) {	
	...
	public function list_chart_audience_datel($params = array()) {	
	...
	public function list_chart_audience_sto($params = array()) {	
	...
	public function list_audience_comm($params = array()) {	
            ...
            $limit_data = $params['limit'] ;
				...
				$sql2 = "SELECT *, RANK() OVER (
				ORDER BY VIEWERS DESC
				) RANK FROM M_SUMMARY_AUDIENCE_RESUME2
				WHERE  SEGMENT <> ''
				AND VIEWERS >= 100 
				AND FIELD = 'HELIX_COMM'
				ORDER BY VIEWERS DESC
	...
	public function list_audience_reg($params = array()) {	
	...
	public function list_audience_witel($params = array()) {	
	...
	public function list_audience_datel($params = array()) {	
	...
	public function list_audience_sto($params = array()) {	
