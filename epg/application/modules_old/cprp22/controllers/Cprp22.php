...
//				$menu['items'][$itemId]['icon']  
  ...
  public function del_jobs(){
	  ...
	  $_POST = json_decode(file_get_contents("php://input"), true);
		...
		$command = 'php /var/www/jobs/delete_profile_res.php '.$list.' > /var/www/jobs/delete_log_profile_res_'.$list.'.log 2>&1 & ';  
	...
	public function create_profiling(){
		...
		if ( $list !== false ) {
				...
				$command = 'php /var/www/jobs/profile_jobs_res_p22_temp.php '.$list.' > /var/www/jobs/log_profile_n_'.$list.'res_2022.log 2>&1 & ';  
