      ...
      <div class="container-fluid">
        ...
        <div class="row">
          ...
          <div class="col-md-7 text-right">
			...
			<button data-toggle="modal" href="#addNewWidget" class="button_white"><em class="fa fa-th-large"></em><strong> Edit Widget</strong></button>
		...
		<div class="col-lg-12">	
          ...
          <div class="col-md-3">
            <div class="urate-stats">
              ...
              <div class="content">
                <span class="titles">Number of Spot</span><br>
                 <span class="values"><?php echo number_format(intval($costspot2[0]["SPOT"]),0,',','.'); ?></span>
              </div>
            </div>
          </div>
          ...
          <div class="col-md-3">
            <div class="urate-stats">
              <div class="icon" style="max-width:52px">
                <img src="<?php echo $path9;?>images/Frame 123D.png" alt="urate-stat">
              </div>
              <div class="content">
                <span class="titles">Cost (IDR Millions)</span><br>
                <span class="values"><?php echo number_format((intval($costspot2[0]["COST"])/1000000),2,',','.'); ?></span>
              </div>
            </div>
          </div>
          ...
          <div class="col-md-3">
            <div class="urate-stats">
              <div class="icon" style="max-width:52px">
				<img src="<?php echo $path9;?>images/Frame 123D2.png" alt="urate-stat">
              </div>
              <div class="content">
				...
				echo number_format($grp[0]['grp'],0,',','.'); }
				?></span>
              </div>
            </div>
          </div>
          ...
          <div class="col-md-3">
            <div class="urate-stats">
              <div class="icon" style="max-width:52px">
                <img src="<?php echo $path9;?>images/Frame 125D3.png" alt="urate-stat">
              </div>
              <div class="content">
                <span class="titles">CPV</span><br>
                <span class="values">
				<?php 
				if ($costspot2[0]["VIEWERS"]==0) {
					echo 0;
					...
					<div id="table_program1">
						<table aria-describedby="table" id="example2" class="table table-striped example" style="color:black">
							<thead style="color:red">
								<tr>
									<th scope="row">NAMA BRAND <img class="cArrowDown" src="<?php echo $pathx;?>assets/images/icon_arrowdown.png" alt="arrow"></th>
        ...
        <div class="grid-stack-item" data-gs-min-width="6" data-gs-min-height="2" data-gs-x="0" data-gs-y="4" data-gs-width="6" data-gs-height="2"
            data-gs-auto-position="1">
              <div class="grid-stack-item-content">
              <div data-widget="widget-3" class="widget">
...
function viewall(){
		...
		var url = '<?php echo base_url(); ?>tvpostbuyu3mh';
		var tahun = $('#tahun').val();
		var bulan = $('#bulan').val();
...
function table1_view(){
  ...
  $("#example2_wrapper").append('<div class="datatable-loading" style="position: absolute; background-color: rgb(255, 255, 255); opacity: 0.75; text-align: center; z-index: 10; left: 0px; top: 0px; width: 100%; height: 520px;"><span class="datatable-loading-inner" style="font-weight: bold; position: relative; top: 45%;"><img id="loading" src="<?php echo base_url();?>assets/urate-frontend-master/assets/images/icon_loader.gif"></span></div>');
	...
	$.ajax({
		url: "<?php echo base_url().'tvpostbuyu3mh/cost_by_program2'; ?>", 
		dataType: 'json',   
		cache: false,
		contentType: false,
		processData: false,
		...
		success: function(data){
			...
			$('#table_program1').html("");
			$('#table_program1').html('<table aria-describedby="table" id="example2" class="table table-striped example" style="color:black"><thead style="color:red"><tr><th>'+field+' <img class="cArrowDown" src="<?php echo $pathx;?>assets/images/icon_arrowdown.png"></th><th>'+nhy+' <img class="cArrowDown" src="<?php echo $pathx;?>assets/images/icon_arrowdown.png"></th></tr></thead></table>');
...
function table2_view(){
  ...
  $("#example3_wrapper").append('<div class="datatable-loading" style="position: absolute; background-color: rgb(255, 255, 255); opacity: 0.75; text-align: center; z-index: 10; left: 0px; top: 0px; width: 100%; height: 520px;"><span class="datatable-loading-inner" style="font-weight: bold; position: relative; top: 45%;"><img id="loading" src="<?php echo base_url();?>assets/urate-frontend-master/assets/images/icon_loader.gif"></span></div>');
	...
	$.ajax({
		url: "<?php echo base_url().'tvpostbuyu3mh/cost_by_program2nn'; ?>", 
		dataType: 'json',   
		cache: false,
		contentType: false,
		processData: false,
		...
		success: function(data){
			...
			$('#table_program').html("");
			$('#table_program').html('<table aria-describedby="table" id="example3" class="table table-striped example" style="color:black"><thead style="color:red"><tr><th>'+field+' <img class="cArrowDown" src="<?php echo $pathx;?>assets/images/icon_arrowdown.png"></th><th>Channel <img class="cArrowDown" src="<?php echo $pathx;?>assets/images/icon_arrowdown.png"></th><th>'+nhy+' <img class="cArrowDown" src="<?php echo $pathx;?>assets/images/icon_arrowdown.png"></th></tr></thead></table>');
			obj = jQuery.parseJSON(data);
...
function view_daypart(){
  ...
  $("#container5").append('<div class="highcharts-loading" style="position: absolute; background-color: rgb(255, 255, 255); opacity: 0.75; text-align: center; z-index: 10; left: 0px; top: 60px; width: 100%; height: 400px;"><span class="highcharts-loading-inner" style="font-weight: bold; position: relative; top: 45%;"><img id="loading" src="<?php echo base_url();?>assets/urate-frontend-master/assets/images/icon_loader.gif"></span></div>');
	...
	$.ajax({
		url: "<?php echo base_url().'tvpostbuyu3mh/daypart_view'; ?>", 
		dataType: 'text',   
		cache: false,
		contentType: false,
		processData: false,
...
function day_view(){
  ...
  $("#container6").append('<div class="highcharts-loading" style="position: absolute; background-color: rgb(255, 255, 255); opacity: 0.75; text-align: center; z-index: 10; left: 0px; top: 60px; width: 100%; height: 400px;"><span class="highcharts-loading-inner" style="font-weight: bold; position: relative; top: 45%;"><img id="loading" src="<?php echo base_url();?>assets/urate-frontend-master/assets/images/icon_loader.gif"></span></div>');
	...
	$.ajax({
		url: "<?php echo base_url().'tvpostbuyu3mh/day_view'; ?>", 
		dataType: 'text',  
		cache: false,
		contentType: false,
		processData: false,
...
function ads_type_view(){
	...
	$.ajax({
		url: "<?php echo base_url().'tvpostbuyu3mh/ads_view'; ?>", 
		dataType: 'text',   
		cache: false,
		contentType: false,
		processData: false,
...
function pie2_view(){
	...
	$.ajax({
		url: "<?php echo base_url().'tvpostbuyu3mh/prime_view'; ?>", 
		dataType: 'text',  
		cache: false,
		contentType: false,
		processData: false,
...
function pie1_view(){
	...
	$.ajax({
		url: "<?php echo base_url().'tvpostbuyu3mh/pie1_view'; ?>", 
		dataType: 'json',   
		cache: false,
		contentType: false,
		processData: false,
...
function cont1_view(){
  ...
  $("#container").append('<div class="highcharts-loading" style="position: absolute; background-color: rgb(255, 255, 255); opacity: 0.75; text-align: center; z-index: 10; left: 0px; top: 60px; width: 100%; height: 400px;"><span class="highcharts-loading-inner" style="font-weight: bold; position: relative; top: 45%;"><img id="loading" src="<?php echo base_url();?>assets/urate-frontend-master/assets/images/icon_loader.gif"></span></div>');
	...
	$.ajax({
		url: "<?php echo base_url().'tvpostbuyu3mh/cost_by_channel'; ?>", 
		dataType: 'text',   
		cache: false,
		contentType: false,
		processData: false,
