    	...
    	$(function () {                   
          ...
          $('#from, #to').timepicker({
              ...
              ,change: function(time){
                  ...
                  $.ajax({
                      type	: "POST",
                      url		: "<?php echo base_url().'timesegmentsea/checkdaypart/'; ?>"+"?f="+$('#from').val()+"&t="+$('#to').val(),
                       dataType: 'json',
          ...
          $('#custom_profile').click(function() {   
              ...
              $.ajax({
                  type	: "POST",
                  url		: "<?php echo base_url().'timesegmentsea/setprofile/'; ?>"+"?f="+$('#start_date').val(),
                   dataType: 'json',
                  contentType: 'application/json; charset=utf-8',
                  success	: function(response) {
  ...
  <script language="javascript">
	  ...
	  function excel(){
          ...
          var form_data = {
              ...
              cgroup     : colgroup
		       ...
		       $.ajax({
              url : "<?php echo base_url().'timesegmentsea/export_chart'?>",
              method : "POST",
              data : form_data,
              success: function(response) {
	   ...
	   function search_chart(group=""){
          ...
          var form_data = {
              ...
              cgroup     : colgroup
			    ...
			    $.ajax({
				  url : "<?php echo base_url().'timesegmentsea/list_charttvcc'?>",
				  method : "POST",
				  data : form_data,
				  success: function(response) {
 			  ...
 			  $.ajax({
				  url : "<?php echo base_url().'timesegmentsea/list_charttvcc2'?>",
				  method : "POST",
				  data : form_data,
				  success: function(response) {
    ...
    function search_genre(){
        ...
        $.ajax({
            type	: "POST",
            url		: "<?php echo base_url().'timesegmentsea/genresearch/';?>"+ "?sess_user_id=" + user_id + "&sess_token=" + token +"&q=" + query,
             dataType: 'json',
            contentType: 'application/json; charset=utf-8',
            success	: function(response) {
	...
	function search_program(){
		...
		if(res.length > 1 || res == '0' ){
			...
			$.ajax({ 
				type	: "POST",
				url		: "<?php echo base_url().'timesegmentsea/programsearch/';?>"+ "?sess_user_id=" + user_id + "&sess_token=" + token +"&q=" + channel + "&d=" + start_date + "&de=" + end_date,
 				dataType: 'json',
				contentType: 'application/json; charset=utf-8',
				success	: function(response) {
 					$("#program").next().next().next().empty('');
    ...
    function search_channel(){
        ...
        $.ajax({
            type	: "POST",
            url		: "<?php echo base_url().'timesegmentsea/channelsearch/';?>"+ "?sess_user_id=" + user_id + "&sess_token=" + token +"&q=" + query +"&g=" + genre,
             dataType: 'json',
            contentType: 'application/json; charset=utf-8',
            success	: function(response) {
    ...
    function search_profile(){
        ...
        $.ajax({
            type	: "POST",
            url		: "<?php echo base_url().'timesegmentsea/profilesearch/'; ?>"+"?q="+query+"&f="+period,
             dataType: 'json',
            contentType: 'application/json; charset=utf-8',
            success	: function(response) {
                 $("#profile").next().next().next().empty('');
