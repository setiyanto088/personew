      ...
      <div class="container-fluid">
        ...
        <div class="row">
          <div class="col-md-5">                                   
            ...
            <h3 class="page-title">TV Program TVV Dashboard</h3>
          </div>
...
<script async >
		...
		function delete_channel(){
			...
			var token = $.cookie(window.cookie_prefix + "token");
 			  ...
 			  $.ajax({
				  url : "<?php echo base_url().'tvprogramun3tvvview/delete_channels'?>",
				  method : "POST",
				  data : form_data,
				  success: function(response) {
					  ...
					  for(var i = 0;i < response.length; i++){
							...
							html += '		<td>'+response[i].CHANNEL_LIST+'</td>';
 							html += '		<td><button type="button" class="btn urate-btn" onClick="edit_channel(\''+response[i].CHANNEL_LIST+'\' , \''+response[i].CHANNEL_NAME+'\')">Edit</button><button type="button" class="btn urate-btn" onClick="delete_conf(\''+response[i].CHANNEL_NAME+'\')">Delete</button></td>';
							html += '	</tr>';
 						  no++;
		...
		function save_channel_list(){
			...
			var token = $.cookie(window.cookie_prefix + "token");
 			  ...
 			  $.ajax({
				  url : "<?php echo base_url().'tvprogramun3tvvview/save_channels'?>",
				  method : "POST",
				  data : form_data,
				  success: function(response) {
	...
	function load_modal_load_channel(){
			 ...
			 var form_data = {
 			  ...
 			  $.ajax({
				  url : "<?php echo base_url().'tvprogramun3tvvview/load_channels'?>",
				  method : "POST",
				  data : form_data,
				  success: function(response) {
   ...
   function search_channel(){
        ...
        $.ajax({
            type	: "POST",
            url		: "<?php echo base_url().'tvprogramun3tvvview/channelsearch/';?>"+ "?sess_user_id=" + user_id + "&sess_token=" + token +"&q=" + query +"&g=" + genre,
             dataType: 'json',
...
function selectAll(){
	...
	$.ajax({
		url: "<?php echo base_url().'tvprogramun3tvvview/header_change'; ?>", 
...
function program_change(){
	...
	$('#example3').DataTable({
        ...
        "serverSide": true,
        "destroy": true,
		"ajax": "<?php echo base_url().'tvprogramun3tvvview/get_filter_programaud'?>" + "/?sess_user_id=" + user_id + "&sess_token=" + token + "&periode=<?php echo $tahunselected ?>&pilihprog="+type+ "&tgl2="+tgl+"&week2="+week+"&check="+check+"&tipe_filter_prog="+tipe_filter_prog,
		"searching": true,
		"language": {
            "decimal": ",",
            "thousands": "."
...
function channel_change(){
  ...
  $("#example4_wrapper").append('<div class="datatable-loading" style="position: absolute; background-color: rgb(255, 255, 255); opacity: 0.75; text-align: center; z-index: 10; left: 0px; top: 0px; width: 100%; height: 520px;"><span class="datatable-loading-inner" style="font-weight: bold; position: relative; top: 45%;"><img alt="image" id="loading" src="<?php echo base_url();?>assets/urate-frontend-master/assets/images/icon_loader.gif"></span></div>');
	...
	$.ajax({
		url: "<?php echo base_url().'tvprogramun3tvvview/audiencebar_by_channel'; ?>", 
		dataType: 'text',  
		cache: false,
		contentType: false,
		processData: false,
...
$( document ).ready(function() {
	...
	Highcharts.chart('container6', {
        ...
        series: [{
            name: 'All',
            data: [<?php echo join($json_spot_date_all, ',') ?>],
			color: "red"
        },{
            name: 'Live',
            ...
            name: 'TVOD',
            data: [<?php echo join($json_spot_date_tvod, ',') ?>],
			color: "blue"
        }]
    });
...
var search_val = $( "input[aria-controls='example3']" ).val();
  ...
  var user_id = $.cookie(window.cookie_prefix + "user_id");
	...
	var table3 = $('#example3').DataTable({
        ...
        "serverSide": true,
        "destroy": true,
		"ajax": "<?php echo base_url().'tvprogramun3tvvview/get_filter_programaud'?>" + "/?sess_user_id=" + user_id + "&sess_token=" + token + "&periode=<?php echo $tahunselected ?>&pilihprog="+fieldas+ "&tgl2="+tgl2+"&week2="+week2+"&searchtxt="+search_val+"&check=True",
		"searching": true,
		"language": {
            "decimal": ",",
            "thousands": "."
	...
	$('#channel_export').on('click', function() {
	  ...
	  $("#channel_export").attr("disabled", true);
		...
		$.ajax({
			url: "<?php echo base_url().'tvprogramun3tvvview/audiencebar_by_channel_export'; ?>", 
			dataType: 'text',  
			cache: false,
			contentType: false,
			processData: false,
	...
	$('#program_export').on('click', function() {
		...
		$.ajax({
			url: "<?php echo base_url().'tvprogramun3tvvview/audiencebar_by_program_export'; ?>", 
			dataType: 'text',   
			cache: false,
			contentType: false,
			processData: false,
...
function day_view_f(){
		...
		$.ajax({
			url: "<?php echo base_url().'tvprogramun3tvvview/filter_days'; ?>", 
			dataType: 'text',  
			cache: false,
			contentType: false,
			processData: false,
...
function table1_view(){
	...
	$.ajax({
		url: "<?php echo base_url().'tvprogramun3tvvview/cost_by_program'; ?>", 
		dataType: 'json',  
		cache: false,
		contentType: false,
		processData: false,
...
function table2_view(){
	...
	$('#example3').DataTable({
        ...
        "serverSide": true,
        "destroy": true,
		"ajax": "<?php echo base_url().'tvprogramun3tvvview/get_filter_programaud'?>" + "/?sess_user_id=" + user_id + "&sess_token=" + token + "&periode=<?php echo $tahunselected ?>&pilihprog="+type+ "&tgl2="+tgl+"&week2="+week+"&check="+check+"&profile="+profile_prog+"&tipe_filter_prog="+tipe_filter_prog,
		"searching": true,
		"language": {
            "decimal": ",",
            "thousands": "."
...
function view_daypart(){
	...
	$.ajax({
		url: "<?php echo base_url().'tvprogramun3tvvview/daypart_view'; ?>", 
		dataType: 'text',  
		cache: false,
		contentType: false,
		processData: false,
...
function day_view(){
	...
	$.ajax({
		url: "<?php echo base_url().'tvprogramun3tvvview/day_view'; ?>", 
		dataType: 'text',  
		cache: false,
		contentType: false,
		processData: false,
...
function ads_type_view(){
	...
	$.ajax({
		url: "<?php echo base_url().'tvprogramun3tvvview/ads_view'; ?>", 
		dataType: 'text',  
		cache: false,
		contentType: false,
		processData: false,
