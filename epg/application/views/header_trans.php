...
.dropdown-animated {
  ...
  <script>
    ...
    function editUserSelf(id){
        ...
        $('#panel-modal  .panel-title').html('<i class="fa fa-user"></i> ');
       	...
       	<nav class="navbar navbar-fixed-top navbar-urate">
          	<div class="container-fluid">
              	<a class="navbar-brand" href="#">
                   <!-- <img src="<?php echo base_url();?>img/inrate_mr_putih_res.png" alt="logo RMRate" width="1200px" height="160px"> -->
				   <h1 style='color:#fff'><b>Dashboard OTT Transvision</b></h1>
              	</a>
              	<ul class="nav navbar-nav navbar-right">
					<li class="dropdown" >
                      ...
                      <a href="javascript:void(0);" data-toggle="dropdown" role="button" style="background-color: transparent !important;" onclick="totalerased()">
                           <h3 style="color: white; margin-top: 10px"> <i class="glyphicon glyphicon-bell"></i> <span style="font-size: 10px" id="totalprofile"></span></h3>
                        </a>
                                ...
                                <ul class="menu">
                                    ...
                                    <li> 
                                            ...
                                            <div class="menu-info">
                                                ...
                                                <p>
												      <i class="fa fa-clock-o"></i> <?php echo $this->session->userdata['day_activation'];?> days more
                                                </p>
                                            </div>
