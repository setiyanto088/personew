       	...
       	<nav class="navbar navbar-fixed-top navbar-urate">
          	<div class="container-fluid">
              	<a class="navbar-brand" href="#">
                    <img src="<?php echo base_url();?>img/Frame11.png" alt="logo RMRate" width="1200px" height="160px">
              	</a>
				<ul class="nav navbar-nav navbar-left">
					<li class="active-user" style="font-size:14px;">
						<div class="menu-filter" style="background-color:#F2F2F2;padding:5px;color:#000;border: none;border-radius:5px">
						
							<?php if($ptv <> ''){ ?>	
								<a href="<?php echo base_url();?>tvprogramun3"><button style="border: none;background-color:#F2F2F2;border-radius:5px;padding:3px 18px 3px 18px;color:#000;"><strong>InRate</strong></button></a>
							<?php }else{ ?>	
								<a href="javascript:function() { return false; }"><button style="border: none;background-color:#F2F2F2;border-radius:5px;padding:3px 18px 3px 18px;color:#000;"><strong>InRate</strong></button></a>
							<?php } ?>	
							
							<?php if($urban <> ''){ ?>	
								<a href="<?php echo base_url();?>tvprogramunres"><button style="border: none;border-radius:5px;padding:3px 18px 3px 18px;background-color:#fff;color:#000;" ><strong>UrbanRate</strong></button></a>
							<?php }else{ ?>
								<a href="javascript:function() { return false; }"><button style="border: none;border-radius:5px;padding:3px 18px 3px 18px;background-color:#fff;color:#000;" ><strong>UrbanRate</strong></button></a>
							<?php } ?>	
						</div>
                	</li>
				...
				<?php if($useetv <> ''){ ?>	
					...
					<li class="active-user" style="font-size:14px;" id="link_useetv">
						<div class="menu-filter" style="background-color:#fff;padding:5px;color:#000;border: 1px solid rgba(0, 0, 0, 0.1);border-radius:5px;margin-left:-20px">
							<a href="<?php echo base_url();?>dashboarduseetv"><span class="" ><img src="<?php echo base_url();?>img/Frame152b.png" alt="" style="height:32px;"></span></a>
						</div>
                	</li>
              	...
              	<ul class="nav navbar-nav navbar-right">
					...
					<li class="dropdown" >
                      ...
                      <a href="javascript:void(0);" data-toggle="dropdown" role="button" style="background-color: transparent !important;" onclick="totalerased()">
                           <h3 style="color: #000; margin-top: 10px"> <em class="glyphicon glyphicon-bell"></em> <span style="font-size: 10px" id="totalprofile"></span></h3>
                        </a>
				...
				<li class="dropdown" >
                      ...
                      <a href="javascript:void(0);" data-toggle="dropdown" role="button" style="background-color: transparent !important;">
                           <span class="ava" ><img style="width:30px; height:30px; margin-top: 10px; margin-left: 10px;margin-right: -20px;" src="<?php echo $path;?>assets/images/Frame 151.png" alt="urate-ava"></span>
                        </a>
                      <ul class="dropdown-menu" >
                	...
                	<li class="active-user">
                    	<span>
							<span id="namanya" style="color:#000"> <?php  
							
							if($this->session->userdata['username'] == '830162'){
							...
							<span style="color:#000; font-weight:100; font-size:12px; margin-top: 0px ">(<?php echo $this->session->userdata('role_name');?>)</span>
