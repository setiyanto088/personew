  ...
  <script>
	...
	function regional_nas(){
		...
		// //alert(tahun);
		 ...
		 // // header("Location: <?php echo base_url(); ?>dashboarduseetv'");
		 window.location.replace("<?php echo base_url(); ?>dashboarduseetv");
		// // Redirect('<?php echo base_url(); ?>dashboarduseetv', false);
						...
						<div class="row" style="margin:auto">
						  <div class="col-md-12" >
							...
							<div class="col-md-12" style="   display: flex;justify-content: space-around;margin-top:20px">		
									...
									<a id="filter2_reg"  onClick="regional_full()" class="menu_link" style="font-size: 11px;" >REGIONAL</a>
									<a id="filter2_reg1"  onClick="regional('01')" class="menu_link" style="font-size: 11px;" >REG 1</a>
									<a id="filter2_reg2"  onClick="regional('02')" class="menu_link" style="font-size: 11px;" >REG 2</a>
									<a id="filter2_reg3"  onClick="regional('03')" class="menu_link" style="font-size: 11px;" >REG 3</a>
									<a id="filter2_reg4"  onClick="regional('04')" class="menu_link" style="font-size: 11px;" >REG 4</a>
									<a id="filter2_reg5"  onClick="regional('05')" class="menu_link" style="font-size: 11px;" >REG 5</a>
									<a id="filter2_reg6"  onClick="regional('06')" class="menu_link" style="font-size: 11px;" >REG 6</a>
									<a id="filter2_reg7"  onClick="regional('07')" class="menu_link" style="font-size: 11px;" >REG 7</a>	
									</div>
							</div>
						</div>
					</div>
