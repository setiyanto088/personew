...
<head>
 ...
 <link rel="icon" href="https://inrate.id/wp-content/themes/jupiter/assets/images/favicon.png?ver=2.1.0" type="image/x-icon">
  ...
  <link rel="icon" type="image/png" href="<?php echo $paths; ?>assets/img/Group2.png"/>
  <!-- Google Fonts -->
...
.dropdown-animated {
  ...
  <script type="text/javascript" src="<?php echo $path;?>assets/js/multiselect-dropdown.js"></script>
  ...
  <script>
    ...
    if(currMenu != undefined || currMenu != "undefined" || currMenu != ""){
				...
				<ul class="nav navbar-nav navbar-left">
					<li class="active-user" style="font-size:14px;">
						<div class="menu-filter" style="background-color:#F2F2F2;padding:5px;color:#000;border: none;border-radius:5px">
							<button style="border: none;background-color:#fff;border-radius:5px;padding:3px 18px 3px 18px"><strong>InRate</strong></button>
							<?php if($urban <> ''){ ?>	
								<a href="<?php echo base_url();?>tvprogramunres"><button style="border: none;border-radius:5px;padding:3px 18px 3px 18px;background-color:#F2F2F2;color:#000;" ><strong>UrbanRate</strong></button></a>
							<?php }else{ ?>
								<a href="javascript:function() { return false; }"><button style="border: none;border-radius:5px;padding:3px 18px 3px 18px;background-color:#F2F2F2;color:#000;" ><strong>UrbanRate</strong></button></a>
							<?php } ?>	
						</div>
                	</li>
