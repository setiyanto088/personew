...
<body>
  <!-- Header -->
	<header>
       	<nav class="navbar navbar-fixed-top navbar-urate" style=" background-image: url(<?php echo base_url();?>img/BANNER.jpg);  background-repeat: no-repeat;background-position: left; ">
