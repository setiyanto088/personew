          ...
          <div class="row">
              <div class="col-md-6">                    
                  <ol class="breadcrumb">
                      ...
                      <li class="breadcrumb-item active">Advance Media Planning</li>
                  </ol>
                  <h3 class="page-title-inner">Advance Media Planning</h3>
              </div>       
          </div>
                  ...
                  <div class="row">
                      ...
                      <div class="dataset col-md-4" style="z-index: 999;">
                          ...
                          <div class="input-group input-daterange">
                              <input type="text" class="form-control urate-form-input" name="start_date" id="start_date" value="" placeholder="From ..." autocomplete="off" />
                              <div class="input-group-addon">-</div>
                              <input type="text" class="form-control urate-form-input" name="end_date" id="end_date" value="" placeholder="To ..." autocomplete="off" />
                          </div>
                      </div>  
                      <!-- END PERIODE FIELD -->
                      <!-- PROFILE FIELD -->       
                      ...
                      <!-- END OBJECTIVE FIELD -->     
                      <!-- COST FIELD -->
                      <div class="dataset col-md-4" style="position: absolute;top: 255px;width: 252px;left: 375px;">
                          <div class="dataset-title">
					   ...
					   <div class="dataset col-md-4" style="position: absolute;top: 255px;width: 152px;left: 625px;">
                          <div class="dataset-title">
                      ...
                      <!-- END COST FIELD -->
					   ...
					   <div class="dataset col-md-4" style="position: absolute;top: 255px;width: 352px;left: 805px;">
                          <div class="dataset-title">
                              <h4 class="title-text">Placement Ads Period</h4>
                          </div>
                          <div class="input-group input-daterange">
                              <input type="text" class="form-control urate-form-input" name="start_date_ads" id="start_date_ads" value="" placeholder="From ..." autocomplete="off" />
                              <div class="input-group-addon">-</div>
                              <input type="text" class="form-control urate-form-input" name="end_date_ads" id="end_date_ads" value="" placeholder="To ..." autocomplete="off" />
                          </div>
                      </div>  
                      ...
                      <div class="col-md-12 text-center" style="top: 365px;position: absolute;width: 96%;">
                          ...
                          <div class="btn-loader">
                              ...
                              <img src="<?php echo $path; ?>assets/images/icon_loader.gif" id="loader" alt="Load">
                          </div>
                      </div>
                      <!-- END PROCESS BUTTON -->
                  </div>
              ...
              <div class="panel-body">
                  ...
                  <ul class="nav nav-tabs" role="tablist">
                      <li role="presentation" class="active">
                          <a href="#table" aria-controls="table" role="tab" data-toggle="tab">Mediaplan</a>
                      </li>
                      <li role="presentation">
                          <a href="#chart" aria-controls="summary" role="tab" data-toggle="tab">Summary Mediaplan</a>
                      </li> 
					  <li role="presentation">
                         <a href="#creative" aria-controls="creative" role="tab" data-toggle="tab" onclick="cal()">Placement Ads</a> 
						 <!-- <a href="#creative" aria-controls="creative" role="tab" data-toggle="tab" >Placement Ads</a>-->
                      </li>
					   <li role="presentation">
                          <a href="#summ_creative" aria-controls="summ_creative" role="tab" data-toggle="tab" >Summary Placement Ads</a>
                      </li> 
					  <li role="presentation">
                          <a href="#summ_compare" aria-controls="summ_compare" role="tab" data-toggle="tab" >Summary</a>
                      </li>
                  </ul>
                  <!-- / Nav tabs -->
                  <div class="tab-content">
                      ...
                      <div role="tabpanel" class="tab-pane fade in active" id="table">
                            <div class="result-table" id='result-table'>
                                <table id="myTable" class="table table-striped table-bordered example urate-table" aria-describedby="Tabel Result"> 
  							                    <thead>
                                    <tr>
                        ...
                        <div role="tabpanel" class="tab-pane fade" id="chart">
                            <div class="result-summary">
                                ...
                                <div class="summary-table">
                                    <div class="row">
                                        <div class="col-md-6" id="summ_prog1">
                                            <h4>Summary Program</h4>
                                            <table id="example1" class="table table-striped table-bordered example" aria-describedby="Tabel Result Summary 1">
                                                <thead>
                                                      <tr>
                                        ...
                                        <div class="col-md-6" id="summ_prog2">
                                            <h4>Summary Channel</h4>
                                            <table id="example2" class="table table-striped table-bordered example" aria-describedby="Tabel Result Summary 2">
                                                <thead>
                                                    <tr>
                                                        <th scope="row">Channel</th>
														<th scope="row">Ads Type</th>
						  ...
						  <div role="tabpanel" class="tab-pane fade" id="summ_compare" >
                            <div class="result-summary">
                                ...
                                <div class="summary-panel">
                                    ...
                                    <div id="texted_ads2"><h3>Summary</h3></div> 
									
									<div class="col-md-12"> 
									<a class='dt-button' href='#' onclick='print_summary()' style="top:0px !important;"> <span style="font-size:12px !important" >Export Excel</span></a>
									</div>
									<br><br>
									
                                    <div class="row">
									
										<table id="myTable_result" class="table table-striped table-bordered example urate-table" aria-describedby="Tabel Result Summary All"> <!-- id="example" -->
											<thead>
											<tr>
												<th align="center" scope="row"><strong>Deskripsi</strong></th>
												<th align="center" scope="row"><strong>Mediaplan</strong></th>
												<th align="center" scope="row"><strong>Placement Ads</strong></th>
												<th align="center" scope="row"><strong>Selisih</strong></th>
												<th align="center" scope="row"><strong>Akurasi (%)</strong></th>
											</tr>
											<tr id="spoted_summ" >
					  ...
					  <div role="tabpanel" class="tab-pane fade" id="summ_creative">
                            <div class="result-summary">
                                <div class="summary-panel">
                                ...
                                <div class="summary-table">
                                    <div class="row">
                                        <div class="col-md-6" id="summ_prog1ads">
                                            <h4>Summary Program</h4>
                                            <table id="example1_ads" class="table table-striped table-bordered example" aria-describedby="Tabel Result Ads 1">
                                                <thead>
                                                      <tr>
                                                          <th scope="row">Channel</th>
                                                          <th scope="row">Program</th>
                                        ...
                                        <div class="col-md-6" id="summ_prog2ads">
                                            <h4>Summary Channel</h4>
                                            <table id="example2_ads" class="table table-striped table-bordered example" aria-describedby="Tabel Result Ads 2">
                                                <thead>
                                                    <tr>
                                                        <th scope="row">Channel</th>
														<th scope="row">Ads Type</th>
					  ...
					  <div role="tabpanel" class="tab-pane fade" id="creative">
							<a class='dt-button' href='#' onclick='print_cal()'> <span>Export Excel</span></a>
						<br><br><br>
  ...
  <script language="javascript">
      $(document).ready(function(){     
          ...
          $('#custom_profile').click(function() {   
              ...
              $.ajax({
                  type	: "POST",
                  url		: "<?php echo base_url().'advancemediaplanningu/setprofile/'; ?>"+"?f="+$('#start_date').val(),
                  dataType: 'json',
		...
		function print_summary(){
			...
			$.ajax({
				url: "<?php echo base_url().'advancemediaplanningu/print_summary'; ?>", 
...
var start_date_ads = $('#start_date_ads').val();
		...
		form_data.append('cr_data', cr_data);
			...
			$.ajax({
				url: "<?php echo base_url().'advancemediaplanningu/print_calender'; ?>", 
				dataType: 'text',  // what to expect back from the PHP script, if anything
				cache: false,
				contentType: false,
				processData: false,
...
var start_date_ads = $('#start_date_ads').val();
		...
		form_data.append('cr_data', cr_data);
			...
			$.ajax({
      			url : "<?php echo base_url().'advancemediaplanningu/list_calander2'?>",
				dataType: 'text',  // what to expect back from the PHP script, if anything
				cache: false,
				contentType: false,
				processData: false,
	...
	function export_mp(){
      ...
      function search(){                 
		...
		$.ajax({
			url: "<?php echo base_url().'advancemediaplanningu/list_planning'; ?>", 
			dataType: 'text',  // what to expect back from the PHP script, if anything
			cache: false,
			contentType: false,
			processData: false,
			...
			success: function(data){
				...
				$('#summ_prog1').html("");
				$('#summ_prog1').html('<h4>Summary Program</h4> <table id="example1" class="table table-striped table-bordered example"><thead><tr><th>Channel</th> <th>Program</th><th>Ads Type</th> <th>Spot</th><th>Cost</th><th>TVR</th></tr></thead></table>');
				...
				$('#summ_prog2').html("");
				$('#summ_prog2').html('<h4>Summary Channel</h4> <table id="example2" class="table table-striped table-bordered example"><thead><tr><th>Channel</th><th>Ads Type</th> <th>Spot</th><th>Cost</th><th>TVR</th></tr></thead></table>');
				...
				$('#summ_prog1ads').html("");
				$('#summ_prog1ads').html('<h4>Summary Program</h4> <table id="example1_ads" class="table table-striped table-bordered example"><thead><tr><th>Channel</th> <th>Program</th><th>Ads Type</th> <th>Spot</th><th>Cost</th><th>TVR</th></tr></thead></table>');
				...
				$('#summ_prog2ads').html("");
				$('#summ_prog2ads').html('<h4>Summary Channel</h4> <table id="example2_ads" class="table table-striped table-bordered example"><thead><tr><th>Channel</th><th>Ads Type</th> <th>Spot</th><th>Cost</th><th>TVR</th></tr></thead></table>');
                  ...
                  filename: 'UNICS - Media Planning'
						...
						columns: [
							...
							{ data: 'TVR'}
      						...
      						$("#tvred").html("<div class='grandItemTit'>Total TVR</div><div class='grandItemCon'>" + obj.tvr + "</div>");
							
							$("#maxtvr").html("<div class='grandItemTit'>Max TVR</div><div class='grandItemCon'>" + obj.maxtvr + "</div>");
      						$("#mintvr").html("<div class='grandItemTit'>Min TVR</div><div class='grandItemCon'>" + obj.mintvr + "</div>");
      						$("#avgtvr").html("<div class='grandItemTit'>Avg TVR</div><div class='grandItemCon'>" + obj.avgtvr + "</div>");
      						$("#cprp1").html("<div class='grandItemTit'>CPRP</div><div class='grandItemCon'>" + obj.cprp1 + "</div>");
							
							
							$("#texted_ads").html("<h3>Grand Total</h3>");
      						...
      						$("#tvred_ads").html("<div class='grandItemTit'>Total TVR</div><div class='grandItemCon'>" + obj.tvr9 + "</div>");
							
							$("#maxtvr_ads").html("<div class='grandItemTit'>Max TVR</div><div class='grandItemCon'>" + obj.maxtvr9 + "</div>");
      						$("#mintvr_ads").html("<div class='grandItemTit'>Min TVR</div><div class='grandItemCon'>" + obj.mintvr9 + "</div>");
      						$("#avgtvr_ads").html("<div class='grandItemTit'>Avg TVR</div><div class='grandItemCon'>" + obj.avgtvr9 + "</div>");
      						$("#cprp1_ads").html("<div class='grandItemTit'>CPRP</div><div class='grandItemCon'>" + obj.cprp19 + "</div>");
			...
			$('#totvr_summ').html('<td align="center">Total TVR</td><td align="right">'+obj.tvr+'</td><td align="right">'+obj.tvr9+'</td><td align="right">'+sel_tottvr.replace(".", ",")+'</td><td align="right">'+aku_tottvr.replace(".", ",")+'</td>'); 
			
			$('#maxtvr_summ').html('<td align="center">Maximum TVR</td><td align="right">'+obj.maxtvr+'</td><td align="right">'+obj.maxtvr9+'</td><td align="right">'+sel_maxtvr.replace(".", ",")+'</td><td align="right">'+aku_maxtvr.replace(".", ",")+'</td>'); 
			
			$('#mintvr_summ').html('<td align="center">Minimum TVR</td><td align="right">'+obj.mintvr+'</td><td align="right">'+obj.mintvr9+'</td><td align="right">'+sel_mintvr.replace(".", ",")+'</td><td align="right">'+aku_mintvr.replace(".", ",")+'</td>'); 
			
			$('#avgtvr_summ').html('<td align="center">Average TVR</td><td align="right">'+obj.avgtvr+'</td><td align="right">'+obj.avgtvr9+'</td><td align="right">'+sel_avgtvr.replace(".", ",")+'</td><td align="right">'+aku_avgtvr.replace(".", ",")+'</td>'); 
			
			$('#cprp_summ').html('<td align="center">CPRP</td><td align="right">'+obj.cprp1+'</td><td align="right">'+obj.cprp19+'</td><td align="right">'+sel_cprp+'</td><td align="right">'+aku_cprp.replace(".", ",")+'</td>'); 
         ...
         var table1 = $("#example1").DataTable({   
			 dom: 'Bfrtip',
              ...
              "language": {
          		...
          		"serverSide": true,
          		destroy: true,
          		"ajax": "<?php echo base_url().'advancemediaplanningu/list_planning_sub'?>" + "/?sess_user_id=" + user_id + "&sess_token=" + token + "&start_date=" + start_date + "&end_date=" + end_date + "&profile=" + profile + "&cost=" + cost + "&high_tvr=" + high_tvr + "&maximum_cost=" + maximum_cost+ "&discount=" + discount + "&minimum_cprp=" + minimum_cprp+"&maximum_reach=" + maximum_reach+"&index=" + index+"&channel=" + channel,
          		"searchDelay": 700,
          		"bFilter" : false,
          		"bInfo" : false,
          		"bLengthChange": false,  
          ...
          var token = $.cookie(window.cookie_prefix + "token");
         	var table2 = $("#example2").DataTable({
              ...
              "language": {
          		...
          		"serverSide": true,
          		destroy: true,
          		"ajax": "<?php echo base_url().'advancemediaplanningu/list_planning_total'?>" + "/?sess_user_id=" + user_id + "&sess_token=" + token + "&start_date=" + start_date + "&end_date=" + end_date + "&profile=" + profile + "&cost=" + cost + "&high_tvr=" + high_tvr + "&maximum_cost=" + maximum_cost+ "&discount=" + discount + "&minimum_cprp=" + minimum_cprp+"&maximum_reach=" + maximum_reach+"&index=" + index+"&channel=" + channel,
          		"searchDelay": 700,
          		"bFilter" : false,
          		"bInfo" : false,
          		"iDisplayLength": 100,
      ...
      function refreshtable(){
          ...
          var table = $("#myTable").DataTable({ //#example
						 dom: 'Bfrtip',
						  'buttons': [
							  {
								  text: 'Export Excel',
      ...
      function search_channel(){
        ...
        $.ajax({
            type	: "POST",
            url		: "<?php echo base_url().'advancemediaplanningu/channelsearch/';?>"+ "?sess_user_id=" + user_id + "&sess_token=" + token +"&q=" + query,
            dataType: 'json',
            contentType: 'application/json; charset=utf-8',
            success	: function(response) {
    ...
    function search_profile(){
        ...
        $.ajax({
            type	: "POST",
            url		: "<?php echo base_url().'advancemediaplanningu/profilesearch/'; ?>"+"?q="+query+"&f="+period,
            dataType: 'json',
            contentType: 'application/json; charset=utf-8',
            success	: function(response) {
                $("#profile").next().next().next().empty('');
