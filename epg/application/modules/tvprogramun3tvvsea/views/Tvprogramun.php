        ...
        <div class="row">
          <div class="col-md-5">                                   
            <ol class="breadcrumb">
             ...
             <h3 class="page-titles" style="font-weight:bold">Channel Daily Viewers</h3>
          </div>
 					...
 					<div id="table_program2" >
						<table aria-describedby="table" id="example4" class="table table-striped example" style="width: 100%">
							<thead style="color:red">
								<tr>
									<th rowspan = "2"  scope="row">Rank <img alt="image" class="cArrowDown" src="<?php echo $pathx;?>assets/images/icon_arrowdown.png" alt="arrow"></th>
									<th rowspan = "2"  scope="row">Channel <img alt="image" class="cArrowDown" src="<?php echo $pathx;?>assets/images/icon_arrowdown.png" alt="arrow"></th>
            ...
            data-gs-auto-position="1">
				...
				<div class="col-lg-12">	
					<div class="navbar-left" style="padding-left:10px;">
					 ...
					 <div class="navbar-right" style="padding-right:20px;padding-top:10px;">
						<button onClick="filter_panel('days')" class="button_white" id="filter_channel"><em class="fa fa-filter"></em> &nbsp Show Filter</button>
						
					</div>
				</div>
				
					<div class="col-lg-12 filter_panel" id="filter_panel_days" style="display:none;padding-left:50px;padding-right:50px">	
...
<script async >
		...
		function delete_channel(){
			...
			var token = $.cookie(window.cookie_prefix + "token");
 			  ...
 			  $.ajax({
				  url : "<?php echo base_url().'tvprogramun3tvvsea/delete_channels'?>",
				  method : "POST",
				  data : form_data,
		...
		function save_channel_list(){
			...
			var token = $.cookie(window.cookie_prefix + "token");
 			  ...
 			  $.ajax({
				  url : "<?php echo base_url().'tvprogramun3tvvsea/save_channels'?>",
				  method : "POST",
				  data : form_data,
				  success: function(response) {
	...
	function load_modal_load_channel(){
			 ...
			 var form_data = {
 			  ...
 			  $.ajax({
				  url : "<?php echo base_url().'tvprogramun3tvvsea/load_channels'?>",
				  method : "POST",
				  data : form_data,
				  success: function(response) {
   ...
   function search_channel(){
        ...
        $.ajax({
            type	: "POST",
            url		: "<?php echo base_url().'tvprogramun3tvvsea/channelsearch/';?>"+ "?sess_user_id=" + user_id + "&sess_token=" + token +"&q=" + query +"&g=" + genre,
             dataType: 'json',
...
function selectAll(){
	...
	$.ajax({
		url: "<?php echo base_url().'tvprogramun3tvvsea/header_change'; ?>", 
		dataType: 'text',   
		cache: false,
		contentType: false,
		processData: false,
...
function program_change(){
	...
	$('#example3').DataTable({
        ...
        "serverSide": true,
        "destroy": true,
		"ajax": "<?php echo base_url().'tvprogramun3tvvsea/get_filter_programaud'?>" + "/?sess_user_id=" + user_id + "&sess_token=" + token + "&periode=<?php echo $tahunselected ?>&pilihprog="+type+ "&tgl2="+tgl+"&week2="+week+"&check="+check+"&tipe_filter_prog="+tipe_filter_prog,
		"searching": true,
		"language": {
            "decimal": ",",
            "thousands": "."
...
function channel_change(){
  ...
  $("#example4_wrapper").append('<div class="datatable-loading" style="position: absolute; background-color: rgb(255, 255, 255); opacity: 0.75; text-align: center; z-index: 10; left: 0px; top: 0px; width: 100%; height: 520px;"><span class="datatable-loading-inner" style="font-weight: bold; position: relative; top: 45%;"><img alt="image" id="loading" src="<?php echo base_url();?>assets/urate-frontend-master/assets/images/icon_loader.gif"></span></div>');
	...
	$.ajax({
		url: "<?php echo base_url().'tvprogramun3tvvsea/audiencebar_by_channel'; ?>", 
		dataType: 'text',  
		cache: false,
		contentType: false,
		processData: false,
...
var search_val = $( "input[aria-controls='example3']" ).val();
  ...
  var user_id = $.cookie(window.cookie_prefix + "user_id");
	...
	var table3 = $('#example3').DataTable({
        ...
        "serverSide": true,
        "destroy": true,
		"ajax": "<?php echo base_url().'tvprogramun3tvvsea/get_filter_programaud'?>" + "/?sess_user_id=" + user_id + "&sess_token=" + token + "&periode=<?php echo $tahunselected ?>&pilihprog="+fieldas+ "&tgl2="+tgl2+"&week2="+week2+"&searchtxt="+search_val+"&check=True",
		"searching": true,
		"language": {
            "decimal": ",",
            "thousands": "."
	...
	$('#channel_export').on('click', function() {
	  ...
	  $("#channel_export").attr("disabled", true);
		...
		$.ajax({
			url: "<?php echo base_url().'tvprogramun3tvvsea/audiencebar_by_channel_export'; ?>", 
			dataType: 'text',   
			cache: false,
			contentType: false,
			processData: false,
	...
	$('#program_export').on('click', function() {
		...
		$.ajax({
			url: "<?php echo base_url().'tvprogramun3tvvsea/audiencebar_by_program_export'; ?>", 
			dataType: 'text',   
			cache: false,
			contentType: false,
			processData: false,
...
function day_view_f(){
		...
		$.ajax({
			url: "<?php echo base_url().'tvprogramun3tvvsea/filter_days'; ?>", 
			dataType: 'text',  
			cache: false,
			contentType: false,
			processData: false,
...
function viewall(){
		...
		var url = '<?php echo base_url(); ?>tvprogramun3tvvsea'; 
		var tahun = $('#tahun').val();
		var bulan = $('#bulan').val();
...
function table1_view(){
	...
	$.ajax({
		url: "<?php echo base_url().'tvprogramun3tvvsea/cost_by_program'; ?>", 
		dataType: 'json',   
		cache: false,
		contentType: false,
		processData: false,
...
function table2_view(){
	...
	$('#example3').DataTable({
        ...
        "serverSide": true,
        "destroy": true,
		"ajax": "<?php echo base_url().'tvprogramun3tvvsea/get_filter_programaud'?>" + "/?sess_user_id=" + user_id + "&sess_token=" + token + "&periode=<?php echo $tahunselected ?>&pilihprog="+type+ "&tgl2="+tgl+"&week2="+week+"&check="+check+"&profile="+profile_prog+"&tipe_filter_prog="+tipe_filter_prog,
		"searching": true,
		"language": {
            "decimal": ",",
            "thousands": "."
...
function view_daypart(){
	...
	$.ajax({
		url: "<?php echo base_url().'tvprogramun3tvvsea/daypart_view'; ?>", 
		dataType: 'text',  
		cache: false,
		contentType: false,
		processData: false,
...
function day_view(){
	...
	$.ajax({
		url: "<?php echo base_url().'tvprogramun3tvvsea/day_view'; ?>", 
		dataType: 'text',   
		cache: false,
		contentType: false,
		processData: false,
...
function ads_type_view(){
	...
	$.ajax({
		url: "<?php echo base_url().'tvprogramun3tvvsea/ads_view'; ?>", 
		dataType: 'text',   
		cache: false,
		contentType: false,
		processData: false,
