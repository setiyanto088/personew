                  ...
                  <div class="row">
                      ...
                      <div class="dataset col-md-4" style="z-index: 999;">
                          ...
                          <div class="input-group input-daterange">
                              <input type="text" class="form-control urate-form-input" name="start_date" id="start_date" placeholder="From ..." value="01/09/2020">
                              <div class="input-group-addon">-</div>
                              <input type="text" class="form-control urate-form-input" name="end_date" id="end_date" placeholder="To ..." value="30/09/2020">
                          </div>
                      </div>      
                      <!-- END PERIODE FIELD -->
                      <!-- WAKTU FIELD --> 
                      ...
                      <div class="col-md-12 text-center" style="top: 365px;position: absolute;width: 96%;">
                          ...
                          <div class="btn-loader">
                              ...
                              <img src="<?php echo $path; ?>assets/images/icon_loader.gif" id="loader">
                          </div>
                      </div>  
                      <!-- END PROCESS BUTTON -->
                  </div>
                  ...
                  <div class="tab-content">
                      ...
                      <div role="tabpanel" class="tab-pane active" id="table">
                          <div class="row result-action">
                              <div class="col-md-6">
                                  <button class="btn urate-outline-btn" value="Hide Selected" onclick="compare();"><img src="<?php echo $path; ?>assets/images/icon_compare.png"> Compare</button>
                              </div>
                          ...
                          <div class="result-table">
                              ...
                              <table id="myTable" class="table table-striped table-bordered example urate-table">
                                  <thead>
                                  <tr style="">
                                      <!--th style="color: #000000; border: 1px solid black;">
                                          <div class="checkbox urate-checkbox">
                                              <input type="checkbox" class="urate-form-checkbox" id="checkall" />
                                              <label for="checkall"></label>
                                          </div>
                                      </th-->
                                      <th style="color: #000000; border: 1px solid black;">Rank</th>
                                      <th style="color: #000000; border: 1px solid black;">Date</th>
                                      <th style="color: #000000; border: 1px solid black;">Program</th>
                                      <th style="color: #000000; border: 1px solid black;">Channel</th>
                                      <th style="color: #000000; border: 1px solid black;">Genre</th>
                                      <th style="color: #000000; border: 1px solid black;">Begin Time</th>
                                      <th style="color: #000000; border: 1px solid black;">End Time</th>
                                      <th style="color: #000000; border: 1px solid black;">TVS <img src="<?php echo $path; ?>assets/images/icon_arrowdown.png"></th>
                                      <th style="color: #000000; border: 1px solid black;">TVR <img src="<?php echo $path; ?>assets/images/icon_arrowdown.png"></th>
                                      <th style="color: #000000; border: 1px solid black;">Viewer <img src="<?php echo $path; ?>assets/images/icon_arrowdown.png"></th>
                                  </tr>
                                  </thead>
  ...
  <script language="javascript">
      $(document).ready(function(){           
          ...
          $('input.toggle-vis').on( 'click', function (e) {
              ...
              $.ajax({
            		url : "<?php echo base_url().'tvpc3trans/listchart_tvpc/'?>" + "?sess_user_id=" + user_id + "&sess_token=" + token  + "&start_date=" + start_date + "&end_date=" + end_date + "&profile=" + profile + "&channel=" + ch + "&stime=" + start_time + "&etime=" + end_time + "&cgroup=" + colgroup,
          ...
          $("#start_date").on("change",function(){
              ...
              $.ajax({
                  type	: "POST",
                  url		: "<?php echo base_url().'tvpc3trans/setprofile/'; ?>"+"?f="+$('#start_date').val(),
                  //data	: JSON.stringify(form_data),			
                  dataType: 'json',
                  contentType: 'application/json; charset=utf-8',
                  success	: function(response) {
...
// window event not working here
    ...
    // for IE < 11
      ...
      function search(group=""){
          ...
          */
          ...
          var table = $("#myTable").DataTable({
						  ...
						  'buttons': [
							  {
								  ...
								  action: function (e, dt, button, config)
								  {
									...
									$.ajax({
										url: "<?php echo base_url().'tvpc3trans/tvpc3_export'; ?>", 
										...
										success: function(data){
											...
											download_file('https://inrate.id/tmp_doc/tvpc_export.xls','TVPC.xls');
              ...
              "processing": true,
              "destroy": true,
              "ajax": "<?php echo base_url().'tvpc3trans/list_tvpc'?>" + "/?sess_user_id=" + user_id + "&sess_token=" + token + "&start_date=" + start_date + "&end_date=" + end_date + "&profile=" + profile + "&channel=" + ch + "&stime=" + start_time + "&etime=" + end_time + "&genre=" + genre,
              "searchDelay": 700,
              "bFilter" : false,
              "aaSorting": [],
              "bInfo" : false,
              ...
              // "fnRowCallback": function( nRow, aData, iDisplayIndex, iDisplayIndexFull ) {
                  // if ( aData[4] == "ANTV" ){
                      // $('td', nRow).css('background-color', '#ff5f5f');
                  // } else if ( aData[4] == "GTV" ) {
                      // $('td', nRow).css('background-color', '#c67575');
                  // } else if ( aData[4] == "KOMPASTV" ) {
                      // $('td', nRow).css('background-color', '#a7d14b');
                  // } else if ( aData[4] == "METROTV" ) {
                      // $('td', nRow).css('background-color', '#f4ec90');
                  // } else if ( aData[4] == "MNCTV" ) {
                      // $('td', nRow).css('background-color', '#5ccca1');
                  // } else if ( aData[4] == "NET" ) {
                      // $('td', nRow).css('background-color', '#cfc825');
                  // } else if ( aData[4] == "OCHNL" ) {
                      // $('td', nRow).css('background-color', '#bf56a1');
                  // } else if ( aData[4] == "RCTI" ) {
                      // $('td', nRow).css('background-color', '#a3a3a3');
                  // } else if ( aData[4] == "RTV" ) {
                      // $('td', nRow).css('background-color', '#54c4c6');
                  // } else if ( aData[4] == "SCTV" ) {
                      // $('td', nRow).css('background-color', '#c98557');
                  // } else if ( aData[4] == "TRANSTV" ) {
                      // $('td', nRow).css('background-color', '#949fbf');
                  // } else if ( aData[4] == "TRANS7" ) {
                      // $('td', nRow).css('background-color', '#8f89db');
                  // } else {
          ...
          $.ajax({
              url : "<?php echo base_url().'tvpc3trans/listchart_tvpc/'?>" + "?sess_user_id=" + user_id + "&sess_token=" + token  + "&start_date=" + start_date + "&end_date=" + end_date + "&profile=" + profile + "&channel=" + ch + "&stime=" + start_time + "&etime=" + end_time + "&cgroup=" + colgroup + "&genre=" + genre,
              success: function(response) {
                  //console.log(response.data);
      ...
      function create_chart(data,cgroup){
          ...
          for(var i=0; i < channel_header.length; i++){
            ch.push(channel_header[i].replace('&',' AND '));
              ...
              // if ( channel[i] == "ANTV" ) {
                  // color_list='#ff5f5f';
              // } else if ( channel[i] == "GTV" ) {
                  // color_list= '#c67575';
              // } else if ( channel[i] == "KOMPASTV" ) {
                  // color_list= '#a7d14b';  
              // } else if ( channel[i] == "METROTV" ) {
                  // color_list= '#f4ec90';
              // } else if ( channel[i] == "MNCTV" ) {
                  // color_list= '#5ccca1';
              // } else if ( channel[i] == "NET" ) {
                  // color_list= '#cfc825';
              // } else if ( channel[i] == "OCHNL" ) {
                  // color_list= '#bf56a1';
              // } else if ( channel[i] == "RCTI" ) {
                  // color_list= '#a3a3a3';
              // } else if ( channel[i] == "RTV" ) {
                  // color_list= '#54c4c6';
              // } else if ( channel[i] == "SCTV" ) {
                  // color_list= '#c98557';
              // } else if ( channel[i] == "TRANSTV" ) {
                  // color_list= '#949fbf';
              // } else if ( channel[i] == "TRANS7" ) {
                  // color_list= '#8f89db';
              // } else {
                // color_list= 'red';
              // } 
          ...
          for(var si=0; si < data.tvpc.length; si++){
              ...
              // if ( data.tvpc[si].channel == "ANTV" ) {
                  // color_list='#ff5f5f';
              // } else if ( data.tvpc[si].channel == "GTV" ) {
                  // color_list= '#c67575';
              // } else if ( data.tvpc[si].channel == "KOMPASTV" ) {
                  // color_list= '#a7d14b';
              // } else if ( data.tvpc[si].channel == "METROTV" ) {
                  // color_list= '#f4ec90';
              // } else if ( data.tvpc[si].channel == "MNCTV" ) {
                  // color_list= '#5ccca1';
              // } else if ( data.tvpc[si].channel == "NET" ) {
                  // color_list= '#cfc825';
              // } else if ( data.tvpc[si].channel == "OCHNL" ) {
                  // color_list= '#bf56a1';
              // } else if ( data.tvpc[si].channel == "RCTI" ) {
                  // color_list= '#a3a3a3';
              // } else if ( data.tvpc[si].channel == "RTV" ) {
                  // color_list= '#54c4c6';
              // } else if ( data.tvpc[si].channel == "SCTV" ) {
                  // color_list= '#c98557';
              // } else if ( data.tvpc[si].channel == "TRANSTV" ) {
                  // color_list= '#949fbf';
              // } else if ( data.tvpc[si].channel == "TRANS7" ) {
                  // color_list= '#8f89db';
              // } else {
                  // color_list= 'red';
              // }
         ...
         // RESET CHART
          ...
          //console.log("tv2data : "+tv2data);
          //console.log("tv1tgl : "+tv1tgl);
	  ...
	  function refreshtablefilter(start_date,end_date,profile,ch,start_time,end_time){
          ...
          var table = $("#myTable").DataTable({
              ...
              "processing": true,
              "destroy": true,
              "ajax": "<?php echo base_url().'tvpc3trans/list_tvpc'?>" + "/?sess_user_id=" + user_id + "&sess_token=" + token + "&start_date=" + start_date + "&end_date=" + end_date + "&profile=" + profile + "&channel=" + ch + "&stime=" + start_time + "&etime=" + end_time,
              "searchDelay": 700,
              "bFilter" : false,
              "bInfo" : false,
              "iDisplayLength": 10,
    ...
    function search_genre(){
        ...
        $.ajax({
            type	: "POST",
            url		: "<?php echo base_url().'tvpc3trans/genresearch/';?>"+ "?sess_user_id=" + user_id + "&sess_token=" + token +"&q=" + query,
            //data	: JSON.stringify(form_data),			
            dataType: 'json',
            contentType: 'application/json; charset=utf-8',
            success	: function(response) {
    ...
    function search_channel(){
        ...
        $.ajax({
            type	: "POST",
            url		: "<?php echo base_url().'tvpc3trans/channelsearch/';?>"+ "?sess_user_id=" + user_id + "&sess_token=" + token +"&q=" + query +"&g=" + genre,
            //data	: JSON.stringify(form_data),			
            dataType: 'json',
            contentType: 'application/json; charset=utf-8',
            success	: function(response) {
    ...
    function create_daypart(){                  
        ...
        $.ajax({
            type	: "POST",
            url		: "<?php echo base_url().'tvpc3trans/setdaypart/';?>"+ "?sess_user_id=" + user_id + "&sess_token=" + token +"&f=" + from +"&t=" + to,
            //data	: JSON.stringify(form_data),			
            dataType: 'json',
            contentType: 'application/json; charset=utf-8',
            success	: function(response) {
    ...
    function search_profile(){
        ...
        $.ajax({
            type	: "POST",
            url		: "<?php echo base_url().'tvpc3trans/profilesearch/'; ?>"+"?q="+query+"&f="+period,
            //data	: JSON.stringify(form_data),			
            dataType: 'json',
            contentType: 'application/json; charset=utf-8',
            success	: function(response) {
