...
$( document ).ready(function() {
    ...
    var form_data = {
     ...
     $.ajax({
        type: "POST",
        url: "<?php echo base_url();?>cpr/searchfav" + "?sess_user_id=" + user_id + "&sess_token=" + token,
...
function addleft(id, dex, val){
    ...
    var selection = {
     ...
     $.ajax({
        type: "POST",
        url: "<?php echo base_url();?>cpr/searchopval" + "?sess_user_id=" + user_id + "&sess_token=" + token,
...
function favorite(id, val){
    ...
    if(star == 1){
        ...
        var form_data = {
         ...
         $.ajax({
            type: "POST",
            url: "<?php echo base_url();?>cpr/create_pav" + "?sess_user_id=" + user_id + "&sess_token=" + token,
            data: JSON.stringify(form_data),
            dataType: 'json',
            contentType: 'application/json; charset=utf-8'
        }).done(function(response) {
...
function getCreate(){
    ...
    if(nas){
                ...
                var form_data = {
                    ...
                    $.ajax({
                        type: "POST",
                        url: "<?php echo base_url();?>cpr/create_profiling" + "?sess_user_id=" + user_id + "&sess_token=" + token,
                        data: JSON.stringify(form_data),
                        dataType: 'json',
                        contentType: 'application/json; charset=utf-8'
                    }).done(function(response) {
