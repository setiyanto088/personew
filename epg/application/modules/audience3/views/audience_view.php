								...
								<div class="form-group">
									...
									<div class="select-wrapper">
									  <select class='urate-select' name="channel" id="channel" title='Please Choose Channel ...'>
										...
										<option value='All Ads Channel' >All Ads Channel</option>
																<?php 
  ...
  <script language="javascript">
    ...
    function search_channel(){
        ...
        var strVar = "<li data-for='channel'><a href='#' data-real='All Channel' class='urate-select-form-two' data-for='channel'>All Channel</a></li><li data-for='channel'><a href='#' data-real='All Ads Channel' class='urate-select-form-two' data-for='channel'>All Ads Channel</a></li>";
