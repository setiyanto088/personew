              ...
              <div class="panel-body">
                  ...
                  <div class="tab-content">
                      <div role="tabpanel" class="tab-pane fade in active" id="table">
                        ...
                        <div role="tabpanel" class="tab-pane fade" id="chart" style="margin-top:70px">
                            ...
                            <div id="container" style="width: 1100px; height: 400px; margin: 0 auto"></div>
                          	...
                          	<div class="col-lg-12 panel urate-panel" style="background-color:#F3F3F3;margin-top:50px">
  ...
  <script language="javascript">
      $(document).ready(function(){      
          ...
          $('#custom_profile').click(function() {   
              ...
              $.ajax({
                  type	: "POST",
                  url		: "<?php echo base_url().'channelmigration3/setprofile/'; ?>"+"?f="+$('#start_date').val(),
                  dataType: 'json',
      ...
      function generate_program(channel, sdate, prof){
		...
		var form_data = new FormData();  
          ...
          $.ajax({
              type	: "POST",
              url		: "<?php echo base_url().'channelmigration3/list_program/';?>"+ "?sess_user_id=" + user_id + "&sess_token=" + token,
      ...
      function search(){
          ...
          var table = $("#example").DataTable({
              ...
              "serverSide": true,
              "destroy": true,			
              "ajax": "<?php echo base_url().'channelmigration3/list_migration'?>" + "/?sess_user_id=" + user_id + "&sess_token=" + token + "&start_date=" + start_date + "&channel=" + channel+ "&program=" + program+ "&profile=" + profile,
              "searchDelay": 700,
              "bFilter" : false,
              'dom': 'lBfrtip',
			  "autoWidth": false,
          ...
          var table2 = $("#example2").DataTable({
              ...
              "serverSide": true,
              "destroy": true,			
              "ajax": "<?php echo base_url().'channelmigration3/list_migration_sub'?>" + "/?sess_user_id=" + user_id + "&sess_token=" + token + "&start_date=" + start_date + "&channel=" + channel+ "&program=" + program,
              "searchDelay": 700,
              "bFilter" : false,
              'dom': 'lBfrtip',
              'buttons': [
          ...
          $.ajax({
              ...
              url : "<?php echo base_url().'channelmigration3/list_chartcm'?>" + "/?sess_user_id=" + user_id + "&sess_token=" + token + "&start_date=" + start_date + "&channel=" + channel + "&program=" + program + "&cgroup=" + colgroup,
              success: function(response) {
          ...
          // SUMMARY       
          $.ajax({
              url : "<?php echo base_url().'channelmigration3/list_summarycm'?>" + "/?sess_user_id=" + user_id + "&sess_token=" + token + "&start_date=" + start_date + "&channel=" + channel + "&program=" + program+ "&profile=" + profile,
              success: function(response) {      
      ...
      function search_channel(){
          ...
          $.ajax({
              type	: "POST",
              url		: "<?php echo base_url().'channelmigration3/channelsearch/';?>"+ "?sess_user_id=" + user_id + "&sess_token=" + token +"&q=" + query,
              dataType: 'json',
              contentType: 'application/json; charset=utf-8',
              success	: function(response) {
      ...
      function search_program(){
          ...
          $.ajax({
              type	: "POST",
              url		: "<?php echo base_url().'channelmigration3/listsearch/';?>"+ "?sess_user_id=" + user_id + "&sess_token=" + token +"&q=" + query + "&d=" + start_date + "&c=" + channel + "&p=" + profile,
              dataType: 'json',
              contentType: 'application/json; charset=utf-8',
              success	: function(response) {
    ...
    function search_profile(){
        ...
        $.ajax({
            type	: "POST",
            url		: "<?php echo base_url().'channelmigration3/profilesearch/'; ?>"+"?q="+query,
            dataType: 'json',
            contentType: 'application/json; charset=utf-8',
            success	: function(response) {
                $("#profile").next().next().next().empty('');
